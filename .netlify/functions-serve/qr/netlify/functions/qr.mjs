...
const require = ___nfyCreateRequire(import.meta.url);
...
var qrNumber = (data) => {
  ...
  const _this = {};
  _this.getMode = () => _mode;
  _this.getLength = (buffer) => _data.length;
  _this.write = (buffer) => {
    const data2 = _data;
    let i = 0;
...
var qr8BitByte = (data) => {
  ...
  const _this = {};
  _this.getMode = () => _mode;
  _this.getLength = (buffer) => _bytes.length;
  _this.write = (buffer) => {
...
var qrKanji = (data) => {
  ...
  const _this = {};
  _this.getMode = () => _mode;
  _this.getLength = (buffer) => ~~(_bytes.length / 2);
  _this.write = (buffer) => {
    const data2 = _bytes;
    let i = 0;
