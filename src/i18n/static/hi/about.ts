  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'प्रोफेशनल एम्बेडिंग के लिए सर्वर-साइड API, पूर्ण पैरामीटर सपोर्ट के साथ।',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'डिफ़ॉल्ट रूप से, जेनरेशन आपके ब्राउज़र में लोकल रूप से होता है। प्रोफेशनल उपयोग के लिए, आप URL पैरामीटर के माध्यम से QR कोड जेनरेट करने के लिए सर्वर-साइड API का भी उपयोग कर सकते हैं — वेबसाइट, ईमेल, या ऑटोमेटेड वर्कफ़्लो में एम्बेड करने के लिए परफेक्ट।',
