...
export const docs: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Formaat: Kies uw exportformaat op basis van uw gebruikssituatie.”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Beheer het gedrag van geanimeerde QR-codes:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Geavanceerd niveau ontgrendelt extra payload-formaten:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Aanvullende overlaymogelijkheden:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Extra mengmodi in het geavanceerde niveau:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Hoe de overlay-afbeelding wordt verwerkt:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Hoe de overlay-afbeelding in het QR-codegebied past:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Bij gebruik van de subpixel-mengmodus:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Bij gebruik van de halftoon-mengmodus:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Bij gebruik van geanimeerde GIF-overlays:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Aanvullende weergave-instellingen:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Aanvullende exportinstellingen:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Instellingen voor invoerverwerking:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Watermerk”',
      paragraphs: [
        '"Voeg watermerken toe aan uw QR-codes:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Metadata”',
      paragraphs: [
        '"Metagegevens insluiten in geëxporteerde bestanden:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Zorg ervoor dat QR-codes scanbaar blijven:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Het professionele niveau voegt betalings- en bedrijfscontenttypen toe:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Extra mengmodi in het professionele niveau:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Geavanceerde weergave-instellingen:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Exportinstellingen voor bedrijven:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Aanvullende professionele animatiefuncties:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Vereiste en algemene parameters (parameternamen worden niet vertaald):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Beeldvoorverwerking toegepast op overlay:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Watermerken toevoegen aan gegenereerde QR-codes:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Voor geanimeerde GIF-uitvoer (vereist format=gif):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Volg deze richtlijnen voor betrouwbare QR-codes:”',
      ],
      bullets: [
