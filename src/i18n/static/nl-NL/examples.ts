...
export const examples: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption: 'Het uitgangspunt: drie jaar tegendienst had de oorspronkelijke QR nauwelijks functioneel verlaten',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['Met behulp van ANQR heeft de café eigenaar de code opnieuw gecreëerd met de identieke menu-URL maar drastisch verbeterde instellingen: Foutcorrectie H voor maximale veerkracht, een 6-module rustige zone voor betrouwbare grensdetectie, en merkkleuren (diepe bordeaux modules op crème achtergrond) die overeenkomen met het interieurpalet van het café.', 'Er werd een kleine centrumoverlay met het logo van het café toegevoegd - bewust subtiel gehouden om de scannbaarheid te behouden en tegelijkertijd meteen merkherkenning te bieden. De veiligheidsmodus bevestigde dat het nieuwe ontwerp betrouwbaar is gescand over de testapparatuur voordat er wordt gedrukt.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Na het inzetten van de nieuwe QR op professionele matte-gelamineerde kaarten voorraad, het café volgde resultaten over vier weken. Het succespercentage van de scan is verbeterd van naar schatting 70% tot bijna-100%. De gemiddelde scantijd daalde van 3-4 seconden tot minder dan 1 seconde. Het meest significant, menu engagement steeg 40% - klanten die eerder keek naar de QR en gaf nu scannen vertrouwen.', 'Personeel meldde minder klantvragen over \'hoe gebruik je de QR\' en geen gevallen meer van handmatig typen van de URL voor gefrustreerde klanten. De branded uiterlijk ook vonk gesprekken, met klanten positief commentaar op het samenhangende ontwerp.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Voor tips, recensies, sociale, en het huren, de winkel kan meer expressief. Deze codes werden gerecupereerd in ANQR met consistente merkstijlen: de handtekening van de winkel olijfgroen op crème, ronde modulestijl, en een subtiele centrumoverlay met het pictogram van de winkel. Foutcorrectie H zorgde zelfs met de styling voor betrouwbaarheid.', 'Deze vier codes werden gerangschikt in een branded panel naast (niet concurreren met) de betaalcode. Duidelijke labels in de typografie van de winkel verklaarden het doel van elke code. De visuele hiërarchie was opzettelijk: betaling stond alleen en prominent; secundaire acties gegroepeerd als opties.'],
      images: [
        {
      ...
      images: [
        {
          ...
          caption: 'Weergavesysteem blauwdruk: fysieke ergonomie geoptimaliseerd voor betrouwbaar scannen over klanthoogtes en lichtomstandigheden',
        },
      ],
    },
    {
      heading: 'Operationele verbeteringen',
      paragraphs: ['Zes weken na implementatie heeft de winkel significante verbeteringen gedocumenteerd: nul klachten van klanten over \'foute code\' verwarring, snellere transactietijden en een 3x toename van tip-inzendingen (klanten konden nu de tipcode vinden en scannen zonder lastig personeel te vragen). Google reviews ook verhoogd als de toegewijde, goed gelabelde QR verwijderd wrijving.', 'De opleiding van het personeel werd eenvoudiger: De betaalcode is de grote, de rest staat op het paneel. Toen betaling apps bijgewerkt en een kort toonde langzamer scannen, de conservatieve betaalcode ontwerp betekende het nog steeds werkte - slechts marginaal langzamer in plaats van volledig falen.', 'Zie de Leergids over QR-codes voor retailbetalingen voor de principes achter dit displaysysteemontwerp.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Tijdens hun laatste conferentie had het bedrijf beschamende mislukkingen ervaren. De podiumbanner QR werd gegenereerd als een kleine PNG en opgeschaald in design software - het resultaat zag er aanvaardbaar uit van een afstand maar faalde om betrouwbaar te scannen van het publiek. Badge QR\'s waren over-stijld en te klein, frustrerend aanwezigen proberen om contacten toe te voegen. Inconsistente instellingen tussen formaten betekende dat de \'zelfde\' QR er op elk stuk anders uitzag.', 'Post-event analyse onthulde de oorzaak: geen enkele bron van waarheid. Elke ontwerper had de QR opnieuw gemaakt met iets verschillende instellingen, en elke afdrukverkoper had bestanden anders verwerkt. Kwaliteit aangetast door het telefoonspel van file handoffs.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Elk formaat vereist specifieke aandacht. Badge inserts op 3cm had de QR nodig om maximale beschikbare ruimte te bezetten - scanafstand zou armlengte zijn. Tafeltenten op 8cm kunnen decoratieve kaders buiten de rustige zone omvatten. De 4 meter hoge banner vereist berekening: van typische afstand tot het publiek (15-20 meter), modules moesten duidelijk te onderscheiden zijn door telefooncamera\'s, waardoor de QR minimaal 80 cm binnen het bannerontwerp moest zijn.', 'Het bedrijf creëerde een Size Guide documenteren minimale QR afmetingen voor elke verwachte scanafstand. Dit werd een herbruikbare troef voor toekomstige gebeurtenissen, waardoor giswerk uit het ontwerpproces werd verwijderd.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['De validatie van de conferentiedag was systematisch: het personeel testte elke ingezette QR voordat de deuren opengingen. De badge inserts scanden direct op armlengte. Tafeltenten werkten betrouwbaar in de variabele verlichting van breakout rooms. De podiumbanner - de schaamte van het vorige evenement - scande succesvol vanuit het midden van het publieksgebied.', 'Zero scanning klachten werden geregistreerd bij 2000+ bezoekers. De operationele overwinning was even belangrijk: wanneer een last-minute sponsor toevoeging nieuwe bewegwijzering vereist, het productieteam genereerde het van de master SVG in minuten, ervan overtuigd dat het zou overeenkomen met al het andere.', 'Zie de Learn-gids over print-ready QR-codes voor het SVG vs PNG-besluitkader en de overdracht van beste praktijken.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['De geanimeerde QR werd geplaatst in een speciale \'stabiele zone\' van de schermindeling - een gebied dat constant bleef terwijl promotionele inhoud draaide in het hoofdschermgebied. Deze scheiding was van cruciaal belang: de QR had visuele stabiliteit nodig om te scannen, zelfs terwijl hij de aandacht trok door zijn subtiele animatie.', 'Een duidelijke call-to-action werd toegevoegd naast de QR: Scan de wachtrij om in te checken. De tekst bleef statisch terwijl de QR pulsed, het creëren van een visuele hiërarchie die het oog trok op de scankans zonder het overweldigen van de promotionele inhoud.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Na een maand van werking, QR check-in adoptie steeg van 15% naar 24% - een relatieve verbetering van 60%. Gast feedback onderzoeken wees uit dat de geanimeerde QR was \'makkelijker op te merken\' en \'voelt meer modern.\' Desk wachtrij tijden nam meetbaar tijdens de piek periodes als meer gasten zelf bediend via de QR.', 'Belangrijk, nul scanfouten werden gemeld ondanks duizenden dagelijkse scans. De conservatieve animatie aanpak had het aandachtsdoel bereikt zonder de betrouwbaarheid op te offeren een check-in flow gevraagd. De lounge rolde vervolgens soortgelijke geanimeerde QR\'s uit als hun andere locaties.', 'Zie de Leergids over geanimeerde QR-codes voor digitale bewegwijzering voor de technische principes achter veilig animatieontwerp.'],
      images: [
        {
