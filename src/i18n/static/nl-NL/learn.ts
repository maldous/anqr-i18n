  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Bestandsgrootte is van belang voor bezorging. Narrowcastingsystemen, e-mailclients en sociale platforms leggen vaak groottelimieten op. Als uw animatie deze limieten overschrijdt, verkleint u het aantal frames, de afmetingen of de kleurdiepte. Soms levert het opsplitsen van een complexe animatie in een kortere lus betere resultaten op dan agressieve compressie die elk frame verslechtert.',
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Geanimeerd QR-testprotocol: systematische verificatie voor frames, apparaten en kijkomstandigheden',
        },
      ],
      links: [
        {
