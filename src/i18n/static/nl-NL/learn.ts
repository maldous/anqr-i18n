...
export const learn: PageDefinition = {
  ...
  description: 'Praktische, business-first gidsen voor het omzetten van QR codes in echte marketing activa - niet alleen functionele vierkanten. Leer hoe u legacy point-of-sale codes kunt upgraden, conforme betaling QR signage kunt maken, print-ready export kunt voorbereiden, animatie veilig kunt gebruiken op digitale displays, en locked-in configuraties kunt delen over meertalige teams met behulp van ANQR ("anker") links.',
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: ['De meeste bedrijven hebben QR codes verspreid over hun activiteiten - op menu\'s, toonbank, verpakking en promotiemateriaal. Veel van deze codes zijn jaren geleden gemaakt met basisgeneratoren, wat resulteert in generieke zwart-wit vierkanten die niet inspireren vertrouwen of overeenkomen met uw merk identiteit. Deze uitgebreide gids begeleidt u door een systematische aanpak van het controleren, upgraden en optimaliseren van uw bestaande QR-infrastructuur zonder de klanttrajecten die u al hebt opgezet te verstoren.', 'Het strategische voordeel van het upgraden in plaats van het vervangen van uw QR codes ligt in het behouden van continuïteit. Uw klanten hebben al geleerd om bepaalde bestemmingen te verwachten wanneer ze uw codes scannen. Door de gecodeerde URL\'s identiek te houden en tegelijkertijd de visuele presentatie, betrouwbaarheid en merkuitlijning drastisch te verbeteren, creëer je een naadloze overgang die het vertrouwen verbetert zonder dat er wijzigingen nodig zijn in je digitale infrastructuur of analytics tracking.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['De hoofdregel van QR upgrades is het behoud van de bestemming. Pak de exacte URL van elke bestaande code en codeer het identiek in uw nieuwe versie. Dit zorgt ervoor dat alle bestaande analytics, redirect logica en klantverwachtingen intact blijven. Als u bestemmingsflexibiliteit nodig heeft voor toekomstige updates, dan is dit het ideale moment om een branded short URL of redirect service in te voeren - maar implementeer dit als een apart project om samengestelde wijzigingen te voorkomen.', 'Voor de visuele upgrade, breng verbeteringen in lagen: eerst zorgen voor technische betrouwbaarheid (passende foutcorrectie en rustige zone), dan merk styling (kleuren, module vormen), en ten slotte overwegen optionele verbeteringen (centeroverlays, frames). Elke laag moet worden gevalideerd door middel van tests alvorens verder te gaan. De veiligheidsmodus van ANQR helpt deze prioriteiten af te dwingen door te waarschuwen wanneer styling keuzes de scannability in gevaar kunnen brengen.'],
    },
    {
      heading: 'Merkidentiteit toevoegen zonder Betrouwbaarheid te compromitteren',
      paragraphs: ['Effectieve QR branding balanceert visuele impact tegen scan betrouwbaarheid. Begin met kleur: vervang de standaard zwarte voorgrond met je primaire merkkleur, zodat er voldoende contrast is met je achtergrond. Voor de meeste merken werken donkere kleuren op lichte achtergronden het beste. Vermijd low-contrast combinaties, gradiënten die de helderheid van de rand verminderen, of kleuren die vergelijkbaar lijken onder gemeenschappelijke lichtomstandigheden.', 'Module vorm aanpassing biedt een andere branding mogelijkheid met minimale betrouwbaarheid impact. Afgeronde modules zorgen voor een zachtere, meer toegankelijke uitstraling met behoud van uitstekende scannability. Dot-stijl modules werken goed voor moderne, tech-forward merken. Aangesloten modules passen bij industriële of bedrijfsidentiteit. Welke stijl u ook kiest, onderhoud consistentie in al uw QR-implementaties voor directe merkherkenning.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Betaalapps zijn minder vergevingsgezind dan generieke camerascanners. Veel banking apps gebruiken oudere, eenvoudigere QR leesalgoritmen geoptimaliseerd voor snelheid in plaats van flexibiliteit. Dit betekent styling die perfect werkt met een telefooncamera kan mislukken met specifieke betaalapps. Houd branding conservatief: gebruik uw merkkleur voor de voorgrond als het een sterk contrast behoudt, maar vermijd gradiënten, zware overlays of decoratieve elementen die de herkenning kunnen verstoren.', 'Als u een centraal logo of overlay wilt, houd het dan uiterst klein - niet meer dan 10-15% van het QR gebied - en test uitgebreid met elke betaalapp die uw klanten gebruiken. Veel bedrijven kiezen voor geen overlay op betaalcodes specifiek, reserveren dat styling voor de marketing van QR-codes waar betrouwbaarheidseisen minder streng zijn. Het is de taak van de betaalcode om transacties te verwerken, niet om visueel indruk te maken.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['ANQR biedt verschillende SVG-exportmodi voor verschillende workflows. True Vector-modus produceert pure path-based output ideaal voor print- en professionele ontwerptools. Wanneer je rasteroverlays of bepaalde effecten hebt toegevoegd, kan ANQR deze insluiten tijdens het onderhouden van vectormodules, of je kunt een volledig gerasterde versie exporteren met de opgegeven resolutie. Het begrijpen van deze opties helpt u kiezen voor de juiste export voor elke use case.', 'Voor PNG export kunt u met ANQR exacte afmetingen specificeren en opties voor transparante achtergronden bevatten. De DPI-instelling helpt u bij het berekenen van de juiste maten voor afdrukken, maar vergeet niet dat DPI metadata is - wat belangrijk is voor afdrukken is het hebben van voldoende pixels voor uw fysieke grootte. Bij twijfel, exporteren groter dan je denkt dat je nodig hebt; schalen omlaag behoudt kwaliteit terwijl schaalvergroting vernietigt het.'],
    },
    {
      heading: 'Bestanden voorbereiden voor overdracht',
      paragraphs: ['Bij het doorgeven van QR-kunstwerk aan ontwerpers of drukverkopers, omvatten duidelijke specificaties: de beoogde fysieke grootte, minimale eisen aan de rustige zone, en eventuele kleurruimte overwegingen. Voor kritische toepassingen kunt u zowel een SVG-master als een PNG-back-up met een hoge resolutie leveren, die duidelijk is voorzien van de beoogde toepassingen. Inclusief uw ANQR configuratie link zodat de code kan worden geregenereerd indien nodig.', 'Anticipeer algemene fouten in het overdrachtsproces. Geef duidelijk aan dat de QR niet moet worden geschaald, gedraaid, scheefgetrokken of effecten mag hebben. Specificeer dat de stille zone duidelijk moet blijven - geen gewasmerken, registratiemerken of ontwerpelementen storen. Indien de QR op een gekleurde of fotografische achtergrond wordt geplaatst, moet een versie met een ondoorzichtige steunvorm worden verstrekt om voldoende contrast te garanderen.'],
      images: [
        {
          ...
          caption: 'Professioneel QR-handoffpakket: alles wat een ontwerper of printverkoper nodig heeft voor nauwkeurige reproductie',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['QR scanners werken door het vastleggen van een enkel frame en het analyseren van het patroon van licht en donker modules. Om een geanimeerde code te laten werken, moet elk frame het volledige, geldige QR patroon bevatten. Dit sluit animaties uit die de codestructuur veranderen, modules oplossen of het contrastpatroon aanzienlijk veranderen. De gegevensdragers - het schijnbaar willekeurige patroon in het centrum - moeten visueel stabiel blijven.', 'Veilige animatiebenaderingen wijzigen elementen die geen gegevens bevatten: achtergronden, kleuren, decoratieve frames en overlay elementen. De structurele componenten - zoekpatronen (de grote hoekvierkanten), timingpatronen (de afwisselende lijnen) en uitlijningspatronen (kleinere vierkanten in grotere codes) - moeten hun posities en verhoudingen behouden. Werken binnen deze beperkingen zorgt nog steeds voor verrassend dynamische en boeiende animaties.'],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['Bij het gebruik van geanimeerde afbeeldingen (GIF\'s, geanimeerde WebP\'s, of video) als overlays haalt ANQR frames uit en combineert ze met uw QR-code. De overlay intensiteit instelling bepaalt hoeveel van de animatie toont door - lagere waarden prioriteit scannability terwijl hogere waarden voorkeur visuele impact. Test uw gekozen intensiteit over meerdere frames om consistente scannabiliteit te garanderen.', 'De materiaalkwaliteit van de bron heeft een significant effect op de resultaten. Gebruik overlays met duidelijke onderwerpen en goed contrast. Vermijd bronanimaties met snel knipperen of extreme helderheidsveranderingen die af en toe lage contrastframes kunnen creëren. Een voorbeeld van de volledige animatiecyclus voordat u exporteert om eventuele problematische frames te vangen die niet kunnen scannen.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['GIF blijft de meest ondersteunde geanimeerde formaat, automatisch afspelen in de meeste contexten zonder ondersteuning van de videospeler. GIF\'s 256-kleurenpalet beperkt echter de kleurtrouw. Voor kleurkritische animaties, overwegen geanimeerde WebP waar ondersteund, of terugvallen op video-formaten voor de hoogste kwaliteit. De GIF-export van ANQR omvat ditheringopties om de kwaliteit binnen paletbeperkingen te maximaliseren.', 'Bestandsgrootte is belangrijk voor levering. Digitale bewegwijzeringssystemen, e-mailclients en sociale platforms leggen vaak groottelimieten op. Als uw animatie deze grenzen overschrijdt, vermindert u het aantal frames, afmetingen of kleurdiepte. Soms bereikt het splitsen van een complexe animatie in een kortere lus betere resultaten dan agressieve compressie die elk frame degradeert.'],
    },
    {
      heading: 'Geanimeerde QR-codes testen',
      paragraphs: ['Het testen van geanimeerde codes vereist scannen op meerdere punten in de animatiecyclus. Niet één keer scannen en succes aannemen - herhaaldelijk scannen, op verschillende momenten, om te controleren of elk frame leesbaar is. Bijzondere aandacht besteden aan frames bij kleurcyclus extremen of overlay intensiteit pieken waar contrast het laagst kan zijn.', 'Testen op de werkelijke display hardware waar mogelijk. Monitor kleurkalibratie, kijkhoek en omgevingsverlichting alle invloed op hoe de animatie verschijnt en scant. Een heldere animatie die perfect scant op uw monitor kan uitspoelen op een buitenscherm of onleesbaar worden in schuine kijkhoeken.'],
      images: [
        {
          ...
          caption: 'Geanimeerde QR-testprotocol: systematische verificatie over frames, apparaten en kijkomstandigheden',
        },
      ],
      links: [
        {
