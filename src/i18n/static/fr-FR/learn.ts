...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        "La plupart des entreprises ont des codes QR dispersés dans leurs activités - sur les menus, les comptoirs, les emballages et le matériel promotionnel. Beaucoup de ces codes ont été créés il y a des années avec des générateurs de base, ce qui a donné lieu à des carrés génériques en noir et blanc qui n'inspirent pas confiance ou correspondent à votre identité de marque. Ce guide complet vous accompagne dans une approche systématique de l'audit, de la mise à niveau et de l'optimisation de votre infrastructure QR existante sans perturber les parcours clients que vous avez déjà établis.",
      ...
      images: [
        {
          ...
          caption:
            "Avant et après: La même URL de destination est passée d'un code générique daté à un actif de marque professionnelle",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Modèle de vérification systématique des QR pour documenter et hiérarchiser vos candidats à la mise à niveau',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Guide de sélection des couleurs de marque montrant des combinaisons très contrastantes qui maintiennent la fiabilité de l'analyse",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Empêcher la dérive de configuration en établissant une source unique faisant autorité pour toutes les reproductions QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Paiement Les codes QR doivent fonctionner instantanément avec les applications bancaires et de portefeuille dans des conditions de compteur réel',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guide de placement du comptoir : hauteurs, angles et distances optimaux pour un balayage de paiement fiable',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paiement spectre de marque QR: du style prudent sûr aux approches décoratives risquées',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Le matériel d'affichage physique a un impact significatif sur la fiabilité de l'analyse. La lamination brillante reflète les lumières aériennes directement dans la caméra du client. Les matériaux texturés peuvent déformer les bords du module. L'impression bon marché peut brouiller les détails fins. Pour le paiement des codes QR, investissez dans la qualité : utilisez la lamination mate ou satinée, assurez l'impression haute résolution et remplacez les écrans avant qu'ils ne s'usent. Un code de paiement rayé ou effacé vous coûte des transactions.",
        "Considérez la durabilité et la remplaçabilité de l'écran. Les écrans de comptoir sont touchés, déplacés, éclaboussés et parfois renversés. Concevoir votre système d'affichage pour que l'insert QR puisse être facilement remplacé sans remplacer l'ensemble du support. Gardez les empreintes de rechange prêtes, générées à partir de votre lien de configuration verrouillé, de sorte que les codes usés peuvent être échangés immédiatement.",
      ],
    },
    {
      heading: 'Tests avec paiement réel Applications',
      paragraphs: [
        "Les scanners de caméra génériques décoderont presque n'importe quel code QR raisonnablement formaté. Les applications de paiement sont plus faciles. Avant de déployer tout paiement QR code, testez-le avec chaque application de paiement que vos clients pourraient utiliser. Dans les environnements multi-paiements, cela peut signifier tester avec plusieurs applications bancaires, portefeuilles numériques et plateformes de paiement. Documenter les applications que vous avez testées et leurs versions - les applications de paiement mettent à jour fréquemment, et une mise à jour pourrait changer le comportement de numérisation.",
        "Essai dans des conditions réalistes : affichage réel, éclairage réel, distance de balayage réelle. Un code qui scanne instantanément sur votre bureau pourrait lutter sur le comptoir à 17h lorsque le soleil de l'après-midi crée l'éblouissement. Testez avec le smartphone le plus ancien et le moins cher que vous pouvez trouver - s'il fonctionne de manière fiable sur un appareil budgétaire, il fonctionnera sur tout. Marquez tout temps d'analyse sur 2 secondes pour l'enquête et la refonte potentielle.",
      ],
      images: [
        {
          ...
          caption:
            "Paiement global matrice d'essais QR couvrant les applications, les appareils et les facteurs environnementaux",
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            "Vecteur vs raster à l'échelle d'impression : la différence de précision qui détermine la fiabilité de l'analyse",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Calculateur de résolution d'impression: détermination des dimensions minimales de pixel pour votre taille de sortie cible",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Paquet professionnel QR handoff : tout ce dont un concepteur ou un fournisseur d'impression a besoin pour une reproduction précise",
        },
      ],
    },
    {
      ...
      paragraphs: [
        "N'approuvez jamais un tirage sans scanner une preuve physique. Demander une preuve imprimée sur le substrat réel avec la finition réelle qui sera utilisée dans la production. Scanner la preuve dans des conditions d'éclairage semblables à celles où la pièce finale sera affichée. Tester avec plusieurs appareils, y compris les smartphones plus anciens qui pourraient avoir des problèmes avec la qualité marginale.",
      ...
      images: [
        {
          ...
          caption:
            "Déroulement de la vérification des épreuves d'impression : essais systématiques avant de s'engager sur les quantités de production",
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        "Les codes QR animés combinent la fonctionnalité des codes QR standard avec un mouvement captivant qui augmente considérablement les taux d'engagement. Dans la signalisation numérique, les médias sociaux et les affichages interactifs, l'animation transforme une utilité statique en un élément visuel convaincant qui attire l'attention et invite à l'interaction. Ce guide couvre les principes, les techniques et les contraintes pratiques de la création de codes QR animés qui scannent de façon fiable tout en produisant un impact visuel.",
        "Le défi fondamental des codes QR animés est d'équilibrer l'intérêt visuel et la fiabilité de l'analyse. Chaque cadre doit être scannable individuellement - un scanner peut capturer le code à n'importe quel moment du cycle d'animation. Cette contrainte façonne chaque décision de conception : quels éléments peuvent bouger, combien ils peuvent changer et ce qui doit rester stable tout au long de l'animation.",
      ],
      images: [
        {
          ...
          caption:
            "Codes QR animés dans l'affichage numérique: mouvement qui attire l'attention et encourage la numérisation",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Principe de superposition d'animation : le modèle QR reste constant tandis que les éléments de fond animent sous",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Analyse des cadres : vérification de la scannabilité cohérente tout au long du cycle d'animation",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Protocole d'essai des QR animé : vérification systématique des cadres, des dispositifs et des conditions de visionnement",
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Le spectre de scannabilité : des codes pare-balles au style qui pousse les limites de fiabilité',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "La zone tranquille est la marge blanche entourant chaque code QR. Les scanners utilisent cette limite pour identifier où le code commence et se termine. La norme ISO spécifie une zone de silence minimale de quatre modules (quatre fois la largeur du plus petit carré du code). La violation de cet espace - avec des éléments de conception, des bords de garniture ou du contenu adjacent - est l'une des causes les plus courantes de pannes de balayage.",
        "L'application de zone tranquille d'ANQR aide à maintenir cet espacement critique, mais vous devez également vous assurer qu'il est préservé dans vos conceptions finales. Lors de la remise de l'œuvre d'art QR, spécifiez explicitement les exigences de zone tranquille. Lors de la mise en page des codes, vérifiez qu'aucun élément ne pénètre dans cet espace. Quelques millimètres d'espace libre peuvent signifier la différence entre le balayage fiable et les clients frustrés.",
      ],
      images: [
        {
          ...
          caption:
            "Besoins de zone tranquille : la marge invisible qui détermine le succès de l'analyse",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guide de distance de numérisation : la taille du module correspond à vos besoins de déploiement',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Aucune vérification logicielle ne remplace les tests physiques. Imprimez votre code à la taille prévue sur du matériel représentatif. Testez-le dans l'environnement de déploiement réel avec des conditions d'éclairage qui correspondent à une utilisation réelle. Scanner avec plusieurs appareils - pas seulement votre téléphone phare, mais les appareils Android budget, les anciens iPhones, et tous les appareils spécifiques que votre public utilise couramment.",
        "Documentez systématiquement vos tests. Indiquer quels appareils ont été testés, dans quelles conditions, avec quels résultats. Si vous déployez des codes à l'échelle, établissez des critères d'acceptation : un taux de réussite de 95 % peut-être dans votre bassin de tests d'appareil, ou des analyses réussies en 2 secondes sur tous les appareils testés. Ces normes aident à rendre les décisions aller/pas aller objectif plutôt que d'espérer le meilleur.",
      ],
      images: [
        {
          ...
          caption:
            "Protocole d'essai de déploiement QR : vérification systématique avant l'engagement de production",
        },
      ],
      links: [
        {
