...
export const docs: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Pour créer votre premier code QR : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Contrôler le comportement des codes QR animés : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Le niveau avancé débloque des formats de charge utile supplémentaires : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Fonctionnalités de superposition supplémentaires : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Modes de fusion supplémentaires en niveau avancé : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Comment l’image superposée est traitée : »',
      ],
      bullets: [
    ...
    },
    {
      heading: '« Mode Forme »',
      paragraphs: [
        '« Comment l’image superposée s’adapte à la zone du code QR : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Lors de l’utilisation du mode de fusion Subpixel : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Lors de l’utilisation du mode de fusion Demi-teintes : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Lors de l’utilisation de superpositions GIF animées : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Commandes de rendu supplémentaires : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Paramètres d\'exportation supplémentaires : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Paramètres de traitement des entrées : »',
      ],
      bullets: [
    ...
    },
    {
      heading: '« Filigrane »',
      paragraphs: [
        '« Ajoutez des filigranes à vos codes QR : »',
      ],
      bullets: [
    ...
    },
    {
      heading: '« Métadonnées »',
      paragraphs: [
        '« Incorporer des métadonnées dans les fichiers exportés : »',
      ],
      bullets: [
    ...
    },
    {
      heading: '« Partage »',
      paragraphs: [
        '« Partagez vos configurations de code QR : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Assurez-vous que les codes QR restent scannables : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Modes de fusion supplémentaires au niveau professionnel : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Paramètres d’exportation d’entreprise : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Fonctionnalités d’animation professionnelles supplémentaires : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Prétraitement d\'image appliqué à la superposition : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Ajouter des filigranes aux codes QR générés : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Pour une sortie GIF animée (nécessite format=gif) : »',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '« Suivez ces directives pour des codes QR fiables : »',
      ],
      bullets: [
