...
export const learn: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Pemindai kamera generik akan memecahkan kode hampir semua kode QR yang telah diformat. Aplikasi pembayaran lebih pickier. Sebelum menyebarkan kode pembayaran QR, uji dengan setiap aplikasi pembayaran yang mungkin digunakan pelangganmu. Dalam lingkungan multi- pembayaran, ini mungkin berarti pengujian dengan beberapa aplikasi perbankan, dompet digital, dan platform pembayaran. Dokumen yang aplikasi Anda telah diuji dan versi mereka - aplikasi pembayaran sering update, dan pemutakhiran bisa mengubah perilaku pemindaian.',
