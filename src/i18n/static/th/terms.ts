...
export const terms: PageDefinition = {
  ...
  description: 'เมื่อคุณเข้าถึงหรือใช้งานเว็บไซต์ คุณตกลงที่จะผูกพันตามข้อกำหนดเหล่านี้',
  ...
  sections: [
    ...
    {
      heading: 'บริการของบุคคลที่สามและโฆษณา',
      paragraphs: [
    ...
    {
      heading: 'การสละสิทธิ์ฟ้องร้องแบบกลุ่ม',
      paragraphs: [
