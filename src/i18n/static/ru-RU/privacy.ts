...
export const privacy: PageDefinition = {
  ...
  description:
    'которую собирает ANQR, способы ее использования и ваши права в соответствии с применимыми законами о защите персональных данных.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Для профессионального использования ANQR предоставляет серверный API, который генерирует QR-коды из параметров URL. При использовании API содержимое вашего QR-кода обрабатывается на наших серверах для отрисовки изображения, но не сохраняется и не регистрируется.',
