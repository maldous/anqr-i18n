  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'При использовании серверного API ваш контент обрабатывается для генерации QR-изображения, но не сохраняется, не регистрируется и не используется для каких-либо других целей, кроме отрисовки запрошенного изображения.',
      ],
    },
    {
    ...
    },
    {
      heading: 'Контакт',
      paragraphs: [
        'относительно данных Условий можно направлять по адресу: ${CONTACT_EMAIL}',
      ],
    },
  ],
}
