...
export const examples: PageDefinition = {
  title: 'Exemple ANQR',
  description:
    'Cinci exemple din lumea reală, în stil de producție, care arată unde codurile QR creează valoare măsurabilă: îmbunătățirea unui cod de contor de vânzare cu amănuntul vechi, plăți de vânzare cu amănuntul de marcă și acțiuni "scanare către", scalarea imprimării de la pliante la panouri publicitare, cod QR animat pentru semnalizare digitală și colaborare interlingvistică folosind linkuri Anchor partajabile. Fiecare exemplu include imagini, constrângeri practice și un link remix înapoi la generator.',
  ...
  primaryLinks: [
    ...
    { href: '/learn?lang=${lang}', label: 'Răsfoiți articolele Learn', type: 'learn' },
    {
      ...
      label: 'Deschideți Ghidul utilizatorului complet',
      type: 'guide',
    },
  ],
  ...
  sections: [
    // ===== Example 1: Uplift Existing Campaign (IDs 1044-1070) =====
    {
      ...
      paragraphs: [
        'Acest exemplu din lumea reală urmărește o mică cafenea care folosea același cod QR pe tejghea timp de trei ani. Codul original a fost generat rapid în timpul aglomerației pandemice, imprimat pe hârtie standard și introdus într-un suport de plastic. Încă funcționa - din punct de vedere tehnic - dar clienții aveau nevoie adesea de mai multe încercări pentru a-l scana și nu a făcut nimic pentru a consolida identitatea de brand atent elaborată a cafenelei.',
        'Transformarea a început cu un audit simplu: codul existent a codificat adresa URL a meniului online al cafenelei, pe care doreau să o păstreze. Provocarea a fost să facă codul QR să pară parte a experienței cafenelei, mai degrabă decât o utilitate ulterioară din 2020.',
      ],
      images: [
        {
          ...
          caption:
            'Punctul de plecare: trei ani de servicii la tejghea au lăsat codul QR original abia funcțional',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Testarea a relevat mai multe probleme: codul original folosea Corecția de Erori L (redundanță minimă), avea o zonă silențioasă de doar 2 module și era imprimat la rezoluție scăzută. Sub iluminarea caldă cu tungsten a cafenelei, modulele negre deja decolorate abia contrastau cu hârtia îngălbenită. Telefoanele mai vechi au avut dificultăți; telefoanele mai noi au avut succes, dar cu o întârziere vizibilă.',
        'Dincolo de problemele tehnice, pătratul generic alb-negru nu comunica nimic despre brand." "Clienții au ezitat înainte de a scana - o barieră subtilă de încredere care a redus interacțiunea cu meniul digital atent conceput al cafenelei.',
      ],
      images: [
        {
          ...
          caption:
            'Analiza tehnică dezvăluie de ce codul vechi a avut performanțe sub așteptări în condiții reale',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Construirea configurației actualizate: fiecare setare aleasă pentru a echilibra expresia mărcii cu fiabilitatea scanării',
        },
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Personalul a raportat mai puține întrebări din partea clienților despre «cum se utilizează codul QR» și că nu au mai fost nevoie de tastare manuală a adresei URL pentru clienții frustrați. Aspectul personalizat a stârnit, de asemenea, conversații, clienții comentând pozitiv designul coerent.',
      ],
      images: [
        {
          ...
          caption:
            'Patru săptămâni de date care arată impactul măsurabil al unei îmbunătățiri atentă a codurilor QR',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Configurația cafenelei demonstrează un branding conservator, dar eficient: Corecție de erori H, zonă silențioasă cu 6 module, culori ale mărcii cu contrast ridicat și o suprapunere centrală minimă. Acest echilibru funcționează pentru majoritatea aplicațiilor de vânzare cu amănuntul, unde fiabilitatea trebuie să fie pe primul loc, dar prezența mărcii contează în continuare.',
        'Deschideți generatorul cu aceste setări preîncărcate și adaptați culorile și suprapunerea la propria marcă. Informația cheie: îmbunătățirile fiabilității pot crește dramatic implicarea, chiar înainte de a adăuga orice stil vizual.',
        'Consultați ghidul de învățare aferent despre îmbunătățirea campaniilor QR existente pentru metodologia completă din spatele acestei abordări.',
      ],
      images: [
        {
    ...
    // ===== Example 2: Branded Retail Payments (IDs 1071-1097) =====
    {
      ...
      paragraphs: [
        'Acest exemplu urmărește un magazin de îmbrăcăminte de tip boutique care acumulase cinci coduri QR diferite la casa de marcat: plată bancară, bacșișuri, Instagram, recenzii Google și un link de angajare. Fiecare a fost generat dintr-o sursă diferită, imprimat la momente diferite și afișat în standuri nepotrivite. Haosul vizual submina estetica atent selectată a magazinului, iar personalul se ocupa în mod regulat de clienți care scanau codul greșit.',
        'Soluția necesita separarea preocupărilor: codurile de plată aveau nevoie de fiabilitate maximă, cu un stil conservator, în timp ce codurile de marketing puteau fi mai expresive. Sistemul de afișare unificat care a apărut demonstrează cum să se echilibreze prezența mărcii cu cerințele funcționale ale diferitelor cazuri de utilizare a codurilor QR.',
      ],
      images: [
        {
          ...
          caption:
            'Punctul de plecare haotic: cinci coduri QR deconectate care concurează pentru atenție și cauzează confuzie în rândul clienților',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Metoda principală de plată a magazinului a folosit un standard regional care impunea respectarea strictă a sarcinii utile. Testele au arătat că până și o ușoară modificare a stilizării a afectat viteza de scanare cu anumite aplicații bancare. Decizia: păstrarea codului QR de plată complet nemodificat, cu excepția optimizării dimensiunii și a imprimării profesionale pe carton mat.',
        'Această abordare conservatoare a însemnat că codul de plată arăta mai puțin «branding» decât era ideal, dar ratele de finalizare a tranzacțiilor s-au îmbunătățit dramatic. Perspectiva: momentele de plată nu sunt oportunități de branding - sunt momente de fiabilitate. Clienții apreciază viteza și certitudinea mai mult decât estetica atunci când sunt implicați bani.',
      ],
      images: [
        {
          ...
          caption:
            'Codul QR de plată: dimensionat generos, imprimat profesional, stilizat conservator pentru recunoaștere instantanee de către aplicațiile bancare',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Pentru sfaturi, recenzii, rețele sociale și angajări, magazinul ar putea fi mai expresiv. Aceste coduri au fost regenerate în ANQR cu un stil de brand consistent: verde măsliniu caracteristic magazinului pe crem, stil de modul rotunjit și o suprapunere centrală subtilă cu pictograma magazinului. Corecția erorilor H a asigurat fiabilitatea chiar și cu stilizarea.',
        'Aceste patru coduri au fost aranjate într-un panou de brand poziționat lângă (fără a concura cu) codul de plată. Etichete clare în tipografia magazinului explicau scopul fiecărui cod." "Ierarhia vizuală a fost intenționată: plata era independentă și proeminentă; acțiunile secundare grupate ca opțiuni.',
      ],
      images: [
        {
          ...
          caption:
            'Panoul de acțiuni secundare: branding consistent, etichetare clară, poziționate ca opțiuni, mai degrabă decât ca distrageri',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Planul sistemului de afișare: ergonomie fizică optimizată pentru scanare fiabilă în funcție de înălțimea clienților și de condițiile de iluminare',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Șase săptămâni de date operaționale care demonstrează impactul asupra afacerii al unui sistem de afișare multi-QR atent conceput',
        },
      ],
      links: [
        {
    ...
    // ===== Example 3: Print Scaling (IDs 1098-1124) =====
    {
      ...
      paragraphs: [
        'Acest exemplu urmărește o companie de producție de evenimente care se pregătea pentru o conferință majoră. Aveau nevoie de același cod QR - care să facă legătura cu aplicația evenimentului - implementat în formate radical diferite: inserții pentru ecusoane de participanți (3 cm), cartonașe pentru corturi la masă (8 cm), semnalizare pentru biroul de înregistrare (30 cm), postere de orientare (60 cm) și un banner masiv pentru fundalul scenei (4 metri). Fiecare format avea distanțe de vizualizare, condiții de iluminare și fluxuri de lucru de producție diferite.',
        'Provocarea nu a fost doar tehnică - a fost operațională." "Mai mulți furnizori gestionau diferite lucrări de imprimare, iar compania trebuia să asigure rezultate consecvente și scanabile, indiferent cine producea ce. Soluția lor s-a concentrat pe exportul SVG și documentația riguroasă a predării.',
      ],
      images: [
        {
          ...
          caption:
            'Un cod QR, cinci dimensiuni de implementare: provocarea menținerii scanabilității de la centimetri la metri',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Analiza criminalistică a erorilor evenimentelor anterioare: fiecare format a introdus probleme de calitate diferite',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Pentru acest eveniment, compania a stabilit un protocol strict: un cod QR master generat în ANQR cu setări optime (Corecție erori H, zonă liniștită generoasă, stilizare curată), exportat ca SVG și stocat ca sursă unică autorizată. Linkul de configurare ANQR a fost documentat alături de fișierul SVG, astfel încât codul să poată fi regenerat dacă este necesar.',
        'Fiecare designer și furnizor a primit același fișier master SVG cu instrucțiuni explicite: plasarea la dimensiunea necesară, nu modificarea, menținerea spațiului liber din zona liniștită. Pentru furnizorii care necesită formate raster, compania a furnizat fișiere PNG pre-randate la dimensiuni specifice, cu convenții de denumire clare care indică utilizarea preconizată.',
      ],
      images: [
        {
          ...
          caption:
            'Pachetul de predare: tot ce aveau nevoie furnizorii pentru a produce rezultate consecvente fără a ghici',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matricea de dimensionare: dimensiuni calculate care asigură o scanare fiabilă la distanța de vizualizare așteptată pentru fiecare format',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Validarea din ziua conferinței a fost sistematică: personalul a testat fiecare cod QR implementat înainte de deschiderea ușilor. Inserțiile pentru insignă au scanat instantaneu la o distanță de un braț. Corturile de masă au funcționat fiabil în iluminatul variabil al sălilor de conferințe. Bannerul scenei - jena evenimentului anterior - a fost scanat cu succes din mijlocul zonei publicului.',
        'Nu au fost înregistrate reclamații privind scanarea pentru peste 2.000 de participanți. Câștigul operațional a fost la fel de semnificativ: când adăugarea unui sponsor în ultimul moment a necesitat o nouă semnalizare, echipa de producție a generat-o din SVG-ul principal în câteva minute, încrezătoare că se va potrivi cu tot restul.',
        'Consultați ghidul de învățare despre coduri QR gata de imprimare pentru cadrul decizional SVG vs PNG și cele mai bune practici de predare.',
      ],
      images: [
        {
          ...
          caption:
            'Succesul din ziua conferinței: scanare fiabilă în fiecare format, de la prim-planuri ale insignelor la fotografii de la distanță ale bannerului scenei',
        },
      ],
      links: [
        {
    ...
    // ===== Example 4: Animated Signage (IDs 1125-1151) =====
    {
      ...
      paragraphs: [
        'Acest exemplu urmărește un salon al unei companii aeriene care folosea coduri QR statice pe ecranele sale digitale de bun venit. Ecranele afișau conținut promoțional rotativ, dar codul QR pentru check-in în salon stătea într-un colț, static și ușor de trecut cu vederea. Analizele au arătat că doar 15% dintre oaspeții eligibili au folosit check-in-ul cu codul QR, în ciuda faptului că era mai rapid decât coada de la recepție. Majoritatea oaspeților pur și simplu nu l-au observat.',
        'Ipoteza era simplă: într-un mediu aglomerat vizual, cu conținut în mișcare, un cod QR static devine invizibil." "Soluția trebuia să facă codul QR vizibil fără a compromite fiabilitatea necesară pentru un flux de check-in unde eșecul ar însemna călători frustrați și cozi mai lungi la ghișeu.',
      ],
      images: [
        {
          ...
          caption:
            'Configurația inițială: un cod QR static pierdut într-o mare de conținut promoțional dinamic, atingând o rată de adoptare de doar 15%',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Semnalizarea digitală a salonului folosea panouri LED mari - un mediu provocator în care animația agresivă putea crea probleme de scanare. Echipa de design a început conservator: un efect de impuls ușor care a extins și contractat subtil prezența vizuală a codului QR fără a modifica structura reală a codului. Temporizarea cadrelor a fost setată lent (250 ms) pentru a evita orice probleme de pâlpâire cu rata de reîmprospătare a LED-urilor.',
        'Validarea modului de siguranță a confirmat că fiecare cadru a rămas scanabil. Testele suplimentare pe panourile LED reale au arătat că impulsul trebuia să fie și mai subtil decât sugerau previzualizările desktopului - luminozitatea și unghiurile de vizualizare ale LED-urilor au afectat contrastul perceput mai mult decât se aștepta.',
      ],
      images: [
        {
          ...
          caption:
            'Configurarea animației: parametri reglați pentru afișarea panoului LED, menținând în același timp fiabilitatea scanării în fiecare cadru',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Codul QR animat a fost poziționat într-o «zonă stabilă» dedicată a aspectului ecranului - o zonă care a rămas constantă în timp ce conținutul promoțional se rotea în zona principală de afișare. Această separare a fost crucială: codul QR avea nevoie de stabilitate vizuală pentru scanare, chiar și în timp ce atrăgea atenția prin animația sa subtilă.',
        'Un îndemn clar la acțiune a fost adăugat lângă codul QR: «Săriți peste coadă - scanați pentru a vă înregistra». Textul a rămas static în timp ce codul QR pulsa, creând o ierarhie vizuală care a atras atenția către oportunitatea de scanare fără a copleși conținutul promoțional.',
      ],
      images: [
        {
          ...
          caption:
            'Alocarea spațiului pe ecran: codul QR animat ocupă o zonă stabilă separată de conținutul promoțional care se rotește',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Codul QR animat a fost exportat ca GIF cu setări optimizate pentru CMS-ul de semnalizare. Considerațiile privind dimensiunea fișierului au contat - sistemul de gestionare a conținutului din lounge avea limite de încărcare, iar fișierele prea mari cauzau sacadarea redării. Exportul final a echilibrat calitatea vizuală în raport cu dimensiunea fișierului prin limitarea paletei de culori și optimizarea numărului de cadre.',
        'Implementarea a inclus o soluție de rezervă: dacă GIF-ul nu se redau din orice motiv, sistemul de semnalizare afișa o copie de rezervă PNG statică. Această redundanță a asigurat că capacitatea de check-in nu se pierdea niciodată din cauza problemelor tehnice cu animația.',
      ],
      images: [
        {
          ...
          caption:
            'Configurație CMS Signage: cod principal animat cu cod de rezervă static, asigurând că funcția de check-in nu este niciodată întreruptă',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Date pe o lună: creștere cu 60% a adopției, timpi de așteptare reduși și menținerea unei fiabilități perfecte a scanării',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Provocarea: 12 piețe, 8 limbi și un istoric al implementărilor QR inconsistente în diferite regiuni',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Echipa globală a mărcii a creat configurația QR autorizată în ANQR: culorile mărcii se potrivesc cu identitatea vizuală a liniei de produse, corectarea erorilor H pentru fiabilitate în toate aplicațiile tipărite și digitale și un stil care s-ar reproduce în mod constant, indiferent de metodele de producție locale. Configurația a fost blocată, iar linkul de partajare a fost documentat în brief-ul campaniei globale.',
        'În mod critic, adresa URL codificată a folosit un serviciu de redirecționare pentru detectarea limbii. La scanare, utilizatorii au fost direcționați automat către pagina produsului în limba lor locală." "Aceasta însemna că toate cele 12 piețe puteau utiliza coduri QR identice - fără variații ale sarcinii utile per piață care ar putea introduce erori.',
      ],
      images: [
        {
          ...
          caption:
            'Configurația principală: standarde globale ale mărcii codificate într-o singură sursă de adevăr, partajabilă',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Aceeași configurație, interfețe diferite: echipele regionale lucrează în limba lor preferată, menținând în același timp consecvența globală',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Unele piețe au necesitat adaptări minore. Echipa chineză avea nevoie de o versiune cu un cadru optimizat pentru WeChat pentru partajarea socială. În loc să modifice versiunea master, au creat o variantă documentată cu propriul link de configurare, etichetat clar ca "Varianta CN-WeChat" în biblioteca de resurse a campaniei. Acest lucru a menținut trasabilitatea, permițând în același timp localizarea necesară.',
        'Echipa de brand a stabilit o regulă simplă: orice variație față de versiunea master necesita un link de configurare nou, documentat. Fără modificări la fișierele exportate, fără «remedieri rapide» în software-ul de design. Acest lucru a prevenit deviația configurației care afectase lansările anterioare.',
      ],
      images: [
        {
          ...
          caption:
            'Guvernanța activelor campaniei: configurația principală plus variantele documentate, toate trasabile prin linkuri de configurare',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'În ziua lansării produsului, coduri QR au fost implementate simultan pe ambalaje, afișaje de retail, materiale de evenimente și campanii digitale pe toate cele 12 piețe. Auditurile de calitate au confirmat consecvența vizuală în toate regiunile - codul QR de pe afișajele de retail din Tokyo se potrivea cu codul QR de pe ambalajele din São Paulo se potrivea cu codul QR de pe bannerele evenimentelor din Berlin.',
        'Nu au fost raportate erori de scanare pe toate piețele. Când a fost necesară o modificare a adresei URL a paginii produsului după lansare, serviciul de redirecționare a gestionat-o invizibil - nu a fost necesară retipărirea. Echipa globală a estimat că abordarea linkului de configurare a economisit peste 40 de ore de timp de coordonare în comparație cu metodologia lor anterioară de lansare.',
        'Consultați ghidul Learn despre colaborarea QR interlingvistică pentru principiile fluxului de lucru din spatele consecvenței campaniilor globale.',
      ],
      images: [
        {
          ...
          caption:
            'Consecvență globală atinsă: prezentare QR identică pe 12 piețe, în ciuda diferitelor limbi, furnizori și formate',
        },
      ],
      links: [
        {
