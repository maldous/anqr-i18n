  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Pentru uz profesional, ANQR oferă un API server-side care generează coduri QR din parametri URL. Atunci când utilizați API-ul, conținutul dvs. QR este procesat pe serverele noastre pentru a reda imaginea, dar nu este stocat sau înregistrat.',
        'Utilizăm Google AdSense pentru publicitate și este posibil să utilizăm servicii de analiză. Aceste servicii colectează informații prin cookie-uri și tehnologii similare. Această politică explică ce date sunt colectate, cum sunt utilizate și drepturile dvs..',
      ],
    },
    {
      heading: 'Informații pe care le colectăm',
      bullets: [
        'Informații pe care le furnizați: Dacă ne contactați prin e-mail sau prin formularul nostru de contact, colectăm numele, adresa de e-mail și conținutul mesajului dumneavoastră.',
    ...
    },
    {
      ...
      paragraphs: [
        'ANQR nu setează cookie-uri proprii. Preferințele dumneavoastră (cum ar fi modul întunecat) sunt stocate local pe dispozitivul dumneavoastră, care nu este transmis către niciun server.',
    ...
    },
    {
      ...
      paragraphs: [
        'Afișăm reclame prin Google AdSense. Google și partenerii săi utilizează cookie-uri pentru a difuza anunțuri pe baza istoricului dvs. de navigare pe acest site și pe alte site-uri web (publicitate bazată pe interese).',
        ...
        'Renunțați prin intermediul Network Advertising Initiative: https://optout.networkadvertising.org',
    ...
    },
    {
      ...
      bullets: [
        'Pentru a răspunde la solicitările dvs. și a oferi asistență.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Netlify (găzduire): Procesează cereri și poate înregistra adrese IP.',
        'Nu vindem informațiile dumneavoastră personale. Cu toate acestea, partajarea datelor cu partenerii de publicitate poate fi considerată o «vânzare» în conformitate cu CCPA (vezi mai jos).',
      ],
    },
    {
      heading: 'Păstrarea datelor',
      bullets: [
        'Trimiterea de contacte: Până la 2 ani.',
        'Jurnale de server: Până la 30 de zile (furnizor de găzduire).',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Dreptul de a restricționa prelucrarea: Solicitați limite privind modul în care utilizăm datele dumneavoastră.',
        'Dreptul la portabilitatea datelor: Solicitați datele dumneavoastră într-un format portabil.',
        'Dreptul de a obiecta: Opuneți-vă prelucrării, inclusiv pentru marketing direct.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Dreptul de ștergere: Solicitați ștergerea informațiilor dumneavoastră personale.',
    ...
    },
    {
      heading: 'Nu urmăriți',
      paragraphs: [
        'Onorăm semnalele browserului "Nu urmăriți" acolo unde este posibil, deși partenerii de publicitate pot să nu răspundă la DNT.',
      ],
    },
    {
      heading: 'Modificări ale acestei politici',
      paragraphs: [
        'Putem actualiza periodic această politică. Data "Ultima actualizare" indică cea mai recentă revizuire. Modificările semnificative pot fi comunicate prin intermediul unui banner al site-ului.',
      ],
    },
    {
