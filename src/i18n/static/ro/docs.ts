...
export const docs: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Format: Alegeți formatul de export în funcție de cazul de utilizare.”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Controlează comportamentul codului QR animat:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Nivelul avansat deblochează formate suplimentare de sarcină utilă:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Capacități suplimentare de suprapunere:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Moduri de amestecare suplimentare în nivelul Avansat:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Mod culoare”',
      paragraphs: [
        '"Cum este procesată imaginea suprapusă:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Cum se potrivește imaginea suprapusă în zona codului QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Când se utilizează modul de amestecare Subpixel:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Când se utilizează modul de amestecare semitonuri:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Când se utilizează suprapuneri GIF animate:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Controale suplimentare de randare:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Setări de procesare a datelor de intrare:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Filigran”',
      paragraphs: [
        '"Adăugați filigrane la codurile QR:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Metadate”',
      paragraphs: [
        '"Încorporarea metadatelor în fișierele exportate:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Împărtășire”',
      paragraphs: [
        '"Partajați configurațiile codului QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Asigurați-vă că codurile QR rămân scanabile:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Nivelul profesional adaugă tipuri de conținut pentru plăți și întreprinderi:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Moduri de amestecare suplimentare la nivelul Profesional:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Setări de export pentru întreprindere:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Funcții suplimentare de animație profesională:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Parametri obligatorii și comuni (numele parametrilor nu sunt traduse):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Stilizarea modulelor și a modelelor:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Preprocesarea imaginii aplicată suprapunerii:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Adăugați filigrane la codurile QR generate:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Pentru ieșirea GIF animată (necesită format=gif):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Urmați aceste instrucțiuni pentru coduri QR fiabile:”',
      ],
      bullets: [
