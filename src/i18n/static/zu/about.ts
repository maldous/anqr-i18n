...
export const about: PageDefinition = {
  ...
  description:
    'I-ANQR iyisikhiqizi samakhodi e-QR samahhala esinendlela yokuqagela iklayenti — khiqiza amakhodi e-QR endaweni noma sebenzisa i-API yethu ukuze ushumeke.',
