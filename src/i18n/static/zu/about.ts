...
export const about: PageDefinition = {
  ...
  description:
    'I-ANQR iyijeneretha yamakhodi e-QR yamahhala enendlela yokusebenzisa iklayenti kuqala - khiqiza amakhodi e-QR endaweni noma sebenzisa i-API yethu yokufaka.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'I-ANQR (ebizwa ngokuthi "i-anchor") iyijeneretha yamakhodi e-QR yamahhala edala amakhodi askeniwayo ama-URL, umbhalo, iziqinisekiso ze-Wi-Fi, amakhadi okuxhumana, imicimbi yekhalenda, nokuningi.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Yenza ngezifiso imibala, izitayela zamamojula, amaphethini okuthola, bese wengeza ukunqwabelanisa kwezithombe.',
        'Thumela ngamafomethi amaningi: i-PNG, i-SVG, i-WebP, kanye ne-GIF egqwayiziwe.',
        'Ukulawula okuthuthukisiwe kwezinga lokulungisa amaphutha, inguqulo ye-QR, imodi yokufaka ikhodi, kanye nokukhetha imaski.',
        'Isiqondiso sokuphepha kokuskena kanye nokubuka kuqala bukhoma ukusiza ukugcina amakhodi efundeka ekuphrintiwe nasezikrinini.',
    ...
    },
    {
      ...
      paragraphs: [
        'I-ANQR isebenza kusiphequluli sakho futhi ifaka ikhodi yokufaka kwakho ku-matrix ejwayelekile ye-QR ngokulungiswa kwamaphutha kaReed--Solomon, bese iyiguqulela kufomethi oyikhethayo.',
        ...
        'Uma ungeza ama-overlays noma ama-animation, i-ANQR ilinganisa isitayela nokuthembeka kokuskena ukuze umphumela uhlale uskenwa.',
        'I-ANQR igxile kumakhodi angaguquki (idatha ingaphakathi kwe-QR). Uma udinga ikhodi enamandla (indawo ehlelekayo), ungafaka ikhodi ye-URL yakho yokuqondisa kabusha noma isixhumanisi esifushane.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'I-ANQR imahhala ukuyisebenzisa futhi isekelwa ukukhangisa. Singabonisa izikhangiso nge-Google AdSense kanye/noma abanye ozakwethu bokukhangisa.',
        ...
        'Asithengisi okuqukethwe okufaka ikhodi kumakhodi e-QR. Izikhangiso zisiza ukumboza izindleko zokusebenzisa nokuthuthukisa iphrojekthi.',
      ],
    },
    {
      heading: 'Izindinganiso ezivulekile',
      paragraphs: [
        'I-ANQR ikhiqiza amakhodi e-QR ngokusekelwe kuzinga le-ISO/IEC 18004 futhi ihlose ukuhambisana okubanzi kuzo zonke izikena, amakhamera, kanye nemisebenzi yokuphrinta.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Samukela impendulo, imibiko yeziphazamiso, kanye neziphakamiso zezici. Sicela uxhumane nathi nge-imeyili noma ikhasi lokuxhumana - sifunda yonke imilayezo, yize izikhathi zokuphendula zingahluka.',
      ],
    },
  ],
};
