...
export const learn: PageDefinition = {
  ...
  sections: [
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: ['Ikhodi ye-QR eklanywe kahle ehluleka ukuskena imbi kakhulu kunokuba ingasebenzi - iyacasula amakhasimende, yonakalise umbono womkhiqizo, futhi ichitha yonke imithombo etshalwe ekudalweni nasekusatshalalisweni kwayo. Lo mhlahlandlela uhlanganisa izici zobuchwepheshe nezisebenzayo ezinquma ukuthi ikhodi ye-QR izoskena ngokwethembeka yini, nokuthi ungayisebenzisa kanjani izici zokuphepha ze-ANQR ukuze ubambe izinkinga ezingaba khona ngaphambi kokuba zifinyelele ekukhiqizweni.', 'Ukuthembeka kwekhodi ye-QR akuyona into ephindwe kabili. Ikhodi ingase iskena kahle kumafoni amakhulu kodwa yehluleke kumadivayisi ashibhile. Ingase isebenze ekukhanyeni okuhle kodwa ihlupheke ezindaweni zokudlela ezimnyama noma elangeni elikhanyayo. Ukuqonda izici ezithinta ukuskenwa kukusiza ukuthi wenze ukuguquguquka okunolwazi phakathi kwesitayela esibonakalayo kanye nokuthembeka kwangempela.'],
      images: [
        {
