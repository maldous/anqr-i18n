...
export const contact: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Joyina umphakathi wethu we-Reddit kwa-r/ANQR ukuze wabelane ngendalo yakho ye-QR, ubuze imibuzo, uthole usizo, futhi uxhumane nabanye abasebenzisi be-ANQR.',
      ],
    },
  ],
};
