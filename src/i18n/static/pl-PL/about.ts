...
export const about: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '"ANQR działa jako niezależne narzędzie internetowe. W przypadku pytań, pomocy technicznej lub zapytań biznesowych prosimy o skorzystanie ze strony Kontakt lub wysłanie wiadomości e-mail”.' + CONTACT_EMAIL + '".”',
      ],
    },
    {
