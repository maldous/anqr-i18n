...
export const privacy: PageDefinition = {
  ...
  description:
    'المعلومات التي تجمعها ANQR، وكيفية استخدامها، وحقوقك بموجب قوانين الخصوصية المعمول بها.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'للاستخدام الاحترافي، توفر ANQR واجهة برمجة تطبيقات من جانب الخادم تنشئ رموز QR من معلمات URL. عند استخدام واجهة برمجة التطبيقات، تتم معالجة محتوى QR الخاص بك على خوادمنا لعرض الصورة، لكن لا يتم تخزينه أو تسجيله.',
