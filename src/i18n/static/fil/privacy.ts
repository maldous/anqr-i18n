...
export const privacy: PageDefinition = {
  ...
  relatedLinks: [{ href: '/terms?lang=${lang}', label: 'Mga Termino ng Paglilingkod', type: 'external' }],
  sections: [
    {
      heading: 'Sumaryo',
