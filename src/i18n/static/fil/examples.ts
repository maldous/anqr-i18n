...
export const examples: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Para sa kaganapang ito, nagtatag ang kumpanya ng mahigpit na protocol: isang master QR na nabuo sa ANQR na may pinakamainam na mga setting (Error Correction H, generous quiet zone, malinis na styling), na-export bilang SVG, at naka-store bilang nag-iisang authoritative source. Ang link ng pagsasaayos ng ANQR ay naidokumento sa tabi ng SVG file upang ang code ay muling mabuo kung kinakailangan.',
    ...
    },
    {
      ...
      paragraphs: [
        'Sistematiko ang pagpapatunay sa araw ng kumperensya: sinubukan ng mga kawani ang bawat naka-deploy na QR bago magbukas ng mga pinto. Agad na na-scan ang mga pagsingit ng badge sa haba ng braso. Ang mga table tent ay gumagana nang mapagkakatiwalaan sa variable na pag-iilaw ng mga breakout room. Ang banner ng entablado - ang kahihiyan ng nakaraang kaganapan - ay matagumpay na na-scan mula sa gitna ng audience area.',
    ...
    },
    {
      ...
      paragraphs: [
        'Ang animated na QR ay na-export bilang GIF na may mga naka-optimize na setting para sa signage CMS. Ang mga pagsasaalang-alang sa laki ng file ay mahalaga - ang sistema ng pamamahala ng nilalaman ng lounge ay may mga limitasyon sa pag-upload, at ang sobrang malalaking file ay nagdulot ng pagkautal sa pag-playback. Ang huling pag-export ay balanseng visual na kalidad laban sa laki ng file sa pamamagitan ng paglilimita sa color palette at pag-optimize ng bilang ng frame.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Kritikal, ang naka-encode na URL ay gumamit ng serbisyo sa pag-redirect sa pagtukoy ng wika. Kapag na-scan, ang mga user ay awtomatikong nai-ruta sa kanilang pahina ng produkto ng lokal na wika. Nangangahulugan ito na ang lahat ng 12 market ay maaaring gumamit ng magkatulad na QR code - walang per-market payload variation na maaaring magpakilala ng mga error.',
      ],
      images: [
        {
