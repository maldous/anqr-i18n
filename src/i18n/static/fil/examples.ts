...
export const examples: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Ang pasimula: Tatlong taon ng counter service ay nag - iwan sa orihinal na QR na hindi gaanong gumagana',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Isinisiwalat ng teknikal na pagsusuri kung bakit ang kodigo ng pamana na isinasagawa sa tunay na mga kalagayan sa daigdig',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Sa paggamit ng ANQR, muling binago ng may - ari ng café ang kodigo sa pamamagitan ng magkatulad na menu na URL subalit lubhang bumuti ang kalagayan: Error sa pagtutuwid H para sa sukdulang pagiging matatag, isang 6-module na tahimik na sona para sa maaasahang direksyon ng hangganan, at mga kulay ng tatak (malalalim na burgundy module na nasa likuran ng krema) na nagtutugma sa panloob na lebel ng café.',
      ...
      images: [
        {
          ...
          caption:
            'Pagtatayo ng upgraded configuration: bawat setting na pinili upang balansehin ang brand expression ng scan pagkamaaasahan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Matapos ilagay ang bagong QR sa propesyonal na mate-lainated card stock, ang café tracked ay nagbunga ng mahigit apat na linggo. Ang bilis ng tagumpay ng Scan ay sumulong mula tinatayang 70% hanggang sa halos-100%. Ang average na oras ng scan ay bumaba mula 3-4 segundo hanggang sa wala pang 1 segundo. Kapansin - pansin, ang tipanan sa menu ay dumami ng 40% - mga parokyano na dati'y sumulyap sa QR at sumuko na ay may pagtitiwalang nagsusuri ngayon.",
        "Si Staff ay nag-ulat ng mas kaunting mga tanong ng parokyano tungkol sa 'how upang gamitin ang QR' at wala nang mga pagkakataon ng manufacturing ang URL para sa mga bigong parokyano. Ang may markang hitsura ay pumukaw rin ng mga pag - uusap, na ang mga parokyano ay positibong nagkokomento tungkol sa disenyo ng cohesive.",
      ],
      images: [
        {
          ...
          caption:
            'Apat na linggong datos na nagpapakita ng di - mabilang na epekto ng maingat na pagdami ng QR',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang pagsasaayos ng karinderya ay nagpapakita ng konserbatibo ngunit epektibong pag-uuri: Error sa pagtutuwid H, 6-module tahimik zone, high-contrast brand colors, at isang maliit na gitnang balot. Ang pagkakatimbang na ito ay mabisa para sa karamihan ng mga kontraksiyon sa tingi kung saan ang pagkamaaasahan ay dapat na mauna subalit ang pagkakaroon ng tatak ay mahalaga pa rin.',
        'Buksan ang generator ng mga setting na ito nang pre-based at i-akma ang mga kulay at claim sa iyong sariling brand. Ang susing pang - unawa: Ang maaasahang mga pagsulong lamang ay maaaring lubhang makaragdag sa tipanan, bago pa man magdagdag ng anumang nakikitang pagbabago.',
        'Tingnan ang kaugnay na gabay ng Learn tungkol sa pagpapabuti ng mga umiiral na kampanya ng QR para sa buong metolohiya sa likod ng pamamaraang ito.',
      ],
      images: [
        {
    ...
    // ===== Example 2: Branded Retail Payments (IDs 1071-1097) =====
    {
      ...
      paragraphs: [
        "Ang halimbawang ito ay sumusunod sa isang tindahan ng damit na boutique na nakapagtipon ng limang iba't ibang code ng QR sa kanilang rehistro: pagbabayad sa bangko, mga tip, Instagram, mga review ng Google, at isang pag-arkila ng link. Ang bawat isa ay ginawa mula sa iba't ibang pinagmulan, inilimbag sa iba't ibang panahon, at nakadispley sa mga puwestong may sira. Ang kaguluhan sa paningin ay nagpapahina sa maingat na kulot na kagandahan ng tindahan, at ang mga kawani ay regular na nakikitungo sa mga parokyano na sinusuri ang maling kodigo.",
        "Ang lunas ay nangangailangan ng paghihiwalay ng mga pagkabahala: ang mga kodigo sa pagbabayad ay nangangailangan ng sukdulang pagkamaaasahan sa konserbatibong pagtitipid, samantalang ang mga kodigo sa pagbebenta ay maaaring maging mas maliwanag. Ang nagkakaisang sistemang display na lumitaw ay nagpapakita kung paano balansehin ang presensiya ng brand laban sa mga functional na mga kahilingan ng iba't ibang QR na gumagamit ng mga kaso.",
      ],
      images: [
        {
          ...
          caption:
            'Ang magulong panimulang punto: limang hindi kilalang kodigo ng QR na nakikipagpaligsahan para sa atensiyon at nagiging sanhi ng kalituhan ng parokyano',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Ang bayad na QR: malaki, inilimbag nang propesyonal, konserbatibo para sa kagyat na pagkilala sa pamamagitan ng mga app sa bangko',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Ang secondary action panel: hindi nagbabagong branding, malinaw na labelling, na nakapuwesto bilang mga pagpipilian sa halip na mga pang - abala',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang pisikal na pagtatanghal ay sabay - sabay na lumutas ng ilang problema. Kapuwa ang patungan ng kabayaran at ang secondary panel ay gumamit ng mga materyales na matte upang alisin ang nakasisilaw na liwanag mula sa liwanag sa itaas. Ang Heights ay tamang - tama para sa mga parokyano na iba - iba ang taas. Ang singles ay nakatuon sa customer queue sa halip na patag sa counter.',
      ...
      images: [
        {
          ...
          caption:
            'Programa ng sistema ng pagtatanghal: Ang pisikal na mga ergonomics ay tamang - tama para sa maaasahang pagsusuri sa itaas ng parokyano at sa mga kalagayan ng ilaw',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Anim na linggo pagkatapos ng pagpopondo, dokumentado ng tindahan ang mahalagang mga pagsulong: mga reklamo ng mga parokyanong sero tungkol sa kalituhan ng kodigo, mas mabilis na mga panahon ng transaksiyon, at isang 3x na pagtaas ng mga pagsumite ng tip (mahahanap ngayon ng mga parokyano at sinusuri ang kodigo ng tip nang hindi naaasiwang nagtatanong ng mga tauhan). Ang mga review ng Google ay dumami rin habang ang dedikado at mahusay na-labeled QR ay nag-aalis ng pagkikiskisan.',
        "Naging mas simple ang pagsasanay sa Staff: Ang 'payment code ay ang malaki, lahat ng iba pa ay nasa panel.' Kapag ang mga app sa pagbabayad ay binago at ang isa ay sandaling nagpakita ng mas mabagal na pagsusuri, ang konserbatibong disenyo ng kodigo ng pagbabayad ay nangangahulugan pa rin na ito ay bahagyang mas mabagal sa halip na lubusang bumagsak.",
        'Tingnan ang Learn guide sa QR codes para sa mga retail na pagbabayad para sa mga prinsipyo sa likod ng display system design na ito.',
      ],
      images: [
        {
          ...
          caption:
            'Anim na linggo ng operating data na nagpapakita ng epekto sa negosyo ng isang maalalahaning multi-QR display system',
        },
      ],
      links: [
        {
    ...
    // ===== Example 3: Print Scaling (IDs 1098-1124) =====
    {
      ...
      paragraphs: [
        "Sinusunod ng halimbawang ito ang isang kompanya ng produksiyon na naghahanda para sa isang malaking komperensiya. Kailangan nila ang parehong QR code - linking sa pangyayaring ito na naka-pped sa kabila ng lubhang iba't-ibang format: staine badge inscriptions (3cm), table tent cards (8cm), register desk signage (30cm), standing posters (60cm), at isang malaking stage band (4 metres). Ang bawat format ay may iba't ibang distansiya sa pagmamasid, mga kalagayan sa ilaw, at mga workflow sa produksiyon.",
        "Ang hamon ay hindi lamang sa teknikal na paraan. Maraming nagtitinda ang humahawak ng iba't ibang trabahong pang - imprenta, at kailangang tiyakin ng kompanya ang di - nagbabago at madaling suriing mga resulta anuman ang gawin. Ang kanilang solusyon ay nakasentro sa pagluluwas ng SVG at mahigpit na mga dokumentasyon sa pamamagitan ng handoff.",
      ],
      images: [
        {
          ...
          caption:
            'Isang kodigong QR, limang sukat ng estimulasyon: ang hamon ng pagpapanatili ng scannity mula sa centimetres hanggang sa metres',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Ang forensic analysis ng nakaraang mga kabiguan sa pangyayari: ang bawat format ay nagpakilala ng iba't ibang mga problema sa kalidad",
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Para sa pangyayaring ito, ang kompanya ay nagtatag ng isang mahigpit na protocol: isang master QR na nilikha sa ANQR na may optimyal na settings (Error recision H, bukas-loob na tahimik na sona, malinis na styling), imported bilang SVG, at naimbak bilang ang nag-iisang may awtoridad na pinagmulan. Ang ANQR configuration link ay dokumentado sa tabi ng SVG file upang ang code ay muling ma-renew kung kinakailangan.',
        'Ang bawat disenyador at tindero ay tumanggap ng iisang SVG master na may maliwanag na mga tagubilin: ilagay sa kinakailangang laki, huwag baguhin, panatilihin ang tahimik na sona. Para sa mga tindero na nangangailangan ng mga radyo format, ang kompanya ay nagbigay ng mga pre-rendered PNG sa mga espesipikong sukat na may malinaw na pagpapangalan sa mga kombensiyon na nagpapahiwatig ng nilalayong paggamit.',
      ],
      images: [
        {
          ...
          caption:
            'Ang package: lahat ng bagay na kailangan ng mga nagtitinda upang magkaroon ng di - nagbabagong resulta nang hindi humuhula',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang bawat format ay nangangailangan ng espesipikong atensiyon. Ang mga ipinasok ni Badge sa 3cm ay nangangailangan ng QR upang umokupa ng sukdulang magagamit na distansiya sa pagitan ng space scanning ay ang haba ng braso. Kasama sa mga toldang may tig - 8cm ang mapalamuting pamumumuti sa labas ng tahimik na sona. Ang 4-metre baner ay nangangailangan ng kalkulasyon: mula sa karaniwang layo ng manonood (15-20 metres), ang mga module ay kailangang malinaw na makilala sa pamamagitan ng mga kamera ng telepono, na nangangahulugang ang QR ay kailangan upang maging hindi bababa sa 80cm sa loob ng disenyo ng baner.',
        'Ang kompanya ay lumikha ng isang senizing guide documenting minimum QR dimensiyons para sa bawat inaasahang scanning distance. Ito ay naging isang magagamit na muli para sa mga pangyayari sa hinaharap, inaalis ang panghuhula mula sa proseso ng disenyo.',
      ],
      images: [
        {
          ...
          caption:
            'Ang pagpepetsa ng matrix: pagtatantiya ng mga dimensiyon upang matiyak ang maaasahang pagsusuri sa bawat inaasahang distansiya ng bawat format',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Ang pag-aalsa ng Conference ay sistematiko: sinubok ng mga tauhan ang bawat naka-set na QR bago magbukas ang mga pinto. Agad na sinuri ang haba ng badge. Ang mga tolda sa hapon ay mabisang nagtatrabaho sa iba't ibang ilaw ng mga silid na pinagpuputol - dikit. Ang stage baner - ang naunang pangyayari ay matagumpay na nai-edit mula sa gitna ng lugar ng manonood.",
        'Ang Zero scanning na mga reklamo ay itinala sa 2,000+ na mga dumalo. Ang panalo ng operasyon ay parehong mahalaga: kapag ang isang huling-minutong sponsor ay nangangailangan ng bagong signage, ang pangkat ng produksiyon ay lumilikha nito mula sa master SVG sa mga minuto, nagtitiwala na ito ay magtutugma sa lahat ng iba pang bagay.',
        'Tingnan ang Learn guide sa mga print-ready QR code para sa SVG vs na desisyon balangkas at handoff pinakamahusay na mga gawain.',
      ],
      images: [
        {
          ...
          caption:
            'Tagumpay sa araw ng Conference: maaasahang scanning sa bawat format, mula sa badge close-ups hanggang sa mga band distance shot',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ang orihinal na setup: isang static QR na nawala sa isang dagat ng dinamikong promosyonal na nilalaman, na nakakamit lamang ang 15% pag-aampon',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animation configuration: Ang mga parameter ay nag - aayos ng LED panel habang pinananatili ang pagiging maaasahan ng scan sa bawat balangkas',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pagbuo ng lupa at lupa: Ang aktibong QR ay sumasakop sa isang matatag na sona na hiwalay sa umiikot na nilalamang promosyonal',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang masiglang QR ay niluluwas bilang isang GIF na may optimisadong settings para sa signage CMS. Ang mga pagsasaalang - alang ng laki ng talaksan - ang sistema ng pangangasiwa sa nilalaman ng palikuran ay may hangganan, at ang labis - labis na malalaking file ay naging sanhi ng pagkautal sa playback. Ang panghuling iniluluwas na timbang na visual quality laban sa laki ng file sa pamamagitan ng pagtatakda ng color paleta at optimising frame count.',
        'Ang Deployment ay kinabibilangan ng isang fallback: kung ang GIF ay hindi makapaglaro sa anumang kadahilanan, ang sistema ng signage ay magpapakita ng static PNG backup. Ang redundancy na ito ay natiyak na kakayahan ng tseke-in ay hindi kailanman nawala dahil sa teknikal na mga isyu sa animation.',
      ],
      images: [
        {
          ...
          caption:
            'Signage CMS configuration: Ang masiglang panimula na may static fallback na tumitiyak sa kakayahan ng check-in ay hindi kailanman naaabala',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Pagkatapos ng isang buwang operasyon, ang QR check-in ampon ay tumaas mula 15% tungo sa 24% - isang 60% relatibong pagpapabuti. Ang mga surbey ng Guest feedback ay nagpapahiwatig na ang masiglang QR ay 'easier upang mapansin' at 'nadamang mas moderno.' Desk queue times measurely nabawasan sa mga peak period habang mas maraming mga bisita self-served sa pamamagitan ng QR.",
        'Mahalaga, ang sero scanning ay iniulat sa kabila ng libu - libong mga scan. Ang konserbatibong animasyong pamamaraan ay nakamit ang tunguhing pansin nang hindi isinasakripisyo ang pagiging maaasahan na hinihingi ng isang pagsusuri-in stream. Pagkatapos, ang pahingahang - dako ay naglabas ng katulad na masiglang mga QR sa kanilang iba pang mga lokasyon.',
        'Tingnan ang Learn guide sa masiglang QR codes para sa digital signage para sa teknikal na mga simulain sa likod ng ligtas na disenyo ng animation.',
      ],
      images: [
        {
          ...
          caption:
            'Isang buwan ng datos: 60% pag - aampon, nabawasang oras ng pag - aampon, at napananatili ang ganap na pagkamaaasahan ng scan',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ang hamon: 12 pamilihan, 8 wika, at isang kasaysayan ng pabagu - bagong pagpapatupad ng QR sa mga rehiyon',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang global brand team ay lumikha ng autorital na QR configuration sa ANQR: ang mga kulay ng tatak ay tumutugma sa visual identity ng produkto, ang Error recision H para sa pagkamaaasahan sa lahat ng print at digital application, at styling na walang pagbabagong mag-ebolb anuman ang mga lokal na paraan ng produksiyon. Ang kaayusan ay naikandado at ang kawing ng bahagi na dokumentado sa pangglobong kampanya ay maikli.',
        'Sa kritikal na paraan, ang naka-set na URL ay gumamit ng isang language-detective redirect service. Kapag sinuri, ang mga gumagamit nito ay awtomatikong dinadala sa kanilang lokal na pahina ng produkto. Ito ay nangangahulugang ang lahat ng 12 merkado ay maaaring gumamit ng identical QR code - no per-market payload na mga pagkakaiba na maaaring magpahiwatig ng mga pagkakamali.',
      ],
      images: [
        {
          ...
          caption:
            'Ang master configuration: Ang mga pamantayan ng mga tatak sa buong daigdig na inilakip sa iisang pinagmumulan ng katotohanan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ang bawat pangkat sa panrehiyong pagbebenta ay tumanggap ng ugnayan sa pagsasaayos sa pamamagitan ng simpleng mga instruksiyon: buksan ang kawing, tiyakin ang patiunang pagsusuri na katugma ng mga tuntunin ng tatak, iluwas sa kinakailangang format para sa iyong aplikasyon. Ang ANQR interface ay nagtanghal sa mas gustong wika ng bawat koponan, ngunit ang nakapailalim na QR settings ay nanatiling magkatulad anuman ang interface language.',
        'Kapag ang koponang Hapones ay nangangailangan ng SVG para sa mga high-end retail display at ang koponan ng Brazil ay nangangailangan ng PNG para sa social media, pareho silang nagluwas mula sa parehong configuration. Nang humiling ng espesipikong halaga ng kulay ang tindahan ng Alemang pangkat, maaari nilang tuwirang banggitin ang kaayusan sa halip na hulaan ito mula sa screenshot.',
      ],
      images: [
        {
          ...
          caption:
            "Magkaparehong pagsasaayos, iba't ibang interface: Ang mga pangkat na pangrehiyon ay nagtatrabaho sa kanilang mas gustong wika samantalang pinananatili ang pangglobong pagkakasuwato",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Kampanya asset governrance: master configuration at dokumentadong mga variant, na pawang matutunton sa pamamagitan ng mga kawing ng pagsasaayos',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Nakita ng mga product launch day ang mga code ng QR na nakalagay sa mga pakete, mga retail display, mga materyales para sa okasyon, at mga digital na kampanya sa lahat ng 12 pamilihan nang sabay-sabay. Ang mahusay na mga audit ay nagpatunay ng nakikitang pagkakasuwato sa ibayo ng mga rehiyon - ang QR sa mga retail display sa Tokyo ay nagtugma sa QR sa São Paulo package ay nagtugma sa QR sa mga band ng laro sa Berlin.',
        'Ang mga kabiguan ng Zero scanning ay iniulat sa ibayo ng mga pamilihan. Nang kailanganin ang isang post-launch product page URL change, ang redirect service ay humawak dito nang hindi nakikita - walang muling paglilimbag na kinakailangan. Tinataya ng pangglobong pangkat na ang paraan ng pag - uugnay ay nakatipid ng 40+ oras ng koordinasyon ng panahon kung ihahambing sa kanilang dating paraan ng paglulunsad.',
        'Tingnan ang Learn guide tungkol sa cross-lingual QR cooperation para sa gumaganang mga prinsipyo sa likod ng global campaign.',
      ],
      images: [
        {
          ...
          caption:
            "Nakamit ang pangglobong pagbabago: ang magkatulad na presentasyon ng QR sa 12 pamilihan sa kabila ng iba't ibang wika, tindero, at format",
        },
      ],
      links: [
        {
