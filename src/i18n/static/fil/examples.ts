...
export const examples: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['Ang masiglang QR ay niluluwas bilang isang GIF na may optimisadong settings para sa signage CMS. Ang mga pagsasaalang - alang ng laki ng talaksan - ang sistema ng pangangasiwa sa nilalaman ng palikuran ay may hangganan, at ang labis - labis na malalaking file ay naging sanhi ng pagkautal sa playback. Ang panghuling iniluluwas na timbang na visual quality laban sa laki ng file sa pamamagitan ng pagtatakda ng color paleta at optimising frame count.', 'Ang Deployment ay kinabibilangan ng isang fallback: kung ang GIF ay hindi makapaglaro sa anumang kadahilanan, ang sistema ng signage ay magpapakita ng static PNG backup. Ang redundancy na ito ay natiyak na kakayahan ng tseke-in ay hindi kailanman nawala dahil sa teknikal na mga isyu sa animation.'],
      images: [
        {
