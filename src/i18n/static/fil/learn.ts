...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Bago at pagkatapos: Ang destinasyon ding iyon na URL ay nagbago mula sa isang pinetsahang kodigong generic tungo sa isang propesyonal na kilalang asset',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR codes na nilikha sa panahon ng maagang yugto ng pag-aampon - partikular na sa panahon ng 2020-2021 nang ang mga negosyo ay sumugod upang ipatupad ang mga walang pakikipag-ugnayang solusyon - kadalasang dumaranas ng ilang mga kritikal na isyu. Nagiging marupok ang mga ito kapag nakalimbag sa mga ibabaw na may kinis o nakikita sa ilalim ng humahamong liwanag dahil sa mababang pagtutuwid. Ang di - sapat na tahimik na mga sona ay nagiging sanhi ng mga kabiguan sa scanning kapag ang mga kodigo ay inilagay malapit sa iba pang nakikitang elemento. Hindi naipapahayag ng pagme - Generic styling ang pagiging lehitimo ng tatak, na humahantong sa pag - aatubili at pagbabawas ng bilang ng scan.',
        'Bukod sa teknikal na mga limitasyon, ang mga kodigong pamana ay kadalasang kumakatawan sa nawawalang mga pagkakataon sa paghehero. Ang bawat QR code ay isang touchpoint sa iyong parokyano - isang sandali kung saan sila ay aktibong gumagawa at handang kumilos. Isang propesyonal na kodigo na katumbas ng mga kulay ng iyong tatak, pati na ang angkop na mga mardyin na pangkaligtasan, at nagtatampok ng di - opsyonal na markang mga elemento na gumagawa sa kagamitang ito na maging isang bagay na ginagamit sa pagbebenta na nagpapatibay sa iyong pagkakakilanlan sa bawat interaksiyon.',
      ],
    },
    {
      heading: 'Pagdaraos ng Isang QR Code Audit',
      paragraphs: [
        'Magsimula ka sa iyong upgrade project sa pamamagitan ng paggawa ng isang komprehensibong imbentaryo ng bawat QR code na kasalukuyang inilalagay sa ibayo ng iyong negosyo. Itala ang lokasyon ng katawan, ang naka - rehistrong destinasyon, ang kasalukuyang kalagayan ng nakalimbag na materyal, at ang karaniwang lugar na pinag - aaralang mabuti kabilang na ang mga kalagayan ng ilaw at ang mga anggulo ng tanawin. Subukin ang bawat kodigo sa pamamagitan ng multiple device - mas lumang mga smartphone at mga aparato sa badyet na kadalasang nagsisiwalat ng maaasahang mga isyu na ginagawa ng maskara ng mga teleponong premium.',
        'Magbigay ng partikular na pansin sa mga code sa mga lokasyong high-stakes: mga puntos ng pagbabayad, mga pook ng tseke-in, at mga pagpapakita ng promosyon kung saan direktang naaapektuhan ng pagkabigo ng scan ang karanasan ng kita o parokyano. Ang mga ito ay dapat na unahin para sa kagyat na pag - upgrade. Pansinin din ang mga code na makikita sa potograpiya o video, yamang ang mga ito ay nangangailangan ng koordinasyon sa iyong pangkat sa pagbebenta upang i - update ang mga visual asset.',
      ],
      images: [
        {
          ...
          caption:
            'Systematic QR audit template para sa pagtatala at pag-uuna sa iyong mga kandidato sa upgrade',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Ang epektibong QR branding balance ay nagreresulta sa visual effect laban sa scan pagkamaaasahan. Magsimula sa kulay: palitan ang default black concept ng iyong pangunahing kulay, tinitiyak ang sapat na pagkakaiba sa iyong pinagmulan. Para sa karamihan ng mga brand, ang maiitim na kulay tungkol sa mga bagong pinagmulan ang pinakamabisa. Iwasan ang mababang-contrast na mga kombinasyon, mga scapile na nagpapagaan sa gilid, o mga kulay na lumilitaw na kahawig sa ilalim ng karaniwang mga kondisyon ng ilaw.',
        'Ang module hugis custisation ay nag-aalok ng isa pang pagkakataon ng pag-uuri na may kaunting pagkamaaasahan. Ang mga carded module ay lumilikha ng mas malambot, mas madaling lapitang hitsura samantalang pinananatili ang mahusay na pagka - scannity. Ang mga dot-style module ay gumaganang mahusay para sa makabago, tech-forward brands. Ang magkakaugnay na mga module ay angkop sa pagkakakilanlan ng industriya o korporasyon. Anumang istilo ang piliin mo, panatilihin ang pagiging hindi pabagu - bago sa lahat ng iyong paggamit ng QR para sa kagyat na pagkilala sa tatak.',
      ],
      images: [
        {
          ...
          caption:
            'Brand color selection guide na nagpapakita ng high-contrast na mga kombinasyon na nagpapanatili sa pagiging maaasahan ng scan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Huwag kailanman mag-upgrade ng mga code ng QR nang walang mahigpit na pagsubok. Mag - imprenta ng isang pisikal na patotoo sa eksaktong laki at gayunding materyal na gaya ng iyong pangwakas na gamit. Subukin sa aktuwal na lugar kung saan titira ang kodigo, sa iba't ibang panahon sa araw - araw upang isaalang - alang ang pagkakaiba - iba ng ilaw. Gumamit ng hindi bababa sa tatlong iba't ibang aparato: isang kasalukuyang flagship phone, isang mid-range device, at isang mas matanda o badyet na smartphone.",
        'Mag - scan ng oras at bilis ng tagumpay sa bawat pagsusulit. Ang isang mahusay-optimed code ay dapat mag-scream sa loob ng 1-2 segundo sa anumang makatuwirang modernong aparato. Kung nakikita mo ang patuloy na pagkaantala o mga kabiguan, bawasan ang matinding pag - aalis o pagliit ng mga balot, dagdagan ang sukat ng tahimik na sona, o lumipat sa mas mataas na antas ng pagtutuwid. Laging nauuna ang pagiging palakaibigan kaysa sa pagiging masalimuot ng paningin.',
      ],
    },
    {
      heading: 'Pagharang sa Iyong Konstansiya',
      paragraphs: [
        "Minsang mapatunayan mo ang isang napakahusay na kaayusan, ingatan ito na ginagamit ang mga kawing na maaaring pagsaluhan ng ANQR. Ito'y lumilikha ng permanenteng rekord ng bawat setting na ginagamit upang lumikha ng iyong sinang - ayunang mga kulay ng kodigo, istilong module, maling pagtutuwid, pag - aayos, at anumang balot. Ibahagi ang kaugnayang ito sa iyong pangkat ng disenyo, mag - imprenta ng mga tindero, at sa sinuman na baka kailangang gumawa ng kodigo sa hinaharap.",
        "Ang lock na ito ng pagsasaayos ay pumipigil sa unti-unting pagkasira na sumasalot sa maraming mga QR supply. Kung wala ito, ang mga miyembro ng kawani ay nag-ere ng mga code mula sa screenshots, ang mga tagapagdisenyo ay muling nag- settings mula sa memorya, at naglilimbag ng mga tindero ay gumagawa ng 'tulong' na mga pagbabago. Ang bawat pagkakaiba ay nagpapakilala ng posibleng mga isyu. Taglay ang isang nakakandadong kawing, ang bawat reproduksiyon ay katulad ng iyong sinubok, sinang - ayunang orihinal.",
      ],
      images: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ang Payment QR code ay dapat gumana agad sa banking at wallet apps sa ilalim ng real-world counter na kondisyon',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Reuntment guide: Napakagandang taas, anggulo, at distansiya para sa mapananaligang pagsusuri sa pagbabayad',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Payment QR branding spectrum: mula sa ligtas na konserbatibong styling hanggang sa mapanganib na mga paraan ng pagdekorasyon',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Komprehensibong bayad QR na sumusubok sa matrix na tumatakip sa mga app, device, at mga salik na pangkapaligiran',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        'Ang pagkakaiba sa pagitan ng isang QR code na perpektong nagsusuri at isa na nabigo ay kadalasang bumababa sa kung paano ito iluluwas at hawakan sa print workflow. Ipinaliliwanag ng gabay na ito ang mga kritikal na pagkakaiba sa pagitan ng vector (SVG) at raster (PNG) na format, kung kailan gagamitin ang bawat isa, at kung paano iaabot ang QR na gawang sining sa mga tagapagdisenyo at maglilimbag ng mga nagtitinda sa mga paraan na nag-iingat ng pagiging maaasahan ng scan mula sa mga business card hanggang sa billboard-sized signage.',
        'Ang produksiyon ng print ay nagpapakilala ng mga variable na hindi umiiral sa screen: ang tinta ay kumalat, substrate striktura, mga proseso ng pagtatapos, at ang pinagsamang epekto ng maraming mga transbersiyon ng file. Ang isang QR code na mukhang napakahusay sa iyong computer ay maaaring lumabas sa printer na may malambot na mga gilid, nabawasang pagkakaiba, o may - katusuhang pinilipit na mga module. Ang pag - unawa sa pagpili ng format at ang pag - agos ng trabaho ang humahadlang sa tahimik na mga kabiguang ito.',
      ],
      images: [
        {
          ...
          caption:
            'Vector vs raster sa print scale: ang eksaktong pagkakaiba na tumitiyak ng pagkamaaasahan ng scan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Palimbagan ang resolusyon: pagtiyak sa minimum na sukat ng pixel para sa iyong target na laki ng output',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Professional QR'off package: lahat ng kailangan ng isang designer o print marketer para sa tumpak na reproduksiyon",
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Huwag kailanman sang - ayunan ang isang print run nang hindi sinusuri ang isang pisikal na patotoo. Humiling ng isang katibayan na nilimbag sa aktuwal na substrate na may aktuwal na pagtatapos na gagamitin sa paggawa. Scan ang patunay sa ilalim ng mga kondisyon ng liwanag katulad ng kung saan ididispley ang huling piraso. Subukin sa pamamagitan ng maramihang aparato, pati na ang mas matatandang smartphone na maaaring makipagpunyagi sa katangiang marginal.',
        'Kung ang patotoo ay mabagal o pabagu - bago ng pagsusuri, magsuri bago sumang - ayon. Kabilang sa karaniwang mga isyu ang di - sapat na pagkakaiba sa may kulay na mga substates, tahimik na mga paglabag sa sona mula sa pagtabas, tintang nagpapalambot sa mga gilid ng module, o laminasyon na lumilikha ng nakasisilaw na liwanag. Ang alinman sa mga ito ay maaaring tawagin bago ipagkatiwala sa isang buong limbag na run - ngunit tangi lamang kung mahuhuli mo ito sa proof stage.',
      ],
      images: [
        {
          ...
          caption:
            'Nag - iimprentang patotoo: sistematikong pagsubok bago gumawa ng maraming produksiyon',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Inanunsyo ang mga code ng QR sa digital signage: mosyon na umaakit ng atensiyon at nagpapasigla sa scanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animation layering prinsipyo: ang QR pattern ay nananatiling hindi nagbabago habang ang mga background na elemento na may buhay sa ilalim',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Frame analysis: Nagpapatunay sa di - nagbabagong kakayahan na suriin ang buong siklo ng animation',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Asimated QR testing protocol: sistematikong beripikasyon sa ibayo ng mga balangkas, aparato, at kalagayan sa panonood',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ang scannity spectrum: mula sa mga kodigong hindi tinatablan ng bala hanggang sa pagsisiksik na nagtutulak sa pagkamaaasahan na mga hangganan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Mga kahilingan ng tahimik na sona: ang di - nakikitang gilid na tumitiyak ng tagumpay sa scan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Napapansin ng mga QR scanner ang disenyo ng mga light at dark module. Anumang pag - iisngit na nakababawas sa pagkakaibang - liwanag na ito, maiitim na pinagmulan, mga epektong frayf, o mababang -opacity na balot - ay gumagawa sa kodigo na mas mahirap basahin. Kinakalkula ng ANQR ang mga ratio ng pagkakaiba at nagbababala kapag ang iyong mga pagpipiliang kulay ay lumalapit sa mapanganib na antas, ngunit ang panghuling arbiter ay palaging real-world testing.',
        "Iba - iba ang posisyon ng kulay at ng liwanag. Ang kombinasyon ng kulay na lumilitaw na high-contrast sa iyong monitor ay maaaring mahirap makilala sa ilalim ng mainit na incandescent light o malamig na fluorescent tubes. Kung ang iyong kodigo ay ilalagay sa iba't ibang kalagayan ng liwanag, subukin sa ilalim ng maraming pinagmumulan ng liwanag, at isaalang - alang ang mas konserbatibong pagkakaiba bilang isang hangganang pangkaligtasan.",
      ],
    },
    {
      heading: 'Pagliit at Pagtanaw sa Distansiya ng Module',
      paragraphs: [
        'Ang pisikal na laki ng indibiduwal na mga module ang tumitiyak sa pinakamalayong distansiya kung saan maaaring suriin ang isang kodigo. Ang mas maliliit na module ay nangangahulugan ng mas maliliit na kodigo subalit nangangailangan ng mas malapit na mga distansiyang scanning. Ang pangkalahatang tuntunin ay na ang bawat module ay dapat na di - kukulangin sa 0.5m sa nilalayong scanning distance, bumabagtas nang proporsiyon sa mas malalayong distansiya. Ang isang kodigo sa isang billboard ay nangangailangan ng mas malalaking module kaysa isang kodigo sa isang business card.',
      ...
      images: [
        {
          ...
          caption:
            'Paglalagay ng giya sa distansiya: katugmang laki ng module sa iyong mga kahilingan sa paglalagay',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'TR depostment test protocol: sistematikong beripikasyon bago ang pangako sa produksiyon',
        },
      ],
      links: [
        {
