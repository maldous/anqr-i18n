...
export const about: PageDefinition = {
  ...
  description:
    'ANQR ക്ലയന്റ്-ഫസ്റ്റ് സമീപനമുള്ള ഒരു സൗജന്യ QR കോഡ് ജനറേറ്ററാണ് — പ്രാദേശികമായി QR കോഡുകൾ സൃഷ്ടിക്കുക അല്ലെങ്കിൽ എംബെഡ്ഡിംഗിനായി ഞങ്ങളുടെ API ഉപയോഗിക്കുക.',
