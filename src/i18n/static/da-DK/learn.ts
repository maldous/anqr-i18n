...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption: 'Counter placering guide: optimale højder, vinkler og afstande for pålidelig betaling scanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption: 'Professionel QR tømmerpakke: alt hvad en designer eller printleverandør har brug for til nøjagtig reproduktion',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption: 'Analyseproces til kontrol af tryk: systematisk afprøvning, før der indgås forpligtelser for produktionsmængder',
        },
      ],
      links: [
        {
    ...
    },
    {
      ...
      paragraphs: ['Ramme hastighed påvirker både visuel glathed og filstørrelse. For de fleste programmer, 10- 15 rammer per sekund giver glat- udseende bevægelse uden overdreven filstørrelser. Højere frame satser tilbyder faldende visuelle afkast, mens betydeligt stigende filstørrelser. Overvej din leveringssammenhæng - et stort digitalt skilt kan håndtere større filer end en mobil annonce placering.', 'Loop adfærd bestemmer, hvordan animation cykler. Sømløse løkker skaber kontinuerlig bevægelse ideel til skiltning og omgivende skærme. Pingpong (fremadrettet-then-reverse) loops fungerer godt for simple animationer. For opmærksomhed-grabing pulser, overveje animationer med holds - perioder med stilhed punkteret af bevægelse, der trækker øjet uden konstant bevægelse træthed.'],
    },
    {
      heading: 'Oprettelse af animerede overlays',
      paragraphs: ['Når du bruger animerede billeder (GIF \'er, animerede webps, eller video) som overskrifter, udtrækker ANQR rammer og komponerer dem med din QR-kode. Den overlay intensitet indstilling kontrollerer, hvor meget af animationen viser igennem - lavere værdier prioritere scannability, mens højere værdier favoriserer visuel effekt. Test din valgte intensitet på tværs af flere rammer for at sikre ensartet scanbarhed.', 'Kildematerialekvalitet påvirker i betydelig grad resultaterne. Brug overlejringer med klare emner og god kontrast. Undgå kilder animationer med hurtig blink eller ekstreme lysstyrke ændringer, der kan skabe lejlighedsvis lavkontrastrammer. Vise den fulde animation cyklus, før du eksporterer til at fange eventuelle problematiske rammer, der kan undlade at scanne.'],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: ['GIF forbliver det mest understøttede animerede format, spille automatisk i de fleste sammenhænge uden at kræve video-afspiller støtte. GIF \'s 256-farvepalet begrænser imidlertid farveægtheden. For farverige-kritiske animationer, overveje animeret WebP, hvor understøttet, eller falde tilbage til videoformater for den højeste kvalitet. ANQR\' s GIF eksport omfatter dithing muligheder for at maksimere kvaliteten inden for palette begrænsninger.', 'Filstørrelse betyder noget for leveringen. Digitale signalsystemer, e-mail-klienter og sociale platforme pålægger ofte størrelsesgrænser. Hvis din animation overskrider disse grænser, reducere frame count, dimensioner, eller farvedybde. Sommetider opdele en kompleks animation i en kortere løkke opnår bedre resultater end aggressiv kompression, der nedbryder hver ramme.'],
    },
    {
      heading: 'Test af animerede QR-koder',
      paragraphs: ['Test animerede koder kræver scanning på flere punkter i animation cyklus. Må ikke bare scanne én gang og antage succes - scanne gentagne gange, på forskellige tidspunkter, for at kontrollere, at hver ramme er læsbar. Vær særlig opmærksom på rammer ved farvecyklus ekstremer eller overlay intensitet toppe, hvor kontrast kan være lavest.', 'Test på den faktiske display hardware, hvor det er muligt. Overvågning af farvekalibrering, synsvinkel og omgivende belysning påvirker alle animationen og scanningen. En lys animation, der scanner perfekt på din skærm kan vaske ud på en udendørs skærm eller blive ulæselig på skrå synsvinkler.'],
      images: [
        {
