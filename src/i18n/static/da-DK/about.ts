...
export const about: PageDefinition = {
  title: 'Om ANQR',
  description:
    'ANQR er en gratis QR kode generator med en klient- første tilgang - generere QR koder lokalt eller bruge vores API til indlejring.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Ad-udbydere kan bruge cookies eller lignende teknologier til at personliggøre annoncer baseret på dine interesser og browsing aktivitet. Du kan administrere annonceindstillinger i dine enhedsindstillinger og gennem Google-annonceindstillinger og lære mere i vores privatlivspolitik.',
        'Vi sælger ikke det indhold, du indkoder i QR-koder. Ads hjælper med at dække omkostningerne ved at køre og forbedre projektet.',
      ],
    },
    {
      heading: 'Åbne standarder',
      paragraphs: [
        'ANQR genererer QR-koder baseret på ISO / IEC 18004-standarden og sigter mod bred kompatibilitet på tværs af scannere, kameraer og udskriftsarbejdsgange.',
      ],
    },
    {
      heading: 'Varemærkemeddelelse',
      paragraphs: [
        'QR Code ® er et registreret varemærke tilhørende DENSO WAVE INCORPOREED. ANQR er ikke tilknyttet, påtegnet eller sponsoreret af DENSO WAVE INCORPORERET.',
      ],
    },
    {
      heading: 'Feedback og bidrag',
      paragraphs: [
        'Vi glæder os over feedback, fejlrapporter og forslag til funktioner. Kontakt venligst via e-mail eller kontaktsiden - vi læser alle meddelelser, selvom svartiderne kan variere.',
      ],
    },
  ],
};
