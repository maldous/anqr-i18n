...
export const privacy: PageDefinition = {
  ...
  relatedLinks: [{ href: '/terms?lang=${lang}', label: 'Tjenestevilkår', type: 'external' }],
  sections: [
    {
      heading: 'Oversigt',
      paragraphs: ['ANQR er en QR kode generator med en klient- første tilgang. Vi kræver ikke, at du opretter en konto. Som standard genereres QR-koder lokalt i din browser - vi har ikke adgang til det indhold, du indkoder.', 'Til professionel brug leverer ANQR en server-side API, der genererer QR-koder fra URL-parametre. Når du bruger API\'en, behandles dit QR-indhold på vores servere for at gengive billedet, men det gemmes eller logges ikke.', 'Vi bruger Google AdSense til reklame og kan bruge analysetjenester. Disse tjenester indsamler information gennem cookies og lignende teknologier. Denne politik forklarer, hvilke data der indsamles, hvordan det anvendes, og dine rettigheder.'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Adgangsret: Anmoder om en kopi af personlige oplysninger om dig.', 'Ret til berigtigelse: Anmoder om rettelse af unøjagtige oplysninger.', 'Ret til sletning: Anmoder om sletning af dine data ("ret til at blive glemt").', 'Ret til at begrænse behandlingen: Anmod om grænser for, hvordan vi bruger dine data.', 'Ret til dataportabilitet: Bed om dine data i et bærbart format.', 'Ret til indsigelse: Indsigelse mod behandling, herunder til direkte markedsføring.', 'Ret til at trække sit samtykke tilbage: Tilbagekaldelse af samtykke på et hvilket som helst tidspunkt, hvor behandlingen er samtykke- baseret.', 'Retten til at indgive klage: Send en klage til din databeskyttelsesmyndighed.'],
    },
    {
      heading: 'GDPR retsgrundlag',
      paragraphs: ['Vi behandler data på disse baser: (a) Samtykke - til personlig reklame (forvaltes af vores annonceringspartnere); (b) Legitimative interesser - til analyse, sikkerhed og forbedring; (c) Kontrakt - til at besvare forespørgsler.', 'For at udøve dine rettigheder, kontakt email@anqr.link. Vi svarer inden for 30 dage.'],
    },
    {
      heading: 'Dine rettigheder under CCPA (California-brugere)',
      bullets: ['Ret til at vide: Anmoder om oplysninger om indsamlede data, kilder, formål og tredjeparter.', 'Ret til at slette: Anmoder om sletning af dine personlige oplysninger.', 'Ret til opt- out: Undtaget fra "salg" af personlige oplysninger (deling med annoncepartnere kan kvalificere sig).', 'Ret til ikke-forskelsbehandling: Vi vil ikke diskriminere for at udøve dine rettigheder.'],
    },
    {
    ...
    {
      heading: 'Kontakt os',
      paragraphs: ['For spørgsmål om privatliv eller for at udøve dine rettigheder: email@anqr.link eller brug vores kontaktside. Vi besvarer anmodninger om privatliv inden for 30 dage.'],
    },
  ],
};
