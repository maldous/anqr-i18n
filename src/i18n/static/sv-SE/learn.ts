...
export const learn: PageDefinition = {
  ...
  description:
    'Praktiska, business-first guider för att förvandla QR-koder till riktiga marknadsföringstillgångar – inte bara funktionella rutor. Lär dig hur du uppgraderar äldre kassakoder, skapar kompatibel QR-skyltning för betalningar, förbereder utskriftsklara exporter, använder animation säkert på digitala skärmar och delar inlåsta konfigurationer mellan flerspråkiga team med ANQR ("ankare") länkar.',
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Före och efter: Samma måladress omvandlad från en daterad generisk kod till en tillgång med professionellt varumärke',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Systematisk QR-revisionsmall för att dokumentera och prioritera dina uppgraderingskandidater',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Effektiv QR-varumärkning balanserar visuell påverkan mot skanningstillförlitlighet. Börja med färg: ersätt den svarta standardförgrunden med din primära märkesfärg, för att säkerställa tillräcklig kontrast mot din bakgrund. För de flesta märken fungerar mörka färger på ljus bakgrund bäst. Undvik kombinationer med låg kontrast, gradienter som minskar kanternas klarhet eller färger som ser likadana ut under vanliga ljusförhållanden.',
        'Anpassning av modulform erbjuder ytterligare ett varumärkesmöjlighet med minimal påverkan på tillförlitligheten. Rundade moduler skapar ett mjukare, mer lättillgängligt utseende samtidigt som de bibehåller utmärkt skanningsbarhet. Dot-style moduler fungerar bra för moderna, tekniskt framåtriktade varumärken. Anslutna moduler passar industriella eller företagsidentiteter. Oavsett vilken stil du väljer, bibehåll konsistens över alla dina QR-distributioner för omedelbar varumärkesigenkänning.',
      ],
      images: [
        {
          ...
          caption:
            'Varumärkesfärgvalsguide som visar kombinationer med hög kontrast som bibehåller skanningens tillförlitlighet',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Förhindra konfigurationsavvikelser genom att skapa en enda auktoritativ källa för alla QR-reproduktioner',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'QR-koder för betalning måste fungera omedelbart med bank- och plånboksappar under verkliga motförhållanden',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Räknarplaceringsguide: optimala höjder, vinklar och avstånd för pålitlig betalningsskanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Payment QR-varumärkesspektrum: från säker konservativ styling till riskabla dekorativa tillvägagångssätt',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Omfattande QR-testmatris för betalning som täcker appar, enheter och miljöfaktorer',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        'Skillnaden mellan en QR-kod som skannar perfekt och en som misslyckas beror ofta på hur den exporterades och hanterades i utskriftsarbetsflödet. Den här guiden förklarar de kritiska skillnaderna mellan vektor- (SVG) och raster- (PNG)-format, när de ska användas och hur man lämnar ut QR-konstverk till designers och tryckerileverantörer på ett sätt som bevarar skanningens tillförlitlighet från visitkort till skyltar i storleken på skyltar.',
        'Tryckproduktion introducerar variabler som inte finns på skärmen: bläckspridning, substratstruktur, efterbehandlingsprocesser och den kumulativa effekten av flera filkonverteringar. En QR-kod som ser perfekt ut i din designprogramvara kan komma ut från skrivaren med mjuka kanter, minskad kontrast eller subtilt förvrängda moduler. Att förstå formatval och bästa praxis för arbetsflöde förhindrar dessa tysta misslyckanden.',
      ],
      images: [
        {
          ...
          caption:
            'Vektor vs raster i utskriftsskala: precisionsskillnaden som avgör skanningens tillförlitlighet',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Professionellt QR-överlämningspaket: allt en designer eller tryckerileverantör behöver för korrekt återgivning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Arbetsflöde för verifiering av utskriftsbevis: systematisk testning innan man bestämmer sig för produktionskvantiteter',
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        'Animerade QR-koder kombinerar funktionaliteten hos vanliga QR-koder med iögonfallande rörelser som dramatiskt ökar engagemangsgraden. I digital skyltning, sociala medier och interaktiva skärmar förvandlar animation ett statiskt verktyg till ett övertygande visuellt element som drar ögat och inbjuder till interaktion. Den här guiden täcker principerna, teknikerna och praktiska begränsningarna för att skapa animerade QR-koder som skannar på ett tillförlitligt sätt samtidigt som de ger visuell effekt.',
        'Den grundläggande utmaningen med animerade QR-koder är att balansera visuellt intresse mot skanningstillförlitlighet. Varje bildruta måste vara individuellt skanningsbar - en skanner kan fånga koden när som helst i animeringscykeln. Denna begränsning formar varje designbeslut: vilka element som kan röra sig, hur mycket de kan förändras och vad som måste förbli stabilt under hela animeringen.',
      ],
      images: [
        {
          ...
          caption:
            'Animerade QR-koder i digital skyltning: rörelse som drar till sig uppmärksamhet och uppmuntrar till skanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animationslagerprincip: QR-mönstret förblir konstant medan bakgrundselement animeras under',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Bildhastighet påverkar både visuell jämnhet och filstorlek. För de flesta applikationer ger 10-15 bilder per sekund smidiga rörelser utan överdrivna filstorlekar. Högre bildfrekvens ger minskande visuell avkastning samtidigt som filstorlekarna ökar avsevärt. Tänk på ditt leveranssammanhang – en stor digital skylt kan hantera större filer än en mobilannonsplacering.',
        'Slingbeteende avgör hur animeringen cyklar. Sömlösa slingor skapar kontinuerlig rörelse idealisk för skyltar och omgivande visningar. Ping-pong-loopar (framåt-sedan-bakåt) fungerar bra för enkla animationer. För att fånga uppmärksamheten pulser, överväg animationer med hållningar - perioder av stillhet som avbryts av rörelser som drar ögat utan konstant rörelsetrötthet.',
      ],
    },
    {
      heading: 'Skapa animerade överlägg',
      paragraphs: [
        'När du använder animerade bilder (GIF, animerade WebPs eller video) som överlagringar, extraherar ANQR ramar och sammansätter dem med din QR-kod. Inställningen för överlagringsintensitet styr hur mycket av animeringen som visas - lägre värden prioriterar skanningsbarhet medan högre värden gynnar visuell effekt. Testa din valda intensitet över flera bildrutor för att säkerställa konsekvent skanningsbarhet.',
        'Källmaterialets kvalitet påverkar resultaten avsevärt. Använd överlägg med tydliga motiv och bra kontrast. Undvik källanimationer med snabbt blinkande eller extrema ljusstyrkaförändringar som kan skapa enstaka bildrutor med låg kontrast. Förhandsgranska hela animeringscykeln innan du exporterar för att fånga eventuella problematiska bildrutor som inte kan skannas.',
      ],
      images: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Testprotokoll för QR-distribution: systematisk verifiering före produktionsåtagande',
        },
      ],
      links: [
        {
