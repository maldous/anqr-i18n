...
export const terms: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['Jeder Streit, der sich aus diesen Bedingungen oder Ihrer Nutzung von ANQR ergibt, wird zunächst versucht, durch informelle Verhandlungen behoben zu werden, indem er ${CONTACT_EMAIL} kontaktiert.', 'Wenn informelle Entschließung scheitert, werden Streitigkeiten durch verbindliche Schiedsverfahren in Victoria, Australien, außer, dass jede Partei kann einstweilige Entlastung vor Gericht für geistige Eigentum Verletzungen suchen.'],
    },
    {
