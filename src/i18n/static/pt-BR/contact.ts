...
export const contact: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      heading: 'E-mail',
      paragraphs: [
        'Para todas as dúvidas: email@anqr.link',
    ...
    },
    {
      ...
      paragraphs: [
        'Envie avisos DMCA para: email@anqr.link',
    ...
    },
    {
      ...
      paragraphs: [
        'Junte-se à nossa comunidade Reddit em r/ANQR para compartilhar suas criações QR, fazer perguntas, obter ajuda e conectar-se com outros usuários ANQR.',
      ],
    },
  ],
};
