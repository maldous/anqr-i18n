...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Sebelum dan selepas: URL destinasi yang sama berubah daripada kod generik bertarikh kepada aset berjenama profesional',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Templat audit QR sistematik untuk mendokumentasikan dan mengutamakan calon naik taraf anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Panduan pemilihan warna jenama menunjukkan kombinasi kontras tinggi yang mengekalkan kebolehpercayaan imbasan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Cegah hanyut konfigurasi dengan mewujudkan satu sumber berwibawa untuk semua pengeluaran semula QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Kod QR pembayaran mesti berfungsi serta-merta dengan apl perbankan dan dompet di bawah keadaan kaunter dunia sebenar',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Panduan penempatan kaunter: ketinggian, sudut dan jarak optimum untuk pengimbasan pembayaran yang boleh dipercayai',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Spektrum penjenamaan QR Pembayaran: daripada penggayaan konservatif yang selamat kepada pendekatan hiasan yang berisiko',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matriks ujian QR pembayaran komprehensif yang meliputi apl, peranti dan faktor persekitaran',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Vektor vs raster pada skala cetakan: perbezaan ketepatan yang menentukan kebolehpercayaan imbasan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Kalkulator resolusi cetakan: menentukan dimensi piksel minimum untuk saiz output sasaran anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pakej penyerahan QR profesional: semua yang diperlukan oleh pereka bentuk atau vendor cetakan untuk pembiakan yang tepat',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Aliran kerja pengesahan bukti cetakan: ujian sistematik sebelum melakukan kuantiti pengeluaran',
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        'Kod QR animasi menggabungkan kefungsian kod QR standard dengan gerakan yang menarik perhatian yang meningkatkan kadar penglibatan secara mendadak. Dalam papan tanda digital, media sosial dan paparan interaktif, animasi mengubah utiliti statik menjadi elemen visual yang menarik yang menarik perhatian dan mengundang interaksi. Panduan ini merangkumi prinsip, teknik dan kekangan praktikal untuk mencipta kod QR animasi yang mengimbas dengan pasti sambil memberikan kesan visual.',
        'Cabaran asas kod QR animasi ialah mengimbangi minat visual terhadap kebolehpercayaan imbasan. Setiap bingkai mestilah boleh diimbas secara individu - pengimbas mungkin menangkap kod pada bila-bila masa dalam kitaran animasi. Kekangan ini membentuk setiap keputusan reka bentuk: elemen mana yang boleh bergerak, berapa banyak ia boleh berubah dan perkara yang mesti kekal stabil sepanjang animasi.',
      ],
      images: [
        {
          ...
          caption:
            'Kod QR animasi dalam papan tanda digital: gerakan yang menarik perhatian dan menggalakkan pengimbasan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Pengimbas QR berfungsi dengan menangkap satu bingkai dan menganalisis corak modul terang dan gelap. Untuk kod animasi berfungsi, setiap bingkai mesti mengandungi corak QR yang lengkap dan sah. Ini menolak animasi yang mengubah struktur kod, melarutkan modul atau mengubah corak kontras dengan ketara. Modul pembawa data - corak yang kelihatan rawak di tengah - mesti kekal secara visual stabil sepanjang masa.',
        'Pendekatan animasi selamat mengubah suai elemen yang tidak membawa data: latar belakang, warna, bingkai hiasan dan elemen tindanan. Komponen struktur - pola pencari (segi empat sudut besar), pola masa (garisan berselang-seli), dan pola penjajaran (segi empat yang lebih kecil dalam kod yang lebih besar) - mesti mengekalkan kedudukan dan perkadarannya. Bekerja dalam kekangan ini masih membenarkan animasi yang dinamik dan menarik.',
      ],
    },
    {
      heading: 'Teknik Animasi Yang Berfungsi',
      paragraphs: [
        'Berbasikal warna menghidupkan warna latar depan dan latar belakang melalui palet sambil mengekalkan kontras yang mencukupi pada setiap langkah. Ini menghasilkan kesan yang bertenaga dan menarik perhatian dengan risiko imbasan yang minimum - selagi kontras tidak pernah jatuh di bawah paras yang boleh dibaca. Pratetap kitaran warna ANQR direka untuk mengekalkan kebolehimbasan sepanjang kitaran.',
        'Tindanan animasi meletakkan imejan bergerak di belakang corak QR separa lutsinar. Kod itu kekal stabil semasa latar belakang bernyawa - mungkin video bergelung, elemen jenama animasi atau grafik gerakan abstrak. Teknik ini memerlukan pengurusan keamatan yang teliti untuk mengelakkan latar belakang daripada mengatasi corak QR, tetapi menghasilkan hasil yang paling menarik secara visual.',
      ],
      images: [
        {
          ...
          caption:
            'Prinsip pelapisan animasi: corak QR kekal malar manakala elemen latar belakang bernyawa di bawahnya',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Kadar bingkai mempengaruhi kedua-dua kelancaran visual dan saiz fail. Untuk kebanyakan aplikasi, 10-15 bingkai sesaat menyediakan gerakan yang kelihatan lancar tanpa saiz fail yang berlebihan. Kadar bingkai yang lebih tinggi menawarkan pulangan visual yang semakin berkurangan sambil meningkatkan saiz fail dengan ketara. Pertimbangkan konteks penyampaian anda - tanda digital yang besar boleh mengendalikan fail yang lebih besar daripada peletakan iklan mudah alih.',
        'Tingkah laku gelung menentukan bagaimana kitaran animasi. Gelung lancar mencipta gerakan berterusan sesuai untuk papan tanda dan paparan ambien. Gelung ping-pong (maju-kemudian-undur) berfungsi dengan baik untuk animasi mudah. Untuk denyutan yang menarik perhatian, pertimbangkan animasi dengan penahanan - tempoh senyap yang diselingi oleh pergerakan yang menarik mata tanpa keletihan gerakan yang berterusan.',
      ],
    },
    {
      heading: 'Mencipta Tindanan Animasi',
      paragraphs: [
        'Apabila menggunakan imej animasi (GIF, WebP animasi atau video) sebagai tindanan, ANQR mengekstrak bingkai dan menggabungkannya dengan kod QR anda. Tetapan keamatan tindanan mengawal jumlah animasi yang ditunjukkan - nilai yang lebih rendah mengutamakan kebolehimbasan manakala nilai yang lebih tinggi mengutamakan kesan visual. Uji keamatan pilihan anda merentas berbilang bingkai untuk memastikan kebolehimbasan yang konsisten.',
        'Kualiti bahan sumber memberi kesan ketara kepada hasil. Gunakan tindanan dengan subjek yang jelas dan kontras yang baik. Elakkan animasi sumber dengan berkelip pantas atau perubahan kecerahan melampau yang boleh mencipta bingkai kontras rendah sekali-sekala. Pratonton kitaran animasi penuh sebelum mengeksport untuk menangkap sebarang bingkai bermasalah yang mungkin gagal untuk mengimbas.',
      ],
      images: [
        {
          ...
          caption:
            'Analisis bingkai: mengesahkan kebolehimbasan yang konsisten merentas keseluruhan kitaran animasi',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protokol ujian QR animasi: pengesahan sistematik merentas bingkai, peranti dan keadaan tontonan',
        },
      ],
      links: [
        {
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: [
        'Kod QR yang direka dengan cantik yang gagal diimbas adalah lebih teruk daripada tidak berguna - ia mengecewakan pelanggan, merosakkan persepsi jenama dan membazirkan setiap sumber yang dilaburkan dalam penciptaan dan pengedarannya. Panduan ini merangkumi faktor teknikal dan praktikal yang menentukan sama ada kod QR akan mengimbas dengan pasti, dan cara menggunakan ciri keselamatan ANQR untuk menangkap masalah yang berpotensi sebelum ia mencapai pengeluaran.',
        'Kebolehpercayaan kod QR bukan binari. Kod mungkin mengimbas dengan sempurna pada telefon perdana tetapi gagal pada peranti bajet. Ia mungkin berfungsi dalam pencahayaan yang ideal tetapi sukar di restoran yang malap atau cahaya matahari yang terang. Memahami faktor yang mempengaruhi kebolehimbasan membantu anda membuat pertukaran termaklum antara penggayaan visual dan kebolehpercayaan dunia sebenar.',
      ],
      images: [
        {
          ...
          caption:
            'Spektrum kebolehimbasan: daripada kod kalis peluru kepada penggayaan yang menolak had kebolehpercayaan',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Pengimbas QR mengesan corak modul terang dan gelap. Sebarang penggayaan yang mengurangkan kontras ini - latar depan terang, latar belakang gelap, kesan kecerunan atau tindanan kelegapan rendah - menjadikan kod lebih sukar dibaca. ANQR mengira nisbah kontras dan memberi amaran apabila pilihan warna anda menghampiri tahap berbahaya, tetapi penimbang tara terakhir sentiasa menguji dunia sebenar.',
        'Persepsi warna berbeza dengan keadaan pencahayaan. Kombinasi warna yang kelihatan kontras tinggi pada monitor anda mungkin menjadi sukar untuk dibezakan di bawah lampu pijar hangat atau tiub pendarfluor yang sejuk. Jika kod anda akan digunakan dalam keadaan pencahayaan yang berbeza-beza, uji di bawah berbilang sumber cahaya dan pertimbangkan nisbah kontras yang lebih konservatif sebagai margin keselamatan.',
      ],
    },
    {
      heading: 'Saiz Modul dan Jarak Pandangan',
      paragraphs: [
        'Saiz fizikal modul individu menentukan jarak maksimum dari mana kod boleh diimbas. Modul yang lebih kecil bermakna kod yang lebih kecil tetapi memerlukan jarak imbasan yang lebih dekat. Peraturan am ialah setiap modul hendaklah sekurang-kurangnya 0.5mm pada jarak pengimbasan yang dimaksudkan, meningkat secara berkadar untuk jarak yang lebih jauh. Kod pada papan iklan memerlukan modul yang lebih besar daripada kod pada kad perniagaan.',
        'Apabila mengira saiz modul, pertimbangkan senario terburuk: pelanggan dengan telefon lama, dalam pencahayaan tidak sempurna, mengimbas pada jarak maksimum yang mungkin. Reka bentuk untuk pengguna ini dan semua orang akan mendapat pengalaman yang lebih baik. Pengesyoran saiz ANQR menjadi faktor dalam pembolehubah dunia sebenar ini untuk mencadangkan dimensi yang sesuai untuk kegunaan anda.',
      ],
      images: [
        {
          ...
          caption:
            'Panduan jarak mengimbas: memadankan saiz modul dengan keperluan penggunaan anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protokol ujian penggunaan QR: pengesahan sistematik sebelum komitmen pengeluaran',
        },
      ],
      links: [
        {
