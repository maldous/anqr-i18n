...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        'A maioría das empresas teñen códigos QR espallados polas súas operacións: menús, mostradores, envases e materiais promocionais. Moitos destes códigos creáronse hai anos con xeradores básicos, dando lugar a cadrados xenéricos en branco e negro que non inspiran confianza nin coinciden coa identidade da túa marca. Esta guía completa guíache a través dun enfoque sistemático para auditar, actualizar e optimizar a túa infraestrutura QR existente sen interromper as viaxes dos clientes que xa estableceches.',
        'A vantaxe estratéxica de actualizar os teus códigos QR en lugar de substituír está en preservar a continuidade. Os teus clientes xa aprenderon a esperar certos destinos cando escanean os teus códigos. Ao manter os URL codificados idénticos mentres melloras drasticamente a presentación visual, a fiabilidade da dixitalización e o aliñamento da marca, creas unha transición perfecta que mellora a confianza sen necesidade de modificar a túa infraestrutura dixital ou o seguimento analítico.',
      ],
      images: [
        {
          ...
          caption:
            'Antes e despois: o mesmo URL de destino transformouse dun código xenérico datado a un activo de marca profesional',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Os códigos QR creados durante a fase de adopción temperá, especialmente durante 2020-2021, cando as empresas se apresuraron a implementar solucións sen contacto, adoitan sufrir varios problemas críticos. As configuracións de corrección de erros baixas fan que sexan fráxiles cando se imprimen en superficies con textura ou se ven cunha iluminación difícil. As zonas de silencio insuficientes provocan erros na exploración cando os códigos se colocan preto doutros elementos visuais. O estilo xenérico non comunica a lexitimidade da marca, o que provoca dúbidas e reducións nas taxas de exploración.',
        'Ademais das limitacións técnicas, os códigos legados adoitan representar oportunidades de marca perdidas. Cada código QR é un punto de contacto co teu cliente, un momento no que están activamente comprometidos e dispostos a actuar. Un código de estilo profesional que coincide coas cores da túa marca, inclúe marxes de seguridade adecuadas e inclúe elementos de marca opcionais que transforma esta utilidade nun activo de marketing que reforza a túa identidade en cada interacción.',
      ],
    },
    {
      heading: 'Realización dunha auditoría de código QR',
      paragraphs: [
        'Comeza o teu proxecto de actualización creando un inventario completo de todos os códigos QR actualmente implantados na túa empresa. Documente a localización física, o destino codificado, o estado actual do material impreso e o ambiente de dixitalización típico, incluíndo as condicións de iluminación e os ángulos de visión. Proba cada código con varios dispositivos: os teléfonos intelixentes máis antigos e os dispositivos económicos adoitan revelar problemas de fiabilidade que ocultan os teléfonos premium.',
      ...
      images: [
        {
          ...
          caption:
            'Modelo de auditoría QR sistemática para documentar e priorizar os candidatos de actualización',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guía de selección de cores de marca que mostra combinacións de alto contraste que manteñen a fiabilidade da dixitalización',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Nunca implementes códigos QR actualizados sen probas rigorosas. Imprima unha proba física co tamaño exacto e no mesmo material que a súa implementación final. Proba no lugar real onde vivirá o código, a diferentes horas do día para ter en conta as variacións de iluminación. Utiliza polo menos tres dispositivos diferentes: un teléfono insignia actual, un dispositivo de gama media e un teléfono intelixente máis antigo ou económico.',
        'Rexistra os tempos de exploración e as taxas de éxito de cada proba. Un código ben optimizado debería escanear en 1-2 segundos en calquera dispositivo razoablemente moderno. Se observas atrasos ou fallos constantes, reduce a intensidade do estilo: elimina ou reduce as superposicións, aumenta o tamaño da zona de silencio ou cambia a un nivel de corrección de erros superior. A fiabilidade sempre prima sobre a sofisticación visual.',
      ],
    },
    {
      heading: 'Bloqueo da súa configuración para a coherencia',
      paragraphs: [
        'Unha vez que validas unha configuración óptima, consérvaa mediante as ligazóns compartibles de ANQR. Isto crea un rexistro permanente de cada configuración utilizada para xerar o código aprobado: cores, estilo do módulo, corrección de erros, tamaño e calquera superposición. Comparte esta ligazón co teu equipo de deseño, os provedores de impresión e calquera persoa que teña que reproducir o código no futuro.',
        'Este bloqueo de configuración evita a degradación gradual que afecta a moitos despregamentos de QR. Sen el, os membros do persoal recrean códigos a partir de capturas de pantalla, os deseñadores reconstruen a configuración a partir da memoria e os provedores de impresión fan axustes "útiles". Cada variación introduce problemas potenciais. Cunha ligazón de configuración bloqueada, cada reprodución é idéntica ao orixinal probado e aprobado.',
      ],
      images: [
        {
          ...
          caption:
            'Evita a deriva da configuración establecendo unha única fonte autorizada para todas as reproducións QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Os códigos QR de pago deben funcionar ao instante coas aplicacións bancarias e de carteira en condicións de mostrador do mundo real',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guía de colocación do mostrador: alturas, ángulos e distancias óptimos para unha dixitalización de pagos fiable',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'As aplicacións de pago son menos tolerantes que os escáneres de cámara xenéricos. Moitas aplicacións bancarias usan algoritmos de lectura QR máis antigos e máis sinxelos, optimizados para a velocidade e non para a flexibilidade. Isto significa que o estilo que funciona perfectamente cunha cámara do teléfono pode fallar con aplicacións de pago específicas. Mantén a marca conservadora: utiliza a cor da túa marca en primeiro plano se mantén un forte contraste, pero evita os degradados, as superposicións pesadas ou os elementos decorativos que poidan interferir co recoñecemento.',
        'Se queres un logotipo ou unha superposición do centro, manténo moi pequeno (non máis do 10 ao 15 % da área QR) e proba extensamente con todas as aplicacións de pago que poidan usar os teus clientes. Moitas empresas optan por non superpoñer os códigos de pago en concreto, reservando ese estilo para comercializar códigos QR onde os requisitos de fiabilidade son menos estritos. O traballo do código de pago é procesar transaccións, non impresionar visualmente.',
      ],
      images: [
        {
          ...
          caption:
            'Espectro de marca QR de pago: desde un estilo conservador seguro ata enfoques decorativos arriscados',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matriz de probas QR de pagos completa que abarca aplicacións, dispositivos e factores ambientais',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Vector vs ráster a escala de impresión: a diferenza de precisión que determina a fiabilidade da exploración',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Calculadora de resolución de impresión: determina as dimensións mínimas de píxeles para o tamaño de saída de destino',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paquete de entrega QR profesional: todo o que un deseñador ou vendedor de impresión necesita para unha reprodución precisa',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Nunca aprobe unha tirada sen escanear unha proba física. Solicite unha proba impresa no substrato real co acabado real que se utilizará na produción. Escanear a proba en condicións de iluminación similares a onde se mostrará a peza final. Proba con varios dispositivos, incluídos os teléfonos intelixentes máis antigos que poden ter problemas de calidade marxinal.',
      ...
      images: [
        {
          ...
          caption:
            'Fluxo de traballo de verificación da proba de impresión: probas sistemáticas antes de comprometerse coas cantidades de produción',
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        'Os códigos QR animados combinan a funcionalidade dos códigos QR estándar cun movemento atractivo que aumenta drasticamente as taxas de participación. Na sinalización dixital, as redes sociais e as pantallas interactivas, a animación transforma unha utilidade estática nun elemento visual convincente que chama a atención e invita á interacción. Esta guía abarca os principios, as técnicas e as limitacións prácticas para crear códigos QR animados que escanean de forma fiable ao tempo que ofrecen un impacto visual.',
        'O reto fundamental dos códigos QR animados é equilibrar o interese visual coa fiabilidade da exploración. Cada fotograma debe ser escaneable individualmente; un escáner pode capturar o código en calquera momento do ciclo de animación. Esta limitación dá forma a cada decisión de deseño: que elementos poden moverse, canto poden cambiar e que debe permanecer estable ao longo da animación.',
      ],
      images: [
        {
          ...
          caption:
            'Códigos QR animados na sinalización dixital: movemento que chama a atención e fomenta a dixitalización',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Os escáneres QR funcionan capturando un único cadro e analizando o patrón de módulos claros e escuros. Para que funcione un código animado, cada fotograma debe conter o patrón QR completo e válido. Isto descarta animacións que transformen a estrutura do código, disolvan módulos ou alteren significativamente o patrón de contraste. Os módulos de transporte de datos, o patrón aparentemente aleatorio no centro, deben permanecer visualmente estables.',
        'Os enfoques de animación segura modifican elementos que non levan datos: fondos, cores, marcos decorativos e elementos superpostos. Os compoñentes estruturais - patróns de busca (os cadrados de esquina grandes), patróns de tempo (as liñas alternas) e patróns de aliñamento (cadrados máis pequenos en códigos máis grandes) - deben manter as súas posicións e proporcións. Traballar dentro destas limitacións aínda permite animacións sorprendentemente dinámicas e atractivas.',
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Principio de capas de animación: o patrón QR permanece constante mentres que os elementos do fondo se animan debaixo',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Análise de fotogramas: verificando a escanebilidade consistente en todo o ciclo de animación',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protocolo de proba QR animado: verificación sistemática en cadros, dispositivos e condicións de visualización',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'O espectro de escaneo: desde códigos a proba de balas ata estilos que superan os límites de fiabilidade',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Requisitos da zona tranquila: a marxe invisible que determina o éxito da exploración',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guía de distancia de dixitalización: adapta o tamaño do módulo aos teus requisitos de implantación',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protocolo de proba de implantación QR: verificación sistemática antes do compromiso de produción',
        },
      ],
      links: [
        {
