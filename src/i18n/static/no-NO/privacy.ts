...
export const privacy: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        'Informasjon du gir: Hvis du kontakter oss via e-post eller kontaktskjemaet vårt, samler vi inn ditt navn, e-postadresse og innhold i meldingen.',
        'Innsamlet informasjon automatisk: Vår hostingleverandør (Netlify), reklamepartnere og analysetjenester kan samle inn: IP-adresse, nettlesertype og versjon, operativsystem, enhetstype, henvisning URL, sider besøkt, tid på stedet og omtrentlig geografisk plassering.',
        'Tredjeparts cookies: Våre reklamepartnere (Google AdSense) bruker informasjonskapsler og lignende teknologier til å betjene og måle annonser. ANQR selv angir ingen førsteparts cookies.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Vi viser annonser gjennom Google AdSense. Google og dens partnere bruker informasjonskapsler til å betjene annonser basert på din nettleserlogg på dette nettstedet og andre nettsteder (interessebasert annonsering).',
        'Finn ut hvordan Google bruker informasjonen din: https://policies.google.com/technologies/partner-sites',
        'Handle annonse personalisering: https://adssettings.google.com',
        'Åpne via Network Advertising Initiative: https://optout.networkadvertising.org',
        'Åpne via Digital Advertising Alliance: https://optout.aboutads.info',
      ],
    },
    {
      ...
      bullets: [
        ...
        'Å vise relevante annonser gjennom våre reklamepartnere.',
        'For å analysere bruk av nettstedet og forbedre tjenestene våre.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Analytiske leverandører: Få anonymiserte bruksdata.',
        'Netlify (vert): Prosessforespørsler og kan logge IP-adresser.',
        'Vi selger ikke din personlige informasjon. Imidlertid kan deling av data med annonsepartnere betraktes som et "salg" under CCPA (se nedenfor).',
      ],
    },
    {
      heading: 'Databevaring',
      bullets: [
        'Kontaktinnlegg: Opp til 2 år.',
        'Serverlogger: Opp til 30 dager (vertsleverandør).',
        'Analytiske data: Opp til 26 måneder (anonymt).',
        'Reklamecookies: Vanligvis 13 måneder (varer etter partner).',
      ],
    },
    {
      heading: 'Dine rettigheter under GDPR (EØS-brukere)',
      paragraphs: [
        'Hvis du er i Det europeiske økonomiske samarbeidsområdet, har du følgende rettigheter i henhold til den generelle personvernforordningen:',
      ],
      bullets: [
        ...
        'Rett til å klage: Oppgi en klage til datatilsynet.',
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        'Rett til å slette: Be om sletting av dine personopplysninger.',
        'Rett til å velge ut: Opt ut av salget av personopplysninger (deling med annonsepartnere kan kvalifiseres).',
        'Rett til ikke-diskriminering: Vi vil ikke diskriminere dine rettigheter.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Informasjonen kan overføres til land med ulike databeskyttelseslover, inkludert USA. Vi bruker passende sikkerhetstiltak som standard kontraktsklausuler.',
      ],
    },
    {
    ...
    },
    {
      heading: 'Ikke spor',
      paragraphs: [
        'Vi ærer ikke spor nettlesersignaler der det er mulig, men reklamepartnere kan ikke svare på DNT.',
      ],
    },
    {
      heading: 'Endringer i denne politikken',
      paragraphs: [
        'Vi kan oppdatere disse retningslinjene regelmessig. Den siste oppdaterte datoen indikerer den siste revisjonen. Betydelige endringer kan kommuniseres via et nettstedsbanner.',
      ],
    },
    {
      heading: 'Kontakt oss',
