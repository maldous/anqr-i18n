...
export const privacy: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['ANQR angir ingen førsteparts cookies. Dine preferanser (for eksempel mørk modus) lagres lokalt på enheten, som ikke overføres til noen server.', 'Våre reklamepartnere (Google AdSense) og hostingleverandør kan imidlertid bruke informasjonskapsler og lignende sporingsteknologier:'],
      bullets: ['Reklameinformasjonskapsler (tredjepart): Sett av Google AdSense og annonsepartnere for å betjene relevante annonser, måle annonseytelse og forstå brukerinteresser. Disse informasjonskapslene kan spore aktiviteten din på ulike nettsteder.', 'Analytiske informasjonskapsler (tredjepart): Kan brukes av vår hostingleverandør eller analysetjenester for å samle inn anonymiserte bruksdata.'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Google AdSense: Mottar data for å vise og måle annonser.', 'Analytiske leverandører: Få anonymiserte bruksdata.', 'Netlify (vert): Prosessforespørsler og kan logge IP-adresser.', 'Vi selger ikke dine personopplysninger. Deling av data med annonsepartnere kan imidlertid anses som et salg under CCPA (se nedenfor).'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Rett til tilgang: Be om en kopi av personopplysninger vi har om deg.', 'Rett til rettelse: Be om rettelse av unøyaktige data.', 'Rett til å slette: Be om sletting av dataene dine (" rett til å bli glemt").', 'Rett til å begrense behandlingen: Be om grenser for hvordan vi bruker dataene dine.', 'Rett til dataportabilitet: Be om dine data i et bærbar format.', 'Rett til å protestere: Objekt mot behandling, inkludert direkte markedsføring.', 'Rett til å trekke tilbake samtykke: Trekk tilbake samtykke når som helst der behandling er samtykkebasert.', 'Rett til å klage: Oppgi en klage til datatilsynet.'],
    },
    {
      heading: 'GDPRs juridiske grunnlag',
      paragraphs: ['Vi behandler data på disse grunnlagene: a) Samtykke - for personlig annonsering (managert av våre reklamepartnere); b) legitime interesser - for analyse, sikkerhet og forbedring; c) Kontrakt - å svare på henvendelser.', 'For å utøve dine rettigheter, kontakt ${CONTACT_EMAIL}. Vi svarer innen 30 dager.'],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['Kategorier: Identifikasjoner (IP-adresse, enhets-ID), Internett-aktivitet (browsing, annonseinteraksjoner), Geolocation (approximat), Inferenser (interesser fra surfing).', 'For å utøve rettigheter eller velge ut: ${CONTACT_EMAIL} eller justere informasjonskapselinnstillingene.'],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['ANQR er ikke rettet mot barn under 13 år (eller 16 i EØS). Vi samler ikke bevisst inn data fra barn. Kontakt ${CONTACT_EMAIL} hvis du tror et barn har gitt informasjon.'],
    },
    {
      heading: 'Sikkerhet',
      paragraphs: ['Vi bruker egnede tekniske og organisatoriske tiltak for å beskytte data, inkludert HTTPS-kryptering. Men ingen Internett-overføring er 100% sikker.'],
    },
    {
      heading: 'Ikke spor',
    ...
    {
      heading: 'Kontakt oss',
      paragraphs: ['For personvernspørsmål eller å utøve dine rettigheter: ${CONTACT_EMAIL} eller bruk vår kontaktside. Vi svarer på personvernforespørsler innen 30 dager.'],
    },
  ],
};
