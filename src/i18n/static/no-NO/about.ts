...
export const about: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '«ANQR drives som et uavhengig nettverktøy. For spørsmål, støtte eller forretningshenvendelser, vennligst bruk kontaktsiden eller send e-post»' + CONTACT_EMAIL + '«.»',
      ],
    },
    {
