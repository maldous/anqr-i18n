...
export const guide: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: ['1. Velg en innholdstype (URL, tekst, WiFi, etc.) fra innholdstype.', '2. Skriv inn dine data i de angitte feltene.', '3. Valgfritt å tilpasse farger, stiler og legge til et overleggsbilde.', '4. Klikk Eksporter for å laste ned QR-koden som PNG, GIF, WebP eller SVG.'],
    ...
    // Basic Features (sections 2-4)
    {
      ...
      paragraphs: ['Grunnleggende nivå gir et strømlinjeformet grensesnitt for å opprette QR-koder med nyttelastinnhold og overlegg. Dette er den enkleste måten å komme i gang på.'],
    ...
    },
    {
      ...
      paragraphs: ['Vanleg tekst: Koder alle tekster opp til QR kode kapasitetsgrense. Ideell for korte meldinger, koder eller identifikatorer.', 'URL: Kode webadresser. QR-koden åpner URL-en når den skannes. Støtter http://og https://protokoller.'],
    },
    {
      heading: 'Bilder Overlegg (Basic)',
      paragraphs: ['Last opp et bilde (JPG, PNG, GIF, WebP) for å blande med QR-koden. Grunnleggende overleggsfunksjoner inkluderer:'],
    ...
    },
    {
      ...
      paragraphs: ['Versjon: QR-koder kommer i versjon 1-40, med høyere versjoner som har mer data, men er større. Sett til 0 (Auto) for å la ANQR velge den minste versjonen som passer innholdet ditt.', 'Feilretting: Avgjør hvor mye skade en QR-kode kan opprettholde mens den forblir skantable.'],
      bullets: ['L (Low): 7% feilretting - minste størrelse, minst redundans.', 'M (medium): 15% feilretting - balansert alternativ.', 'Q (Quartile): 25% feilretting - bra for trykte koder.', 'H (høy): 30% feilretting - beste for koder med overlegg eller under tøffe forhold.'],
    ...
    },
    {
      ...
      paragraphs: ['Den stille sonen er den hvite plassen rundt QR-koden. Skannere trenger denne margen for å oppdage hvor koden starter. Standarden anbefaler minst 4 moduler. Nedsettelse under 4 kan forårsake skanneproblemer.'],
    },
    {
      heading: 'Modulstil',
      paragraphs: ['Moduler er de enkelte firkanter som utgjør en QR-kode. ANQR tilbyr fem stiler:'],
      bullets: ['Square: Klassisk QR utseende med skarpe hjørner.', 'Avrundet: Myke hjørner for et vennligere utseende.', 'Dots: Cirkulære moduler for en moderne estetisk.', 'Diamant: 45° roterte firkanter for et karakteristisk mønster.', 'Tilkoblet: Moduler slås sammen når de tilstøter, og skaper organiske former.'],
    ...
    },
    {
      ...
      bullets: ['Square: Standard firkantede hjørner.', 'Avrundet: Mykte hjørner som passer avrundet modulstil.', 'Sirkel: Circular Finder mønstre for dot-style koder.'],
    },
    {
      heading: 'Justering & Timing-mønster',
      paragraphs: ['Justeringsmønstre vises i større QR-koder (versjon 2+) for å bidra til å korrigere forvrengning. Timing mønstre er de vekslende linjene som forbinder finner mønstre.'],
    ...
    },
    {
      ...
      bullets: ['PNG: Lossless raster format, ideell for de fleste bruk. Best for print og digital.', 'WebP: Moderne format med mindre filstørrelser. Godt for webbruk.', 'GIF: Nødvendig for animerte QR-koder. Støtter åpenhet.', 'SVG: Vektorformat som skalerer uendelig. Beste for store utskrifter eller når du trenger å redigere koden.'],
      links: [
    ...
    },
    {
      ...
      bullets: ['Hastighet: Animasjonsrammehastighet i millisekunder.', 'Loop: Kontinuerlig eller enkeltspill animasjon.', 'Bounce: Ping-pong animasjon retning.', 'Start ramme: Begynn animasjon fra spesifikk ramme.', 'Max Frames: Begrens totale rammer i animasjon.', 'Rammesteg: Hopp over rammer for raskere animasjon.', 'Interpolering: Ingen, Crossfade eller Morph mellom rammer.'],
      links: [
    ...
    },
    {
      ...
      bullets: ['Beskjær: Aktiver beskjering for å velge et firkantet område av bildet.', 'Halftone: Klassisk utskrift-stil prikk mønster basert på bilde lysstyrke.', 'Dithered: Feil-diffusion dithering for detaljert reproduksjon.'],
    ...
    },
    {
      ...
      bullets: ['Subpiksel: Deler hver modul i underpiksler for høyere detaljer.', 'Blåstøy: Bruker blå støy utjamning for artefakter-frie mønstre.', 'Mosaikk: Flisebasert effekt som bevarer bildestruktur.', 'Gap Fyll: Plasserer bildet i hull mellom moduler.', 'Lysstyrke: Varies modulstørrelse basert på bildelysstyrke.', 'Duotone: Kartbilde til to farger for slående kontrast.'],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['Når aktivert, holder de tre hjørne finner mønstre umodifisert av overlegget. Sterkt anbefalt for pålitelig skanning.'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Gridstørrelse: 2×2, 3×3, eller 4×4 underpiksler per modul. Høyere = mer detaljer.', 'Senterregelen: Strict krever sentrum subpiksel for å matche modul. Halvtonesenteret tillater variasjon.', 'Nøytral farge: Farge som brukes for ubestemte subpiksler.', 'Finner Overstyr: Hvordan finne mønstre er gjengitt (solid eller stilisert).'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Gapmodus: Ingen, Innsats, Stroke eller Negativ mellomroms gap styling.', 'Hjørneradius: Avrundede hjørner prosentdel for moduler.', 'Gradient: Ingen, lineær, Radiell eller konisk gradient på moduler.', 'Eye Outer/Inner Style: Uavhengig styling for finner mønster ringer.', 'Dot rotasjon: Roter diamant/dot moduler.', 'Eye Scale: Størrelsesjustering for finnermønstre.', 'Rammestil: Legg til dekorative rammer (Rounded Frame, Sticker, Tag).', 'Rammetekst: Legg til tekst som "Scan Me!" i rammer.'],
      links: [{ href: '/?lang=${lang}&tab=advanced#render', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Filnavn: Tilpasset filnamn for nedlastinger.', 'GIF Palettstørrelse: 2-256 farger i GIF-utgang.', 'GIF Quantizer: Median Cut, NeuQuant eller Octree fargereduksjon.', 'GIF Dithering: Av, Floyd-Steinberg, eller Bestill.', 'GIF Gjennomsiktig farge: Sett en farge som skal være gjennomsiktig.', 'SVG Ekte vektor: Bruk stier i stedet for innebygd raster.', 'SVG Form presisjon: Pixel eller presis banegjengivelse.', 'SVG Bygg inn Raster Overlay: Inkluder overlegg som innebygd bilde.', 'Bakgrunn Overstyr: Tving en bestemt bakgrunnsfarge i utgangen.'],
    ...
    },
    {
      ...
      bullets: ['Direkte link: Opprett en delt URL med gjeldende innstillinger.', 'Embed HTML: Få innebygd kode for nettsteder.', 'Kodeparametere: Ta med alle innstillinger i delt URL.', 'Merk: Overlegg bilder fra lokale filer kan ikke deles via URL.'],
      links: [
    ...
    },
    {
      ...
      bullets: ['EPC/SEPA (EU): Europeisk bankoverføring QR-koder med IBAN, BIC, beløp, referanse.', 'UPI (India): Unified Payments Interface med VPA, Payee name, beløp.', 'PayNow (Singapore): Singapore hurtig betaling med UEN eller mobilnummer.', '(Thailand): Thai nasjonale betalingssystem.', 'PIX (Brazil): Brasiliansk øyeblikksbetaling med PIX-nøkkel.', 'Crypto: Bitcoin, Ethereum, Litecoin-betalingsadresser med valgfritt beløp.', 'Markedsføringskampanje Link: URL-adresser med full UTM-parameter (Marketing Tags) sporing.', 'Kort link: For bruk med URL-forkortere for dynamiske/sporbare QR-koder.', 'GS1 Digital Link: Produktidentifikasjon med GTIN, serie, sats, utløp.', 'App Deep Link: iOS/Android app dype lenker med tilpassede ordninger.', 'Tilpasset format: Rå data uten formatering eller validering.'],
      links: [
    ...
    },
    {
      ...
      bullets: ['EPC/SEPA (EU): Europeisk bankoverføring QR-koder etter EPC QR-kodestandarden. Støtter IBAN, BIC (valgfritt for innenlandsk), beløp i EUR, og strukturerte eller ustrukturerte betalingsreferanser. Brukes over hele SEPA-sonen, inkludert EU-land og Sveits, Norge, Island, Liechtenstein, Monaco og San Marino.', 'Sveitsisk QR-bill: Sveitsisk betalingsstandard etter SIX implementeringsretningslinjer. Støtter CHF og EUR, QR-reference (QRR), Creditor Reference (ISO 11649), strukturerte kreditor-/debitoradresser og faktureringsinformasjon. Det er nødvendig med sveitsiske fakturaer siden 2022.'],
    ...
    },
    {
      ...
      bullets: ['UPI (India): Unified Payments Interface som følger NPCI Deep Linking Spesifikasjon. Støtter VPA (Virtual Payment Address), betalingsnavn, beløp i INR, transaksjonsnote, referanse-ID, handelskategorikode og transaksjonsmodus.', 'BharatQR (India): Unified QR standard støtter både UPI og kortbaserte betalinger. Kombinerer UPI VPA med kort-PAN for maksimal kompatibilitet. Inkluderer handelsnavn, by, MCC, GST-detaljer og faktura/referansenumre.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
      heading: 'Sørøstasiatiske betalingsstandarder',
      bullets: ['PayNow (Singapore): Singapore rask betalingssystem ved hjelp av EMVCo QR spesifikasjon med SGQR profil. Støtter UEN (bedriftsregistrering), mobilnummer eller NRIC som proxy-identifikatorer. Inkluderer mengderedigeringsflagg og utløpsdato.', '(Thailand): Thai National Payment System etter Bank of Thailand EMV profil. Støtter mobilnummer, nasjonal ID, skatte-ID, e-veske-ID og fakturering med flere referansefelt.', 'QRIS (Indonesia): Rask responskode Indonesisk standard. EMV-basert nasjonal betalingsstandard som støtter kjøpmanns-ID, NMID (Nasjonal merchant ID), kjøpmannskriterier klassifisering og bekvemmelighetsgebyrer (fast eller prosent).', 'DuitNow (Malayasia): Malaysias øyeblikkelige betalingssystem. Støtter flere proxytyper, inkludert NRIC, mobil, pass, hær-ID og forretningsnummer.', 'VietQR (Vietnam): vietnamesisk interbank transfer standard. Krever bank BIN (NAPAS identifikasjon) og kontonummer. Støtter flere servicekoder for ulike overføringstyper (QRPUSH, QRIBFTTA, QRIBFTTC).', 'QR Ph (Filippiner): Filipinsk QR betalingsstandard for InstaPay og PESONet. Bruker kontonummer med kjøpmannsidentifikasjon for P2M (person-til-merchant) transaksjoner.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
      heading: 'Østasiatiske betalingsstandarder',
      bullets: ['TWQR (Taiwan): Taiwansk QR betalingsstandard. Støtter handels-ID, skatte-ID og TWD-beløp.', 'HKQR/FPS (Hong Kong): Hongkong raskere betalingssystem QR-koder. Støtter FPS ID, mobilnummer eller e-post som betalingsidentifikatorer. Beløp i HKD.', 'JPQR (Japan): Japansk enhetlig QR-kodebetalingsstandard. Bruker lager-ID for kjøpsidentifikasjon med JPY-beløp.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Bitcoin/Litecoin (BIP-21): Standard cryptocurrency-betalingsadresser med lommebokadresse, valgfritt beløp og etikett. Kompatibel med alle store Bitcoin og Litecoin lommeboker.', 'Lightning Network (BOLT11): Lightning Network betaling fakturaer. Lim inn en BOLT11-kodet fakturastreng for øyeblikkelige Bitcoin-betalinger med minimale avgifter.', 'Ethereum (EIP-681): Ethereum-transaksjonsforespørselsadresser som støtter innfødte ETH-overføringer og ERC-20-tokenoverføringer. Inkluderer kjede-ID for multi-nettverksstøtte (Mainnet, Polygon, BSC, Arbitrum, Optimism, Avalanche), gassparametre og kontraktsfunksjonssamtaler.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
      heading: 'Betalingslink-tjenester',
      bullets: ['PayPal.Me: PayPal betalingskoblinger med brukernavn og valgfritt forhåndsfylt beløp. Mottakere kan betale via PayPal-saldo, kort eller bankkontoer.', 'Kontantapp: Kontant App betalingskoblinger ved hjelp av $cashtag med valgfritt beløp. Populær i USA for peer-to-peer betaling.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    {
      heading: 'Generisk EMV QR',
      bullets: ['EMV Generisk: Opprett egendefinert EMV Merchant-Presented Mode QR-koder for betalingsordninger som ikke er spesielt oppført. Konfigurer handelsnavn, by, landkode (ISO 3166-1), valutakode (ISO 4217 numeriske), MCC, tips-/konvensjonsgebyralternativer og ekstra datafelt. Nyttig for testing eller egendefinert integrasjon.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
    ...
    },
    {
      ...
      bullets: ['Crisp Edges: Bruk pikslert bildegjengivelse for skarpe modulkanter.', 'Pixel Snap: Gulv, runde eller Ceil pixel justering.', 'Per-module fargemodus: solid, etter lysstyrke, etter posisjon, ved overlegg, ved Cluster.', 'Fargepalett: Definer egendefinert fargepalett for per-module farger.', 'Kontrastvakt: Sørg for minste kontrastforhold mellom farger.', 'Min kontrastforhold: WCAG-stil kontrastkrav (1:1 til 21:1).', 'Ekstra grense Moduler: Ytterligere grense utenfor stille sone.'],
    ...
    },
    {
      ...
      bullets: ['DPI: Sett utskriftsoppløsning (72-600 DPI). 300 DPI anbefales for utskrift.', 'Inkluder Stille Zone: Bytt rolig sone i utgangsdimensjoner.', 'Eksporter som ekstra: Opprett PDF sammen med primærformat.'],
    ...
    // API Reference (sections 57-69)
    {
      ...
      paragraphs: ['ANQR gir en server-side API for å generere QR-koder via URL-parametre. Dette er ideelt for å integrere QR-koder i nettsteder, e-poster, dokumenter eller automatiserte arbeidsflyter uten JavaScript på klientsiden.', 'Base URL: https://anqr.link/api/qr'],
    ...
    },
    {
      ...
      bullets: ['wmEn: Sett til 1 for å muliggjøre vannmerke.', 'wm Type: Vannmerke type - tekst, bilde, mønster.', 'wmText: Vannmerketekst (URL-kodet).', 'wmImg: URL til vannmerkebilde.', 'wmPos: Posisjon - sentrum, hjørner, kanter, bak, roe_zone.', 'wmOpacity: Dekkevne 0-100 (standard: 50).', 'wmBlend: Blandemodus - normal, multiplisere, skjerm, overlegg.'],
    },
    {
      heading: 'Animasjonsparametere',
      paragraphs: ['For animert GIF-utgang (krever format=gif):'],
      bullets: ['anim Mønster: animasjonsmønster - ingen, puls, bølge, skanneline, skimmer, drift, color_syklus.', 'anim Rammer: Antall rammer 1-60 (standard: 24).', 'anim Hastighet: Rammeforsinkelse i millisekunder 10-1000 (standard: 100).', 'anim Seed: Tilfeldig frø for animasjon.', 'easing: Animation easing - lineær, easy_in, easy_out, easy_in_out, studse.'],
    },
    {
      heading: 'Utgangsparametere',
      paragraphs: ['Utdataformatalternativer:'],
      bullets: ['kvalitet: WebP kvalitet 0-1 (standard: 0.9).', 'webpQ: WebP-kvalitet 0-100 (standard: 90).', 'gifColors: GIF palettstørrelse 2-256 (standard: 256).', 'dpi: Utgangs-DPI for PNG (standard: 72).', 'metaTitel, metaAuthor, metaCopy, meta Desc: PNG metadata felt.'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Share Link: Oppretter en URL til ANQR-appen med alle innstillingene kodet som URL-parametre. Mottakere kan vise og endre QR-koden.', 'Bygg inn bildet: Generererer en <img> tag som peker på server-API. QR-koden gjøres serversiden og fungerer som et bilde.', 'Legg merke til: Oppretter Markdown-bildesyntaks for dokumentasjon og README-filer.', 'Direkte API URL: Den rå API URL for bruk i programmer, skript eller andre integrasjoner.'],
    ...
    },
    {
      ...
      paragraphs: ['API er fritt å bruke for rimelige volumer. For bruk av høyvolum eller kommersielle applikasjoner som krever garantert oppetid, vennligst kontakt oss.', 'API-svar inkluderer aggressive caching-hoder. For best ytelse, cache svar på slutten eller bruk samme URL konsekvent for identiske QR-koder.'],
    },
    ...
    },
    {
      ...
      bullets: ['QR vil ikke skanne: Reduser overleggsintensitet, øke feilretting, sjekk kontrast.', 'Kode for stor: Reduser innholdslengde, bruk URL-korter, lavere versjon.', 'Sløringsutgang: Øk modulstørrelsen, bruk PNG i stedet for komprimerte formater.', 'Farger ser feil ut: Sjekk fargekontrast, prøv gråtone overlegg modus.', 'GIF ikke animere: Sørg for å bruke GIF-formatutgang, sjekk rammetelling.', 'Overlegg på bildet som ikke lastes inn: Sjekk tillatelser for CORS på eksterne bilder.'],
      links: [{ href: '/learn?lang=${lang}#section-5', label: 'Se relaterte guider og eksempler', type: 'learn' }],
    },
    {
    ...
    },
    {
      ...
      paragraphs: ['Klikk Share-knappen i profesjonell modus for å kopiere en URL med gjeldende innstillinger. Mottakere kan åpne denne URL-en for å se nøyaktig konfigurasjon. Merk: Overlegg bilder fra lokale filer kan ikke deles via URL.'],
      links: [{ href: '/?lang=${lang}&tab=professional#share', label: 'Prøv denne konfigurasjonen direkte i ANQR-generatoren.', type: 'generator' }],
    },
  ],
  relatedLinks: [
