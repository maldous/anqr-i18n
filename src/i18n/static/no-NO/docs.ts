...
export const docs: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      heading: '«Hurtigstart»',
      paragraphs: [
        '«Slik lager du din første QR-kode:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Format: Velg eksportformat basert på brukstilfelle.»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Kontrollér animert QR-kodeoppførsel:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Avansert nivå låser opp flere nyttelastformater:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere overleggsfunksjoner:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere blandingsmoduser på avansert nivå:»',
      ],
      bullets: [
    ...
    },
    {
      heading: '«Fargemodus»',
      paragraphs: [
        '«Hvordan overleggsbildet behandles:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Hvordan overleggsbildet passer til QR-kodeområdet:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Når du bruker feildiffusjonsdithering, velg hvordan feilen skal fordeles:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Når du bruker blandingsmodusen for delpiksler:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Når du bruker blandingsmodus for halvtone:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Når du bruker animerte GIF-overlegg:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere gjengivelseskontroller:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere eksportinnstillinger:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Innstillinger for inndatabehandling:»',
      ],
      bullets: [
    ...
    },
    {
      heading: '«Vannmerke»',
      paragraphs: [
        '«Legg til vannmerker i QR-kodene dine:»',
      ],
      bullets: [
    ...
    },
    {
      heading: '«Metadata»',
      paragraphs: [
        '«Legg inn metadata i eksporterte filer:»',
      ],
      bullets: [
    ...
    },
    {
      heading: '«Deling»',
      paragraphs: [
        '«Del QR-kodekonfigurasjonene dine:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Sørg for at QR-koder fortsatt kan skannes:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Faglig nivå legger til betalings- og bedriftsinnholdstyper:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere blandingsmoduser på profesjonelt nivå:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Avanserte gjengivelseskontroller:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Innstillinger for eksport for bedrifter:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Ytterligere profesjonelle animasjonsfunksjoner:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Obligatoriske og vanlige parametere (parameternavnene oversettes ikke):»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Alternativer for bildeoverlegg (overleggsbilde hentes på serversiden):»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Forbehandling av bildet på overlegg:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Legg til vannmerker i genererte QR-koder:»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«For animert GIF-utdata (krever format=gif):»',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '«Følg disse retningslinjene for pålitelige QR-koder:»',
      ],
      bullets: [
