...
export const terms: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Cualquier disputa que surja de estos Términos o su uso de ANQR se tratará primero de resolverse mediante negociación informal contactando a email@anqr.link.',
