...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        "La plupart des entreprises ont des codes QR dispersés dans leurs opérations : sur les menus, les comptoirs, les emballages et le matériel promotionnel. Beaucoup de ces codes ont été créés il y a des années avec des générateurs de base, ce qui donne lieu à des carrés génériques en noir et blanc qui n'inspirent pas confiance et ne correspondent pas à l'identité de votre marque. Ce guide complet vous guide à travers une approche systématique d'audit, de mise à niveau et d'optimisation de votre infrastructure QR existante sans perturber les parcours clients que vous avez déjà établis.",
      ...
      images: [
        {
          ...
          caption:
            "Avant et après : la même URL de destination transformée d'un code générique daté en un actif de marque professionnelle",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Modèle d'audit QR systématique pour documenter et prioriser vos candidats à la mise à niveau",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guide de sélection des couleurs de la marque montrant des combinaisons à contraste élevé qui maintiennent la fiabilité de la numérisation',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Ne déployez jamais de codes QR mis à niveau sans des tests rigoureux. Imprimez une épreuve physique à la taille exacte et sur le même matériau que votre déploiement final. Testez à l'emplacement réel où le code se trouvera, à différents moments de la journée pour tenir compte des variations d'éclairage. Utilisez au moins trois appareils différents : un téléphone phare actuel, un appareil de milieu de gamme et un smartphone plus ancien ou économique.",
        "Enregistrez les temps d'analyse et les taux de réussite pour chaque test. Un code bien optimisé devrait être analysé en 1 à 2 secondes sur tout appareil raisonnablement moderne. Si vous constatez des retards ou des échecs constants, réduisez l'intensité du style : supprimez ou réduisez les superpositions, augmentez la taille de la zone silencieuse ou passez à un niveau de correction d'erreur plus élevé. La fiabilité prime toujours sur la sophistication visuelle.",
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Empêchez la dérive de configuration en établissant une source unique faisant autorité pour toutes les reproductions QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Les codes QR de paiement doivent fonctionner instantanément avec les applications bancaires et de portefeuille dans des conditions réelles.',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guide de placement au comptoir : hauteurs, angles et distances optimaux pour une numérisation fiable des paiements',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Spectre de marque Payment QR : du style conservateur sûr aux approches décoratives risquées',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matrice complète de tests QR de paiement couvrant les applications, les appareils et les facteurs environnementaux',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        "La différence entre un code QR qui est parfaitement scanné et un code qui échoue réside souvent dans la manière dont il a été exporté et géré dans le flux de travail d'impression. Ce guide explique les distinctions essentielles entre les formats vectoriels (SVG) et raster (PNG), quand les utiliser et comment transmettre les illustrations QR aux concepteurs et aux imprimeurs de manière à préserver la fiabilité de la numérisation, des cartes de visite aux panneaux d'affichage.",
      ...
      images: [
        {
          ...
          caption:
            "Vecteur ou raster à l'échelle d'impression : la différence de précision qui détermine la fiabilité de la numérisation",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Calculateur de résolution d'impression : déterminer les dimensions minimales en pixels pour votre taille de sortie cible",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Package de transfert QR professionnel : tout ce dont un concepteur ou un fournisseur d'impression a besoin pour une reproduction précise",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Flux de travail de vérification des épreuves à l'impression : tests systématiques avant de s'engager sur des quantités de production",
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        "Les codes QR animés combinent les fonctionnalités des codes QR standards avec des mouvements accrocheurs qui augmentent considérablement les taux d'engagement. Dans l'affichage numérique, les médias sociaux et les affichages interactifs, l'animation transforme un utilitaire statique en un élément visuel convaincant qui attire le regard et invite à l'interaction. Ce guide couvre les principes, les techniques et les contraintes pratiques de la création de codes QR animés qui se scannent de manière fiable tout en offrant un impact visuel.",
        "Le défi fondamental des codes QR animés consiste à trouver un équilibre entre l'intérêt visuel et la fiabilité de la numérisation. Chaque image doit pouvoir être numérisée individuellement : un scanner peut capturer le code à tout moment du cycle d'animation. Cette contrainte façonne chaque décision de conception : quels éléments peuvent bouger, dans quelle mesure ils peuvent changer et ce qui doit rester stable tout au long de l'animation.",
      ],
      images: [
        {
          ...
          caption:
            "Codes QR animés dans l'affichage numérique : un mouvement qui attire l'attention et encourage la numérisation",
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Les scanners QR fonctionnent en capturant une seule image et en analysant le motif des modules clairs et sombres. Pour qu'un code animé fonctionne, chaque image doit contenir le modèle QR complet et valide. Cela exclut les animations qui transforment la structure du code, dissolvent les modules ou modifient considérablement le motif de contraste. Les modules porteurs de données - le motif apparemment aléatoire au centre - doivent rester visuellement stables partout.",
      ...
      images: [
        {
          ...
          caption:
            "Principe de superposition d'animation : le motif QR reste constant tandis que les éléments d'arrière-plan s'animent en dessous",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            "Analyse d'image : vérifier la cohérence de la numérisation tout au long du cycle d'animation",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protocole de test QR animé : vérification systématique sur tous les cadres, appareils et conditions de visualisation',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Le spectre de la numérisation : des codes pare-balles au style qui repousse les limites de la fiabilité',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "La zone silencieuse est la marge vierge entourant chaque code QR. Les scanners utilisent cette limite pour identifier où commence et se termine le code. La norme ISO spécifie une zone de silence minimale de quatre modules (quatre fois la largeur du plus petit carré du code). La violation de cet espace - avec des éléments de conception, des bords coupés ou du contenu adjacent - est l'une des causes les plus courantes d'échec d'analyse.",
        "L'application de zones silencieuses par l'ANQR permet de maintenir cet espacement critique, mais vous devez également vous assurer qu'il est préservé dans vos conceptions finales. Lors de la remise des illustrations QR, spécifiez explicitement les exigences de la zone silencieuse. Lorsque vous placez des codes dans des mises en page, vérifiez qu'aucun élément ne s'immisce dans cet espace. Quelques millimètres d'espace libre peuvent faire la différence entre une numérisation fiable et des clients frustrés.",
      ],
      images: [
        {
          ...
          caption:
            "Exigences en matière de zone silencieuse : la marge invisible qui détermine le succès de l'analyse",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guide de distance de numérisation : adapter la taille du module à vos exigences de déploiement',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Le mode de sécurité de l'ANQR fournit des informations en temps réel sur la fiabilité de l'analyse. Il surveille les taux de contraste, la conformité des zones silencieuses, l'intensité de la superposition et d'autres facteurs affectant la capacité de numérisation. Lorsqu'un paramètre approche des niveaux de risque, vous verrez des avertissements avec des conseils spécifiques sur la façon d'améliorer la fiabilité. Pour les déploiements professionnels où les pannes sont coûteuses, maintenez le mode sécurité actif tout au long du processus de conception.",
    ...
    },
    {
      ...
      paragraphs: [
        "Aucune vérification logicielle ne remplace les tests physiques. Imprimez votre code à la taille prévue sur du matériel représentatif. Testez-le dans l'environnement de déploiement réel avec des conditions d'éclairage qui correspondent à une utilisation réelle. Numérisez avec plusieurs appareils : pas seulement votre téléphone phare, mais également les appareils Android économiques, les anciens iPhones et tout appareil spécifique que votre public utilise couramment.",
        "Documentez systématiquement vos tests. Enregistrez quels appareils ont été testés, dans quelles conditions et avec quels résultats. Si vous déployez des codes à grande échelle, établissez des critères d'acceptation : peut-être un taux de réussite de 95 % sur l'ensemble de votre pool de tests d'appareils, ou des analyses réussies dans les 2 secondes sur tous les appareils testés. Ces normes aident à prendre des décisions objectives plutôt que d'espérer le meilleur.",
      ],
      images: [
        {
          ...
          caption:
            'Protocole de test de déploiement QR : vérification systématique avant engagement en production',
        },
      ],
      links: [
        {
