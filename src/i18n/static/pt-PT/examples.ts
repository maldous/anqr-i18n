...
export const examples: PageDefinition = {
  ...
  description:
    'Cinco exemplos reais de estilo de produção que mostram onde os códigos QR criam valor mensurável: elevação de um código de contador de varejo legado, pagamentos de varejo de marca e ações de "digitalização para", escala de impressão de folhetos a outdoors, QR animado para sinalização digital e colaboração multilíngue usando links Anchor compartilháveis. Cada exemplo inclui imagens, restrições práticas e um link de remix para o gerador.',
  ...
  sections: [
    // ===== Example 1: Uplift Existing Campaign (IDs 1044-1070) =====
    {
      ...
      paragraphs: [
        ...
        'A transformação começou com uma auditoria simples: o código existente codificava o URL do menu online do café, que eles queriam manter. O desafio era fazer com que o QR parecesse parte da experiência do café, em vez de um utilitário posterior de 2020.',
      ],
      images: [
        {
          ...
          caption:
            'O ponto de partida: três anos de atendimento no balcão deixaram o QR original quase funcional',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Os testes revelaram vários problemas: o código original usava Correção de Erros L (redundância mínima), tinha uma zona silenciosa de apenas 2 módulos e foi impresso em baixa resolução. Sob a iluminação quente de tungstênio do café, os módulos pretos já desbotados mal contrastavam com o papel amarelado. Os telefones mais antigos apresentavam dificuldades; os telefones mais novos tiveram sucesso, mas com um atraso notável.',
        'Além de questões técnicas, o quadrado preto e branco genérico não comunicava nada sobre a marca. Os clientes hesitaram antes de digitalizar – uma barreira de confiança subtil que reduziu o envolvimento com o menu digital cuidadosamente concebido do café.',
      ],
      images: [
        {
          ...
          caption:
            'Análise técnica revelando por que o código legado teve desempenho inferior em condições do mundo real',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Construindo a configuração atualizada: cada configuração escolhida para equilibrar a expressão da marca com a confiabilidade da digitalização',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Depois de implantar o novo QR em cartões profissionais laminados foscos, a cafeteria acompanhou os resultados durante quatro semanas. A taxa de sucesso da digitalização melhorou de cerca de 70% para quase 100%. O tempo médio de varredura caiu de 3-4 segundos para menos de 1 segundo. Mais significativamente, o envolvimento do menu aumentou 40% – os clientes que antes olhavam para o QR e desistiam agora estavam lendo com confiança.',
        'A equipe relatou menos perguntas dos clientes sobre "como usar o QR" e não houve mais ocorrências de digitação manual da URL para clientes frustrados. A aparência da marca também gerou conversas, com os clientes comentando positivamente sobre o design coeso.',
      ],
      images: [
        {
          ...
          caption:
            'Quatro semanas de dados mostrando o impacto mensurável de uma melhoria cuidadosa do QR',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'A configuração do café demonstra uma marca conservadora, mas eficaz: Correção de Erros H, zona silenciosa de 6 módulos, cores de marca de alto contraste e uma sobreposição central mínima. Este equilíbrio funciona para a maioria das aplicações de balcões de varejo onde a confiabilidade deve estar em primeiro lugar, mas a presença da marca ainda é importante.',
        'Abra o gerador com essas configurações pré-carregadas e adapte as cores e sobreposições à sua marca. O principal insight: as melhorias na confiabilidade por si só podem aumentar drasticamente o envolvimento, mesmo antes de adicionar qualquer estilo visual.',
        'Veja o guia de aprendizagem relacionado sobre como melhorar as campanhas QR existentes para conhecer a metodologia completa por trás dessa abordagem.',
      ],
      images: [
        {
    ...
    // ===== Example 2: Branded Retail Payments (IDs 1071-1097) =====
    {
      ...
      paragraphs: [
        'Este exemplo segue uma boutique de roupas que acumulou cinco códigos QR diferentes em seu caixa: pagamento bancário, gorjetas, Instagram, avaliações do Google e um link de contratação. Cada um foi gerado a partir de uma fonte diferente, impresso em momentos diferentes e exibido em estandes incompatíveis. O caos visual estava minando a estética cuidadosamente selecionada da loja, e a equipe lidava regularmente com os clientes que digitalizavam o código errado.',
      ...
      images: [
        {
          ...
          caption:
            'O ponto de partida caótico: cinco códigos QR desconectados competindo por atenção e causando confusão ao cliente',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'O QR de pagamento: dimensionado generosamente, impresso profissionalmente, com estilo conservador para reconhecimento instantâneo por aplicativos bancários',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Para dicas, avaliações, redes sociais e contratações, a loja poderia ser mais expressiva. Esses códigos foram regenerados em ANQR com um estilo de marca consistente: o verde oliva sobre creme característico da loja, estilo de módulo arredondado e uma sutil sobreposição central com o ícone da loja. A Correção de Erros H garantiu confiabilidade mesmo com o estilo.',
        'Esses quatro códigos foram organizados em um painel da marca posicionado ao lado (não concorrente) do código de pagamento. Etiquetas claras na tipografia da loja explicavam a finalidade de cada código. A hierarquia visual foi intencional: o pagamento era isolado e proeminente; ações secundárias agrupadas como opções.',
      ],
      images: [
        {
          ...
          caption:
            'O painel de ação secundário: marca consistente, rotulagem clara, posicionada como opções em vez de distrações',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'A exibição física resolveu vários problemas simultaneamente. Tanto o suporte de pagamento quanto o painel secundário utilizaram materiais foscos para eliminar o brilho da iluminação superior. As alturas foram otimizadas para clientes de estatura variada. Ângulos direcionados para a fila do cliente, em vez de planos no balcão.',
        'Criticamente, a loja criou impressões sobressalentes a partir de links de configuração ANQR bloqueados. Quando o código das dicas acabou sendo borrifado, a equipe o substituiu em minutos usando a configuração armazenada - sem capturas de tela, sem adivinhar as configurações, sem degradação da qualidade.',
      ],
      images: [
        {
          ...
          caption:
            'Projeto do sistema de exibição: ergonomia física otimizada para digitalização confiável em alturas de clientes e condições de iluminação',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Seis semanas após a implantação, a loja documentou melhorias significativas: zero reclamações de clientes sobre confusão de "código errado", tempos de transação mais rápidos e um aumento de três vezes no envio de gorjetas (os clientes agora podiam encontrar e escanear o código da gorjeta sem perguntar desajeitadamente à equipe). As avaliações do Google também aumentaram à medida que o QR dedicado e bem rotulado eliminou o atrito.',
        "O treinamento da equipe ficou mais simples: 'o código de pagamento é o grande, todo o resto está no painel'. Quando os aplicativos de pagamento foram atualizados e um deles mostrou brevemente uma digitalização mais lenta, o design conservador do código de pagamento significava que ele ainda funcionava – apenas um pouco mais lento, em vez de falhar totalmente.",
      ...
      images: [
        {
          ...
          caption:
            'Seis semanas de dados operacionais demonstrando o impacto nos negócios de um sistema de exibição multi-QR bem pensado',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Um código QR, cinco tamanhos de implantação: o desafio de manter a capacidade de leitura de centímetros a metros',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Na última conferência, a empresa passou por fracassos embaraçosos. O QR do banner do palco foi gerado como um pequeno PNG e ampliado em software de design - o resultado parecia aceitável à distância, mas não foi digitalizado de forma confiável pelo público. Os QRs dos crachás eram superdimensionados e muito pequenos, frustrando os participantes que tentavam adicionar contatos. Configurações inconsistentes entre formatos significavam que o "mesmo" QR parecia diferente em cada peça.',
        'A análise pós-evento revelou a causa raiz: nenhuma fonte única de verdade. Cada designer recriou o QR com configurações ligeiramente diferentes e cada fornecedor de impressão processou os arquivos de maneira diferente. Qualidade degradada pelo jogo telefônico de transferência de arquivos.',
      ],
      images: [
        {
          ...
          caption:
            'Análise forense de falhas de eventos anteriores: cada formato introduziu diferentes problemas de qualidade',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'O pacote de transferência: tudo o que os fornecedores precisavam para produzir resultados consistentes sem adivinhações',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Cada formato exigia atenção específica. As inserções de crachás de 3 cm precisavam que o QR ocupasse o espaço máximo disponível - a distância de digitalização seria o comprimento do braço. As tendas de mesa de 8 cm podem incluir molduras decorativas fora da zona tranquila. O banner de 4 metros exigia cálculos: a partir da distância típica do público (15-20 metros), os módulos precisavam ser claramente distinguíveis pelas câmeras dos telefones, o que significava que o QR precisava estar pelo menos 80 cm dentro do design do banner.',
        'A empresa criou um guia de dimensionamento documentando as dimensões mínimas do QR para cada distância de digitalização esperada. Isso se tornou um recurso reutilizável para eventos futuros, eliminando suposições do processo de design.',
      ],
      images: [
        {
          ...
          caption:
            'A matriz de dimensionamento: dimensões calculadas que garantem uma digitalização confiável na distância de visualização esperada de cada formato',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'A validação do dia da conferência foi sistemática: a equipe testou cada QR implantado antes da abertura das portas. As inserções do crachá são digitalizadas instantaneamente com o braço estendido. As tendas de mesa funcionavam de maneira confiável na iluminação variável das salas de descanso. O banner do palco – a vergonha do evento anterior – foi escaneado com sucesso no meio da área de audiência.',
        'Nenhuma reclamação de digitalização foi registrada em mais de 2.000 participantes. A vitória operacional foi igualmente significativa: quando uma adição de patrocinador de última hora exigia nova sinalização, a equipe de produção a gerava a partir do SVG mestre em minutos, confiante de que combinaria com todo o resto.',
        'Consulte o guia de aprendizagem sobre códigos QR prontos para impressão para a estrutura de decisão SVG vs PNG e práticas recomendadas de transferência.',
      ],
      images: [
        {
          ...
          caption:
            'Sucesso no dia da conferência: digitalização confiável em todos os formatos, desde close-ups de crachás até fotos à distância de banners de palco',
        },
      ],
      links: [
        {
    ...
    // ===== Example 4: Animated Signage (IDs 1125-1151) =====
    {
      ...
      paragraphs: [
        'Este exemplo segue uma sala VIP de uma companhia aérea que usava códigos QR estáticos em suas telas digitais de boas-vindas. As telas exibiam conteúdo promocional rotativo, mas o código QR para check-in na sala VIP ficava em um canto, estático e facilmente esquecido. A análise mostrou que apenas 15% dos hóspedes elegíveis usaram o check-in QR, apesar de ser mais rápido do que a fila no balcão. A maioria dos convidados simplesmente não percebeu.',
        'A hipótese era simples: em um ambiente visualmente movimentado com conteúdo em movimento, um QR estático torna-se invisível. A solução precisava tornar o QR perceptível sem comprometer a confiabilidade necessária para um fluxo de check-in onde falhas significariam viajantes frustrados e filas mais longas no balcão.',
      ],
      images: [
        {
          ...
          caption:
            'A configuração original: um QR estático perdido em um mar de conteúdo promocional dinâmico, alcançando apenas 15% de adoção',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Configuração de animação: parâmetros ajustados para exibição do painel de LED, mantendo a confiabilidade da digitalização em cada quadro',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'O QR animado foi posicionado em uma "zona estável" dedicada do layout da tela – uma área que permaneceu constante enquanto o conteúdo promocional girava na área de exibição principal. Esta separação foi crucial: o QR precisava de estabilidade visual para a digitalização, ao mesmo tempo que atraia a atenção através da sua animação subtil.',
        "Uma frase de chamariz clara foi adicionada ao lado do QR: 'Ignore a fila - escaneie para fazer check-in.' O texto permaneceu estático enquanto o QR pulsava, criando uma hierarquia visual que chamava a atenção para a oportunidade de digitalização sem sobrecarregar o conteúdo promocional.",
      ],
      images: [
        {
          ...
          caption:
            'Alocação de espaço na tela: o QR animado ocupa uma zona estável separada do conteúdo promocional rotativo',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'O QR animado foi exportado como GIF com configurações otimizadas para o CMS de sinalização. As considerações sobre o tamanho do arquivo eram importantes - o sistema de gerenciamento de conteúdo da sala tinha limites de upload e arquivos muito grandes causavam interrupções na reprodução. A exportação final equilibrou a qualidade visual em relação ao tamanho do arquivo, limitando a paleta de cores e otimizando a contagem de quadros.',
        'A implantação incluía um substituto: se o GIF não fosse reproduzido por qualquer motivo, o sistema de sinalização exibiria um backup PNG estático. Essa redundância garantiu que a capacidade de check-in nunca fosse perdida devido a problemas técnicos com a animação.',
      ],
      images: [
        {
          ...
          caption:
            'Configuração do Signage CMS: primário animado com fallback estático garantindo que a capacidade de check-in nunca seja interrompida',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Após um mês de operação, a adoção do check-in QR aumentou de 15% para 24% – uma melhoria relativa de 60%. Pesquisas de feedback dos hóspedes indicaram que o QR animado era "mais fácil de notar" e "parecia mais moderno". Os tempos de fila no balcão diminuíram de forma mensurável durante os períodos de pico, à medida que mais hóspedes se autoatendiam por meio do QR.',
        'É importante ressaltar que foram relatadas zero falhas de verificação, apesar de milhares de verificações diárias. A abordagem conservadora da animação alcançou o objetivo de atenção sem sacrificar a confiabilidade exigida pelo fluxo de check-in. Posteriormente, o lounge lançou QRs animados semelhantes em outros locais.',
        'Consulte o guia de aprendizagem sobre códigos QR animados para sinalização digital para conhecer os princípios técnicos por trás do design seguro de animação.',
      ],
      images: [
        {
          ...
          caption:
            'Um mês de dados: aumento de 60% na adoção, tempos de fila reduzidos e manutenção de confiabilidade de verificação perfeita',
        },
      ],
      links: [
        {
    ...
    // ===== Example 5: Cross-Lingual Collaboration (IDs 1152-1178) =====
    {
      ...
      paragraphs: [
        'Este exemplo segue uma empresa de produtos eletrônicos de consumo que lança um novo produto simultaneamente em 12 mercados em 8 idiomas. Cada equipe de marketing regional precisava produzir embalagens, displays de varejo e materiais promocionais com códigos QR vinculados a páginas de produtos localizadas. Os lançamentos anteriores resultaram em estilos QR inconsistentes, falhas ocasionais de digitalização e um "jogo telefônico" de desvio de configuração à medida que cada equipe recriava códigos a partir de capturas de tela.',
        'A solução aproveitou os links de configuração compartilháveis do ANQR para estabelecer uma única fonte de verdade que cada equipe regional pudesse acessar, independentemente do idioma da interface. A carga QR usava um redirecionamento inteligente que detectava o idioma do usuário, de modo que um código funcionava globalmente enquanto proporcionava experiências localizadas.',
      ],
      images: [
        {
          ...
          caption:
            'O desafio: 12 mercados, 8 idiomas e um histórico de implementações de QR inconsistentes entre regiões',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'A configuração mestre: padrões de marca globais codificados em uma fonte de verdade única e compartilhável',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Cada equipe regional de marketing recebeu o link de configuração com instruções simples: abrir o link, verificar se a visualização corresponde às diretrizes da marca, exportar no formato necessário para sua aplicação. A interface ANQR era exibida no idioma preferido de cada equipe, mas as configurações QR subjacentes permaneciam idênticas, independentemente do idioma da interface.',
        'Quando a equipe japonesa precisou de SVG para displays de varejo de alto padrão e a equipe brasileira precisou de PNG para mídias sociais, ambos exportaram a partir da mesma configuração. Quando o fornecedor de impressão da equipe alemã solicitava valores de cores específicos, eles podiam consultar a configuração diretamente, em vez de adivinhar por meio de uma captura de tela.',
      ],
      images: [
        {
          ...
          caption:
            'Mesma configuração, interfaces diferentes: as equipes regionais trabalham no idioma de sua preferência, mantendo a consistência global',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Governança de ativos de campanha: configuração mestre e variantes documentadas, todas rastreáveis por meio de links de configuração',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Consistência global alcançada: apresentação QR idêntica em 12 mercados, apesar de diferentes idiomas, fornecedores e formatos',
        },
      ],
      links: [
        {
