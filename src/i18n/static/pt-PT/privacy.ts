  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Para exercer os seus direitos, contacte email@anqr.link. Respondemos em até 30 dias.',
      ],
    },
    {
      ...
      bullets: [
        ...
        'Direito de cancelar: cancelar a "venda" de informações pessoais (o compartilhamento com parceiros de publicidade pode ser qualificado).',
    ...
    },
    {
      ...
      paragraphs: [
        'A ANQR não se destina a crianças menores de 13 anos (ou 16 anos no EEE). Não coletamos intencionalmente dados de crianças. Contate email@anqr.link se você acredita que uma criança forneceu informações.',
      ],
    },
    {
      heading: 'Segurança',
    ...
    },
    {
      heading: 'Contate-nos',
      paragraphs: [
        'Para questões de privacidade ou para exercer os seus direitos: email@anqr.link ou utilize a nossa página de contacto. Respondemos às solicitações de privacidade dentro de 30 dias.',
      ],
    },
  ],
};
