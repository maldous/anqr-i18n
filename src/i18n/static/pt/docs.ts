...
export const docs: PageDefinition = {
  title: 'Guia do Usuário do ANQR',
  description: 'Guia completo para usar o ANQR na criação de QR codes.',
  ...
  sections: [
    ...
    {
      heading: 'Configurações de codificação do QR',
      paragraphs: [
    ...
    {
      heading: 'Estilo do padrão localizador',
      paragraphs: [
    ...
    {
      heading: 'Tamanho e espaçamento dos módulos',
      paragraphs: [
    ...
    {
      heading: 'Modos de mistura da sobreposição (avançado)',
      paragraphs: [
    ...
    {
      heading: 'Preservar padrões localizadores',
      paragraphs: [
    ...
    {
      heading: 'Opções avançadas de exportação',
      paragraphs: [
    ...
    {
      heading: 'Modos de mistura da sobreposição (profissional)',
      paragraphs: [
    ...
    {
      heading: 'Modo com consciência de ECC',
      paragraphs: [
    ...
    {
      heading: 'Opções profissionais de renderização',
      paragraphs: [
    ...
    {
      heading: 'Opções profissionais de exportação',
      paragraphs: [
    ...
    {
      heading: 'Compartilhar e incorporar',
      paragraphs: [
