...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        "Most businesses have QR codes scattered across their operations - on menus, counter stands, packaging, and promotional materials. Many of these codes were created years ago with basic generators, resulting in generic black-and-white squares that fail to inspire confidence or match your brand identity. This comprehensive guide walks you through a systematic approach to auditing, upgrading, and optimising your existing QR infrastructure without disrupting the customer journeys you've already established.",
      ...
      images: [
        {
          ...
          caption:
            'Before and after: The same destination URL transformed from a dated generic code to a professional branded asset',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR codes created during the early adoption phase - particularly during 2020-2021 when businesses rushed to implement contactless solutions - often suffer from several critical issues. Low error correction settings make them fragile when printed on textured surfaces or viewed under challenging lighting. Insufficient quiet zones cause scanning failures when codes are placed near other visual elements. Generic styling fails to communicate brand legitimacy, leading to hesitation and reduced scan rates.',
        "Beyond technical limitations, legacy codes often represent missed branding opportunities. Every QR code is a touchpoint with your customer - a moment where they're actively engaged and willing to take action. A professionally styled code that matches your brand colours, includes appropriate safety margins, and features optional branded elements transforms this utility into a marketing asset that reinforces your identity at every interaction.",
      ],
    },
    {
      heading: 'Conducting a QR Code Audit',
      paragraphs: [
        'Begin your upgrade project by creating a comprehensive inventory of every QR code currently deployed across your business. Document the physical location, the encoded destination, the current condition of the printed material, and the typical scanning environment including lighting conditions and viewing angles. Test each code with multiple devices - older smartphones and budget devices often reveal reliability issues that premium phones mask.',
      ...
      images: [
        {
          ...
          caption:
            'Systematic QR audit template for documenting and prioritising your upgrade candidates',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Brand colour selection guide showing high-contrast combinations that maintain scan reliability',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Prevent configuration drift by establishing a single authoritative source for all QR reproductions',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Payment QR codes must work instantly with banking and wallet apps under real-world counter conditions',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Payment QR codes typically follow regional standards that dictate the payload format. In Singapore, PayNow QR uses specific formatting. In India, UPI codes follow BharatQR or UPI deep link standards. European SEPA payments use EPC QR codes. Each standard exists to ensure banking apps can instantly recognise and process the payment information. Deviating from these standards - even slightly - can cause payment apps to reject codes that generic camera scanners read without issue.',
        "ANQR includes templates for major payment standards that automatically format your merchant details into compliant payloads. Always use these templates rather than manually constructing payment strings, as even minor formatting errors can cause transaction failures. If your region's payment standard isn't available as a template, consult your payment provider's technical documentation for exact formatting requirements.",
      ],
    },
    {
      heading: 'Sizing and Placement for Counter Displays',
      paragraphs: [
        "Counter-top QR codes face unique physical challenges. Customers scan at arm's length, often at an angle, sometimes through sneeze guards or display cases. Overhead lighting creates glare spots. The code competes with other counter clutter for attention and clear sightlines. Size your payment QR generously - a minimum of 4-5cm is recommended for most counter applications, scaling up if the code sits behind glass or in a dimly lit area.",
        'Position matters as much as size. Place the code where customers can comfortably hold their phone without blocking the queue or reaching awkwardly. Angle the display toward the customer rather than laying it flat. If possible, use matte lamination or non-reflective display materials to minimise glare from overhead lighting. Test the final placement at different times of day to catch lighting issues.',
      ],
      images: [
        {
          ...
          caption:
            'Counter placement guide: optimal heights, angles, and distances for reliable payment scanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Comprehensive payment QR testing matrix covering apps, devices, and environmental factors',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Vector vs raster at print scale: the precision difference that determines scan reliability',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "SVG files describe QR codes as mathematical shapes rather than grids of pixels. This means the code can be scaled to any size - from a 1cm label to a 10-metre banner - without any loss of edge sharpness. The printer's RIP (Raster Image Processor) renders the vectors at the output device's native resolution, ensuring each module edge is as crisp as the hardware allows. There's no interpolation, no anti-aliasing artifacts, no accumulated blur from multiple resize operations.",
    ...
    },
    {
      ...
      paragraphs: [
        "PNG becomes necessary when your workflow or destination platform doesn't support vector formats. Some web platforms, signage CMS systems, and legacy print workflows require raster images. In these cases, PNG can work well - but only if you follow strict rules: export at the final physical size and resolution, never scale up after export, and avoid any lossy compression or format conversion.",
      ...
      images: [
        {
          ...
          caption:
            'Professional QR handoff package: everything a designer or print vendor needs for accurate reproduction',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Never approve a print run without scanning a physical proof. Request a proof printed on the actual substrate with the actual finishing that will be used in production. Scan the proof under lighting conditions similar to where the final piece will be displayed. Test with multiple devices, including older smartphones that might struggle with marginal quality.',
        'If the proof scans slowly or inconsistently, investigate before approving. Common issues include insufficient contrast on coloured substrates, quiet zone violations from trimming, ink spread softening module edges, or lamination creating glare. Any of these can be addressed before committing to a full print run - but only if you catch them at the proof stage.',
      ],
      images: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Animated QR codes in digital signage: motion that attracts attention and encourages scanning',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animation layering principle: the QR pattern remains constant while background elements animate beneath',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'When using animated images (GIFs, animated WebPs, or video) as overlays, ANQR extracts frames and composites them with your QR code. The overlay intensity setting controls how much of the animation shows through - lower values prioritise scannability while higher values favour visual impact. Test your chosen intensity across multiple frames to ensure consistent scannability.',
    ...
    },
    {
      ...
      paragraphs: [
        "GIF remains the most widely supported animated format, playing automatically in most contexts without requiring video player support. However, GIF's 256-colour palette limits colour fidelity. For colour-critical animations, consider animated WebP where supported, or fall back to video formats for the highest quality. ANQR's GIF export includes dithering options to maximise quality within palette limitations.",
    ...
    },
    {
      ...
      paragraphs: [
        "Testing animated codes requires scanning at multiple points in the animation cycle. Don't just scan once and assume success - scan repeatedly, at different moments, to verify that every frame is readable. Pay particular attention to frames at colour cycle extremes or overlay intensity peaks where contrast might be lowest.",
        'Test on the actual display hardware where possible. Monitor colour calibration, viewing angle, and ambient lighting all affect how the animation appears and scans. A bright animation that scans perfectly on your monitor might wash out on an outdoor screen or become unreadable at oblique viewing angles.',
      ],
      images: [
        {
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: [
        "A beautifully designed QR code that fails to scan is worse than useless - it frustrates customers, damages brand perception, and wastes every resource invested in its creation and distribution. This guide covers the technical and practical factors that determine whether a QR code will scan reliably, and how to use ANQR's safety features to catch potential problems before they reach production.",
        "QR code reliability isn't binary. A code might scan perfectly on flagship phones but fail on budget devices. It might work in ideal lighting but struggle in dim restaurants or bright sunlight. Understanding the factors that affect scannability helps you make informed tradeoffs between visual styling and real-world reliability.",
      ],
      images: [
        {
    ...
    },
    {
      ...
      paragraphs: [
        'QR codes include built-in redundancy that allows them to be read even when partially damaged or obscured. The error correction level - L (7%), M (15%), Q (25%), or H (30%) - determines how much of the code can be missing while still decoding correctly. Higher error correction creates larger codes but provides a safety margin for overlays, printing imperfections, and environmental damage.',
        'For codes with image overlays, error correction level H is essential - the overlay physically obscures part of the code, and you need that 30% redundancy to maintain reliability. For clean, unstyled codes in controlled environments, level M often suffices. Level L should be reserved for situations where code size is critically constrained and you can guarantee pristine conditions.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'No amount of software verification replaces physical testing. Print your code at the intended size on representative material. Test it in the actual deployment environment with lighting conditions that match real use. Scan with multiple devices - not just your flagship phone, but budget Android devices, older iPhones, and any specific devices your audience commonly uses.',
        "Document your testing systematically. Record which devices were tested, under what conditions, with what results. If you're deploying codes at scale, establish acceptance criteria: perhaps 95% success rate across your device test pool, or successful scans within 2 seconds on all tested devices. These standards help make go/no-go decisions objective rather than hoping for the best.",
      ],
      images: [
        {
