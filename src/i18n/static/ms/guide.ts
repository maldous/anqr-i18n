...
export const guide: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: ['Kecerahan (-100 to +100): Terang atau gelapkan gambar.', 'Kontras (-100 to +100): Meningkatkan atau mengurangi jangkauan tonal.', 'Gamma (0.2 hingga 3.0): Penyesuaian kecerahan non-linear. Nilai di bawah 1 nada tengah ringan, di atas 1 gelap mereka.', 'Ketepuan (-100 hingga +100): Keamatan warna. -100 adalah skala kelabu, +100 terlalu jenuh.', 'Rotan Rona Rona Rona (0-360°): Anjakkan semua warna di roda warna.', 'Kaburkan (0-20px): Gambar halus detail.', 'Tajamkan ketajam (0-100%): Perbesar tepi dan rinciannya.', 'Memposterkan (0-16 tingkat): Kurangi kadar warna untuk efek poster.', 'Ambang (0-955): Konversi ke biner hitam/putih pada titik terputus.', 'Deteksi Edge: Algoritma Sobel atau Canny untuk hanya menampilkan tepi.', 'Balikkan semua warna.'],
    },
    {
      heading: 'Moda Muatan',
    ...
    },
    {
      ...
      bullets: ['PayPal.Me: Sambungan pembayaran PayPal dengan nama pengguna dan jumlah pra-penuh pilihan. Penerima wasiat dapat membayar melalui saldo PayPal, kartu, atau rekening bank.', 'Tunai Tunai Tunai: Tunai Upah pembayaran App link menggunakan $cashtag dengan jumlah pilihan. Popular di Amerika Serikat untuk pembayaran peer-to-peer.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Coba konfigurasi ini langsung di generator ANQR.', type: 'generator' }],
    },
    {
