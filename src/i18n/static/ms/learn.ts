...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Sebelum dan sesudah: URL destinasi yang sama berubah dari kode generik tertanggal menjadi aset bermerek profesional',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Templat audit Sistematika Sistematika QR untuk mendokumentasikan dan memprioritaskan calon penataran Anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Panduan pemilihan warna merek nird menunjukkan kombinasi kontras tinggi yang mempertahankan keandalan pemindaian',
        },
      ],
    },
    {
    ...
    // Guide 2: QR Codes for Retail Payments
    {
      ...
      paragraphs: [
        'Kode-kode QR payment yury QR beroperasi di lingkungan yang paling menuntut di ritel: momen transaksi. Para pelanggan sudah siap membayar, sering kali dengan antrian yang membentuk di belakang mereka, dan setiap detik penundaan menimbulkan gesekan. Namun momen tekanan tinggi ini juga real estate prima untuk penguatan merek. Pedoman ini menjelaskan bagaimana membuat kode QR pembayaran yang memindai langsung pada aplikasi perbankan saat masih menyajikan penampilan bermerek profesional yang membangun kepercayaan pelanggan.',
        'Prinsip dasar untuk pembayaran kode QR adalah keandalan atas estetika. Sebuah kode yang dirancang dengan indah yang gagal memindai aplikasi perbankan pelanggan akan dikenakan biaya yang jauh lebih dalam transaksi yang ditinggalkan dan frustrasi pelanggan daripada desain konservatif yang pernah bisa. Mulailah dengan kepatuhan, tambahkan keandalan, kemudian lapisan cermat dalam mencap hanya di mana ia tidak berkompromi dengan fungsi utama.',
      ],
      images: [
        {
          ...
          caption:
            'Kode QR payment [P] harus bekerja secara instan dengan perbankan dan aplikasi dompet di bawah kondisi kontra dunia nyata',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Panduan Counter penempatan: tinggi, sudut, dan jarak optimal untuk pemindaian pembayaran yang dapat diandalkan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pembayaran yuran QR branding spectrum: dari styling konservatif aman ke pendekatan dekoratif berisiko',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pembayaran koprehensif QR pengujian matriks meliputi aplikasi, perangkat, dan faktor lingkungan',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        'Perbedaan antara kode QR yang memindai dengan sempurna dan salah satu yang gagal sering turun ke bagaimana itu diekspor dan ditangani dalam alur kerja cetak. Panduan ini menjelaskan perbedaan kritis antara format vektor (SVG) dan raster (PNG), ketika menggunakan masing-masing, dan bagaimana menyerahkan karya seni QR kepada desainer dan vendor cetak dengan cara yang menjaga keandalan pemindaian dari kartu bisnis ke signage ukuran papan reklame.',
        'Produksi cetakan molford memperkenalkan variabel yang tidak ada di layar: penyebaran tinta, tekstur substrat, proses finishing, dan efek kumulatif dari konversi berkas berganda. Kode QR yang terlihat sempurna dalam perangkat lunak desain Anda dapat muncul dari pencetak dengan ujung yang dilembutkan, kontras yang berkurang, atau modul yang menyimpang secara subtly. Memahami pemilihan format dan praktik terbaik alur kerja mencegah kegagalan diam ini.',
      ],
      images: [
        {
          ...
          caption:
            'Vektor VV vs raster pada skala cetak: perbedaan presisi yang menentukan keandalan pemindaian',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Kalkulator resolusi cetakan: menentukan dimensi piksel minimum untuk ukuran output target Anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paket QR handoff profesional: segala sesuatu yang dibutuhkan perancang atau vendor cetak untuk reproduksi akurat',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Uji kerja verifikasi pembuktian uji coba uji coba uji sistematis sebelum melakukan produksi kuantitas',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Kode QR Animasi anime dalam tanda digital: gerakan yang menarik perhatian dan mendorong pemindaian',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Pemindai QR WHAV bekerja dengan menangkap satu frame dan menganalisis pola modul cahaya dan gelap. Agar kode animasi berfungsi, setiap frame harus memuat pola QR yang lengkap dan valid. Ini mengeluarkan animasi yang mengubah struktur kode, melarutkan modul, atau mengubah pola kontras secara signifikan. Modul pembawa data - pola yang tampaknya acak di tengah - harus tetap stabil secara visual di seluruh.',
      ...
      images: [
        {
          ...
          caption:
            'Prinsip pelapisan animasi: pola QR tetap konstan sementara elemen latar belakang animasi di bawah',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Laju frame falak mempengaruhi kelancaran visual maupun ukuran berkas. Untuk kebanyakan aplikasi, 10-15 frame per detik menyediakan mosi yang terlihat halus tanpa ukuran file yang berlebihan. Kadar bingkai yang lebih tinggi dari tungkai ini menawarkan penurunan kembalian visual sementara secara signifikan meningkatkan ukuran berkas. Pertimbangkan konteks pengiriman Anda - sebuah tanda digital yang besar dapat menangani berkas yang lebih besar daripada penempatan iklan mobile.',
        'Perilaku belacu menentukan bagaimana siklus animasi. Gelung tanpa tepi menghasilkan gerakan yang terus menerus ideal untuk signage dan tampilan ambient. Loop Ping-pong (forward-then-reverse) bekerja dengan baik untuk animasi sederhana. Untuk denyut perhatian-pengumpulan, perhatikan animasi dengan periode hold - stillness yang diselingi oleh gerakan yang menarik mata tanpa kelelahan gerak konstan.',
      ],
    },
    {
      heading: 'Menciptakan Pelapis Animasi',
      paragraphs: [
        'Ketika menggunakan gambar animasi (GIF, WebP animasi, atau video) sebagai overlay, ANQR ekstrak bingkai dan komposit mereka dengan kode QR Anda. Pengaturan keamatan overlay kontrol berapa banyak animasi menunjukkan melalui - nilai yang lebih rendah prioritise scannabilitas sementara nilai yang lebih tinggi mendukung dampak visual. Uji keamatanmu yang dipilih melintasi beberapa frame untuk memastikan scannabilitas yang konsisten.',
        'Kualitas material sumber secara signifikan berdampak pada hasil. Ungkapkan tindihan dengan subjek yang jelas dan kontras yang baik. Hindari animasi sumber dengan kilatan cepat atau perubahan kecerahan ekstrem yang dapat menciptakan bingkai berkontras rendah sesekali. Kitar animasi lengkap sebelum mengekspor untuk menangkap bingkai problematik yang mungkin gagal dipindai.',
      ],
      images: [
        {
          ...
          caption:
            'Analisis kerangka morfika: memverifikasi scannabilitas konsisten di seluruh siklus animasi',
        },
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Masalah ukuran file untuk pengiriman. Sistem signage digital, klien email, dan platform sosial sering memberlakukan batasan ukuran. Jika animasi Anda melebihi batas ini, kurangi jumlah bingkai, dimensi, atau kedalaman warna. Kadang-kadang pemilahan suatu animasi kompleks menjadi loop yang lebih pendek mencapai hasil yang lebih baik daripada kompresi agresif yang menurunkan setiap frame.',
      ],
    },
    {
      heading: 'Metode Animasi Animasi QR',
      paragraphs: [
        'Kode animasi tesdosis memerlukan pemindaian di beberapa titik dalam siklus animasi. Jangan hanya memindai sekali dan menganggap sukses - scan berulang kali, pada saat yang berbeda, untuk memverifikasi bahwa setiap frame dapat dibaca. Kecerdasan khususnya terhadap bingkai pada ekstrem siklus warna atau puncak intensitas overlay di mana kontras mungkin terendah.',
        'Tes pada perangkat keras tampilan sebenarnya di mana mungkin. Kalibrasi warna monitor, sudut pandang, dan pencahayaan ambien semua mempengaruhi bagaimana animasi muncul dan memindai. Sebuah animasi cerah yang dapat memindai dengan sempurna monitor Anda dapat keluar pada layar luar atau menjadi tidak terbaca pada sudut pandang oblique.',
      ],
      images: [
        {
          ...
          caption:
            'Protokol uji coba QR Animasi: verifikasi sistematis melintasi frame, perangkat, dan kondisi tampilan',
        },
      ],
      links: [
        {
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: [
        'Kode QR yang dirancang dengan indah yang gagal dipindai lebih buruk daripada tidak berguna - itu membuat frustrasi pelanggan, merusak persepsi merek, dan membuang setiap sumber yang diinvestasikan dalam pembuatan dan distribusinya. Panduan ini meliputi faktor-faktor teknis dan praktis yang menentukan apakah kode QR akan memindai secara layak, dan bagaimana menggunakan fitur keselamatan ANQR untuk menangkap masalah potensial sebelum mereka mencapai produksi.',
        'Keandalan kode QR bukan biner. Kode code yang mungkin dipindai dengan sempurna pada telepon kapal tapi gagal pada perangkat anggaran. Ini mungkin bekerja dalam pencahayaan yang ideal tetapi berjuang di restoran redup atau sinar matahari terang. Memahami faktor-faktor yang mempengaruhi kepekaan pemindaian membantu Anda membuat perdagangan informasi antara gaya visual dan keandalan dunia nyata.',
      ],
      images: [
        {
          ...
          caption:
            'Spektrum scannabilitas: dari kode anti peluru ke styling yang mendorong batas keandalan',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Kode QR kode QR termasuk built-in redundancy yang memungkinkan mereka untuk dibaca bahkan ketika sebagian rusak atau dikaburkan. Tingkat pembetulan kesalahan - L (7%), M (15%), Q (25%), atau H (30%) - menentukan berapa banyak kode dapat hilang saat masih mendekoding dengan benar. Pembetulan kesalahan yang lebih tinggi membuat kode yang lebih besar tetapi menyediakan margin keselamatan untuk overlay, mencetak ketidaksempurnaan, dan kerusakan lingkungan.',
        'Untuk kode kode dengan overlay gambar, tingkat pembetulan kesalahan Kau perlu 30% redundansi untuk mempertahankan keandalan. Untuk kode bersih dan tidak bergaya di lingkungan terkendali, tingkat M sering cukup. Aras Kau bisa menjamin kondisi murni.',
      ],
    },
    {
      heading: 'Critical Quiet Zone',
      paragraphs: [
        'Zona diam adalah margin kosong mengelilingi setiap kode QR. Scanners menggunakan batas ini untuk mengidentifikasi di mana kode dimulai dan berakhir. Standar ISO Veadon menentukan zona tenang minimum dari empat modul (empat kali lebar kuadrat terkecil dalam kode). Violating ruang ini - dengan elemen desain, tepi trim, atau konten yang berdekatan - adalah salah satu penyebab paling umum dari kegagalan pemindaian.',
        'Penegasan zona tenang ANQR membantu menjaga jarak kritis ini, tetapi Anda juga harus memastikan itu dipertahankan dalam desain akhir Anda. Ketika menyerahkan karya seni QR, secara eksplisit nyatakan persyaratan zona yang tenang. Saat menempatkan kode dalam tata letak, pastikan tak ada elemen yang masuk ke ruang ini. Ada beberapa milimeter ruang yang jelas yang dapat berarti perbedaan antara pemindaian yang dapat diandalkan dan pelanggan yang frustrasi.',
      ],
      images: [
        {
          ...
          caption:
            'Persyaratan zona diam: margin halimunan yang menentukan keberhasilan pemindaian',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Panduan jarak pengimbasan: mencocokkan ukuran modul sesuai dengan persyaratan penyebaran Anda',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protokol pengujian pengerahan QR UGAS QR: verifikasi sistematis sebelum komitmen produksi',
        },
      ],
      links: [
        {
