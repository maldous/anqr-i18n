...
export const about: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'ANQR je provozován jako nezávislý webový nástroj. V případě dotazů, podpory nebo obchodních dotazů použijte prosím kontaktní stránku nebo e-mail.' + CONTACT_EMAIL + '.',
      ],
    },
    {
