...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Aurretik eta ondoren: helmuga URL bera datatutako kode generiko batetik marka profesionaleko aktibo izatera pasa da',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Adopzio goiztiarreko fasean sortutako QR kodeak -batez ere 2020-2021 bitartean enpresek kontakturik gabeko irtenbideak ezartzera presaka ibili zirenean- askotan arazo larri batzuk izaten dituzte. Erroreen zuzenketa baxuko ezarpenek hauskor bihurtzen dituzte testurazko gainazaletan inprimatzen direnean edo argiztapen zailarekin ikusten denean. Eremu lasai nahikoak eskaneatze hutsak eragiten ditu kodeak beste elementu bisualetatik gertu jartzen direnean. Estilo generikoak ez du markaren zilegitasuna komunikatzen, zalantzak eta eskaneaketa tasak murrizten ditu.',
        'Muga teknikoetatik haratago, ondare-kodeek askotan galdutako marka aukerak adierazten dituzte. QR kode bakoitza zure bezeroarekiko ukipen-puntu bat da, aktiboki parte hartzen duten eta neurriak hartzeko prest dauden unea. Zure markaren koloreekin bat datorren estilo profesionaleko kode batek, segurtasun-marjina egokiak barne hartzen dituena eta marka hautazko elementuak dituena, erabilgarritasun hau interakzio bakoitzean zure identitatea indartzen duen marketin-aktibo bihurtzen du.',
      ],
    },
    {
      heading: 'QR Kodeen Auditoria egitea',
      paragraphs: [
        'Hasi berritze-proiektua une honetan zure negozioan zabaldutako QR kode guztien inbentario osoa sortuz. Dokumentatu kokapen fisikoa, kodetutako helmuga, inprimatutako materialaren uneko egoera eta eskaneatzeko ingurune tipikoa, argi-baldintzak eta ikusteko angeluak barne. Probatu kode bakoitza gailu anitzekin - telefono zaharrek eta aurrekontu-gailuek maiz erakusten dituzte premium telefonoek estaltzen dituzten fidagarritasun-arazoak.',
        'Arreta berezia jarri apustu handiko kokapenetako kodeak: ordainketa-puntuak, check-in-eremuak eta sustapen-pantailak, non eskaneatzea hutsegiteak diru-sarreretan edo bezeroaren esperientzian eragiten duen zuzenean. Horiei lehentasuna eman behar zaie berehala eguneratzeko. Kontuan izan argazki- edo bideo-edukietan agertzen diren kodeak ere, hauek zure marketin-taldearekin koordinazioa beharko baitute ikusizko aktiboak eguneratzeko.',
      ],
      images: [
        {
          ...
          caption:
            'QR auditoria sistematikoko txantiloia zure bertsio berritzeko hautagaiak dokumentatzeko eta lehenesteko',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Markaren kolorea aukeratzeko gidaliburua, eskaneatzea fidagarritasuna mantentzen duten kontraste handiko konbinazioak erakusten dituena',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Saihestu konfigurazio-noraeza QR erreprodukzio guztietarako autoritate-iturri bakarra ezarriz',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ordainketa QR kodeek berehala funtzionatu behar dute banku- eta zorro-aplikazioekin, mundu errealeko kontagailu baldintzetan',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Kontadorea jartzeko gida: altuera, angelu eta distantzia optimoak ordainketa fidagarrian eskaneatzeko',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Ordainketa QR markaren espektroa: estilo kontserbadore segurutik dekorazio-ikuspegi arriskutsuetara',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Ordainketa QR probaren matrize integrala aplikazioak, gailuak eta ingurumen-faktoreak biltzen dituena',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        'Primeran eskaneatzen duen QR kode baten eta askotan huts egiten duenaren arteko aldea inprimatzeko lan-fluxuan esportatu eta kudeatu zenaren araberakoa da. Gida honek bektorial (SVG) eta raster (PNG) formatuen arteko bereizketa kritikoak azaltzen ditu, bakoitza noiz erabili eta QR artelanak nola entregatu diseinatzaileei eta inprimatu saltzaileei eskaneatze fidagarritasuna negozio-txarteletatik iragarki-tamainako seinaleztapenera arte.',
      ...
      images: [
        {
          ...
          caption:
            'Bektorea vs raster inprimatze eskalan: eskaneatzeko fidagarritasuna zehazten duen zehaztasun-aldea',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Inprimatze-bereizmenaren kalkulagailua: zure helburuko irteera-tamainaren gutxieneko pixel-dimentsioak zehaztea',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'QR entrega-pakete profesionala: diseinatzaile edo inprimatze-saltzaile batek behar duen guztia erreprodukzio zehatza lortzeko',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Inoiz ez onartu inprimaketa bat froga fisiko bat eskaneatu gabe. Eskatu benetako substratuan inprimatutako froga bat ekoizpenean erabiliko den benetako akaberarekin. Eskaneatu froga azken pieza erakutsiko den lekuaren antzeko argi-baldintzetan. Probatu hainbat gailurekin, kalitate marjinala izan dezaketen telefono zaharragoekin barne.',
        'Froga poliki edo koherentziarik gabe eskaneatzen bada, ikertu onartu aurretik. Arazo ohikoenak hauek dira: koloretako substratuetan kontraste nahikorik ez izatea, mozketak eragindako gune lasaien urraketak, tinta hedatzea leuntzeko moduluen ertzak edo laminazioa distira sortzen duena. Horietako edozein bidera daiteke inprimaketa osoa egiteko konpromisoa hartu aurretik, baina froga-fasean harrapatzen badituzu soilik.',
      ],
      images: [
        {
          ...
          caption:
            'Inprimatu frogak egiaztatzeko lan-fluxua: proba sistematikoak ekoizpen-kopuruekin konpromisoa hartu aurretik',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'QR kode animatuak seinaleztapen digitalean: arreta erakartzen duen eta eskaneatzea bultzatzen duen mugimendua',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR eskanerrek fotograma bakarra harrapatzen dute eta modulu argien eta ilunen eredua aztertzen dute. Kode animatu batek funtziona dezan, fotograma bakoitzak baliozko QR eredu osoa eduki behar du. Horrek baztertzen ditu kode-egitura aldatzen duten, moduluak desegiten edo kontraste-eredua nabarmen aldatzen duten animazioak. Datuak garraiatzeko moduluak -erdialdean itxuraz ausazko eredua - bisualki egonkor mantendu behar dute.',
        'Animazio seguruen planteamenduek daturik ez daramaten elementuak aldatzen dituzte: atzeko planoak, koloreak, marko apaingarriak eta gainjarritako elementuak. Egitura-osagaiek - bilatzaile-ereduak (izkina-lauki handiak), denbora-ereduak (lerro txandakatuak) eta lerrokatze-ereduak (lauki txikiak kode handiagoetan) - beren posizioak eta proportzioak mantendu behar dituzte. Muga horien barruan lan egiteak animazio harrigarri dinamikoak eta erakargarriak egiteko aukera ematen du.',
      ],
    },
    {
      heading: 'Funtzionatzen duten animazio teknikak',
      paragraphs: [
        'Koloreen txirrindularitzak paleta baten bidez lehen planoko eta atzeko planoko koloreak animatzen ditu, pauso bakoitzean kontraste nahikoa mantenduz. Horrek arreta erakargarria duen efektu bizia sortzen du eskaneatzeko arrisku minimoarekin, betiere kontrastea irakur daitekeen mailatik behera jaisten ez den bitartean. ANQR-ren kolore-zikloaren aurrezarpenak ziklo osoan zehar eskaneagarritasuna mantentzeko diseinatuta daude.',
        'Gainjartze animatuek QR eredu erdi-garden baten atzean jartzen dituzte mugitzen diren irudiak. Kodea egonkor mantentzen da atzeko planoa animatzen den bitartean - agian bideo-loop bat, animaziozko markako elementuak edo mugimendu grafiko abstraktuak. Teknika honek intentsitatea kudeatu behar du hondoak QR eredua gaindi ez dezan, baina emaitza ikusgarrienak sortzen ditu.',
      ],
      images: [
        {
          ...
          caption:
            'Animazio-geruzaren printzipioa: QR eredua konstante mantentzen da atzeko planoko elementuak azpian animatzen diren bitartean',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Markoen analisia: animazio-ziklo osoan zehar eskaneagarritasun koherentea egiaztatzea',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'GIF animazio-formaturik onartuena izaten jarraitzen du, eta testuinguru gehienetan automatikoki erreproduzitzen da bideo-erreproduzitzaileen laguntza behar izan gabe. Hala ere, GIFaren 256 koloreko paletak koloreen fideltasuna mugatzen du. Kolore kritikoko animazioetarako, kontuan hartu WebP animatua onartzen den tokian, edo itzuli bideo formatuetara kalitaterik handiena lortzeko. ANQR-en GIF esportazioak dithering aukerak biltzen ditu paleta mugen barruan kalitatea maximizatzeko.',
        'Fitxategiaren tamaina garrantzitsua da entregatzeko. Errotulazio digitalaren sistemek, posta elektronikoko bezeroek eta plataforma sozialek askotan tamaina mugak ezartzen dituzte. Zure animazioak muga horiek gainditzen baditu, murrizteko fotograma-kopurua, dimentsioak edo kolore-sakonera. Batzuetan, animazio konplexu bat begizta laburrago batean zatitzeak emaitza hobeak lortzen ditu fotograma guztiak degradatzen dituen konpresio oldarkorra baino.',
      ],
    },
    {
      heading: 'Animaziozko QR kodeak probatzen',
      paragraphs: [
        'Kode animatuak probatzeko animazio-zikloko hainbat puntutan eskaneatu behar da. Ez eskaneatu behin eta arrakasta izan; eskaneatu behin eta berriz, une ezberdinetan, fotograma bakoitza irakurgarria dela egiaztatzeko. Arreta berezia jarri kolore-zikloaren muturreko markoei edo kontrastea baxuena izan daitekeen gainjarritako intentsitate-gailurretan.',
        'Probatu benetako pantailaren hardwarean, ahal denean. Monitorearen koloreen kalibrazioak, ikuspegi angeluak eta giroko argiak eragiten dute animazioa nola agertzen den eta eskaneatzen den moduan. Zure monitorean ezin hobeto eskaneatzen den animazio distiratsua kanpoko pantaila batean garbitu daiteke edo ikuste-angelu zeiharretan irakurezin bihur daiteke.',
      ],
      images: [
        {
          ...
          caption:
            'QR probaren protokolo animatua: egiaztapen sistematikoa fotograma, gailu eta ikusteko baldintzen artean',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Eskaneatzeko espektroa: balen aurkako kodeetatik fidagarritasun-mugak bultzatzen dituen estilora',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Zona lasaiaren eskakizunak: eskaneatze arrakasta zehazten duen marjina ikusezina',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Eskaneatzeko distantzia-gida: moduluaren tamaina zure inplementazio-baldintzekin bat etortzea',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'QR hedatze-protokoloa probatzeko protokoloa: ekoizpen-konpromisoaren aurretik egiaztatze sistematikoa',
        },
      ],
      links: [
        {
