...
export const examples: PageDefinition = {
  ...
  sections: [
    // ===== Example 1: Uplift Existing Campaign (IDs 1044-1070) =====
    {
      ...
      paragraphs: [
        'Ky shembull i botës reale ndjek një kafene të vogël që kishte përdorur të njëjtin kod QR në banakun e tyre për tre vjet. Kodi origjinal u krijua shpejt gjatë nxitimit të pandemisë, u printua në letër standarde dhe u fut në një stendë plastike. Ajo ende funksionoi - teknikisht - por klientët shpesh kishin nevojë për përpjekje të shumta për ta skanuar atë dhe nuk bëri asgjë për të përforcuar identitetin e markës së kafenesë të krijuar me kujdes.',
        'Transformimi filloi me një kontroll të thjeshtë: kodi ekzistues kodonte URL-në e menysë në internet të kafenesë, të cilën ata donin ta mbanin. Sfida ishte ta bënte QR-në të ndihej si pjesë e përvojës së kafenesë dhe jo si një mjet i menduar më vonë nga viti 2020.',
      ],
      images: [
        {
          ...
          caption:
            'Pika e fillimit: tre vjet shërbim sportel e kishin lënë QR-në origjinale mezi funksionale',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Analiza teknike që zbulon pse kodi i trashëguar nuk funksionoi në kushte të botës reale',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Duke përdorur ANQR, pronari i kafenesë rikrijoi kodin me URL-në identike të menysë, por cilësimet e përmirësuara në mënyrë dramatike: Korrigjimi i gabimit H për elasticitet maksimal, një zonë e qetë me 6 module për zbulimin e besueshëm të kufijve dhe ngjyrat e markës (module të thella ngjyrë burgundy në sfond krem) që përputheshin me paletën e brendshme të kafenesë.',
        'U shtua një shtresë e vogël qendrore që përmban logon e kafenesë - e mbajtur qëllimisht delikate për të ruajtur skanueshmërinë duke ofruar njohje të menjëhershme të markës. Safety Mode konfirmoi se dizajni i ri u skanua në mënyrë të besueshme në pajisjet e testimit përpara çdo printimi.',
      ],
      images: [
        {
          ...
          caption:
            'Ndërtimi i konfigurimit të përmirësuar: çdo cilësim i zgjedhur për të balancuar shprehjen e markës me besueshmërinë e skanimit',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Pas vendosjes së QR-së së re në kartën profesionale të petëzuar me mat, kafeneja gjurmoi rezultatet për katër javë. Shkalla e suksesit të skanimit u përmirësua nga rreth 70% në gati 100%. Koha mesatare e skanimit ra nga 3-4 sekonda në nën 1 sekondë. Më e rëndësishmja, angazhimi i menusë u rrit me 40% - klientët që më parë hodhën një sy në QR dhe hoqën dorë, tani po skanonin me besim.',
        "Stafi raportoi më pak pyetje të klientëve rreth 'si të përdoret QR' dhe jo më shumë raste të shtypjes manuale të URL-së për klientët e frustruar. Pamja e markës ndezi gjithashtu biseda, me klientët që komentuan pozitivisht për dizajnin koheziv.",
      ],
      images: [
        {
          ...
          caption:
            'Katër javë të dhëna që tregojnë ndikimin e matshëm të një ngritjeje të menduar QR',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Konfigurimi i kafenesë demonstron markë konservatore, por efektive: Korrigjimi i gabimit H, zonë e qetë me 6 module, ngjyra të markave me kontrast të lartë dhe një mbivendosje minimale në qendër. Ky bilanc funksionon për shumicën e aplikacioneve të sporteleve me pakicë ku besueshmëria duhet të jetë e para, por prania e markës është ende e rëndësishme.',
        'Hapni gjeneratorin me këto cilësime të para-ngarkuar dhe përshtatni ngjyrat dhe mbivendosjen me markën tuaj. Vështrimi kryesor: vetëm përmirësimet e besueshmërisë mund të rrisin në mënyrë dramatike angazhimin, edhe para se të shtoni ndonjë stil vizual.',
        'Shikoni udhëzuesin përkatës Mësoni për përmirësimin e fushatave ekzistuese QR për metodologjinë e plotë që qëndron pas kësaj qasjeje.',
      ],
      images: [
        {
    ...
    // ===== Example 2: Branded Retail Payments (IDs 1071-1097) =====
    {
      ...
      paragraphs: [
        'Ky shembull ndjek një dyqan veshjesh butiku që kishte grumbulluar pesë kode QR të ndryshme në regjistrin e tyre: pagesa bankare, këshilla, Instagram, komente në Google dhe një lidhje punësimi. Secili u krijua nga një burim i ndryshëm, u printua në kohë të ndryshme dhe u shfaq në stendat e papërputhshme. Kaosi vizual po minonte estetikën e dyqanit të kuruar me kujdes dhe stafi merrej rregullisht me klientët që skanonin kodin e gabuar.',
        'Zgjidhja kërkonte shqetësime të ndara: kodet e pagesave kishin nevojë për besueshmëri maksimale me një stil konservator, ndërsa kodet e marketingut mund të ishin më ekspresive. Sistemi i unifikuar i ekranit që u shfaq tregon se si të balancohet prania e markës ndaj kërkesave funksionale të rasteve të ndryshme të përdorimit të QR.',
      ],
      images: [
        {
          ...
          caption:
            'Pika kaotike e fillimit: pesë kode QR të shkëputura që konkurrojnë për vëmendje dhe shkaktojnë konfuzion të klientit',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Mënyra kryesore e pagesës së dyqanit përdorte një standard rajonal që kërkonte pajtueshmëri të rreptë të ngarkesës. Testimi zbuloi se edhe stilimi i vogël ndikoi në shpejtësinë e skanimit me disa aplikacione bankare. Vendimi: mbaj QR-në e pagesës plotësisht të pamodifikuar, përveç optimizimit të madhësisë dhe printimit profesional në stokun e kartës mat.',
        "Kjo qasje konservatore nënkuptonte se kodi i pagesës dukej më pak 'markë' sesa ideali, por normat e përfundimit të transaksioneve u përmirësuan në mënyrë dramatike. Vështrimi: momentet e pagesës nuk janë mundësi markimi - ato janë momente besueshmërie. Konsumatorët vlerësojnë shpejtësinë dhe sigurinë mbi estetikën kur përfshihen paratë.",
      ],
      images: [
        {
          ...
          caption:
            'QR e pagesës: me madhësi bujare, të printuar në mënyrë profesionale, të stiluar në mënyrë konservative për njohje të menjëhershme nga aplikacionet bankare',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paneli dytësor i veprimit: markë e qëndrueshme, etiketim i qartë, i pozicionuar si opsione dhe jo si shpërqendrime',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Ekrani fizik zgjidhi disa probleme në të njëjtën kohë. Si bazamenti i pagesës ashtu edhe paneli dytësor përdorën materiale mat për të eliminuar shkëlqimin nga ndriçimi i sipërm. Lartësitë u optimizuan për klientët me shtat të ndryshëm. Këndet e drejtuara drejt radhës së klientit dhe jo të sheshtë në banak.',
        'Në mënyrë kritike, dyqani krijoi printime rezervë nga lidhjet e konfigurimit të kyçur ANQR. Kur kodi i këshillave përfundimisht u spërkat me kafe, stafi e zëvendësoi atë brenda pak minutash duke përdorur konfigurimin e ruajtur - pa pamje nga ekrani, pa hamendje në cilësimet, pa degradim të cilësisë.',
      ],
      images: [
        {
          ...
          caption:
            'Plani i sistemit të ekranit: ergonomia fizike e optimizuar për skanim të besueshëm në lartësitë e klientëve dhe kushtet e ndriçimit',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Gjashtë javë të dhëna operacionale që demonstrojnë ndikimin e biznesit të një sistemi të zhytur në mendime të ekranit me shumë QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Një kod QR, pesë madhësi të vendosjes: sfida e ruajtjes së skanimit nga centimetra në metra',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Në konferencën e tyre të fundit, kompania kishte përjetuar dështime të turpshme. Banneri i skenës QR u krijua si një PNG i vogël dhe u përshkallëzua në softuerin e projektimit - rezultati dukej i pranueshëm nga një distancë, por nuk arriti të skanohej në mënyrë të besueshme nga audienca. QR-të e distinktivit ishin shumë të stilizuara dhe shumë të vogla, të pranishmit zhgënjyes që përpiqeshin të shtonin kontakte. Cilësimet e paqëndrueshme nëpër formate nënkuptonin se "i njëjti" QR në fakt dukej i ndryshëm në secilën pjesë.',
        'Analiza pas ngjarjes zbuloi shkakun kryesor: asnjë burim i vetëm i së vërtetës. Secili projektues kishte rikrijuar QR-në me cilësime paksa të ndryshme dhe çdo shitës printimi kishte përpunuar skedarët ndryshe. Cilësia e degraduar përmes lojës telefonike të dorëzimit të dosjeve.',
      ],
      images: [
        {
          ...
          caption:
            'Analiza mjeko-ligjore e dështimeve të ngjarjeve të mëparshme: secili format kishte paraqitur probleme të ndryshme të cilësisë',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paketa e dorëzimit: gjithçka që u nevojitet shitësve për të prodhuar rezultate të qëndrueshme pa hamendje',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matrica e madhësisë: dimensionet e llogaritura që sigurojnë skanim të besueshëm në distancën e pritur të shikimit të secilit format',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Vlefshmëria e ditës së konferencës ishte sistematike: stafi testoi çdo QR të vendosur përpara se të hapeshin dyert. Futjet e distinktivit skanohen menjëherë në gjatësinë e krahut. Çadrat e tavolinave funksionuan me besueshmëri në ndriçimin e ndryshueshëm të dhomave të ndarjes. Banneri i skenës - turpi i ngjarjes së mëparshme - u skanua me sukses nga mesi i zonës së audiencës.',
        'Zero ankesa për skanim u regjistruan në mbi 2000 pjesëmarrës. Fitorja operacionale ishte po aq domethënëse: kur një shtesë sponsori në minutën e fundit kërkonte sinjalistikë të re, ekipi i prodhimit e gjeneroi atë nga masteri SVG në minuta, me besim se do të përputhej me gjithçka tjetër.',
        'Shihni udhëzuesin Mësoni për kodet QR të gatshme për printim për kuadrin e vendimeve SVG kundër PNG dhe praktikat më të mira të dorëzimit.',
      ],
      images: [
        {
          ...
          caption:
            'Suksesi i ditës së konferencës: skanim i besueshëm në çdo format, nga pamjet e afërta të distinktivit deri te shkrepjet në distancë të banderolave',
        },
      ],
      links: [
        {
    ...
    // ===== Example 4: Animated Signage (IDs 1125-1151) =====
    {
      ...
      paragraphs: [
        'Ky shembull ndjek një sallë pritjeje linja ajrore që kishte përdorur kode QR statike në ekranet e tyre dixhitale të mirëseardhjes. Ekranet shfaqnin përmbajtje promocionale rrotulluese, por kodi QR për regjistrimin në sallë pritjeje ishte në një cep, statik dhe lehtësisht i anashkaluar. Analiza tregoi se vetëm 15% e të ftuarve të kualifikuar përdorën regjistrimin QR, pavarësisht se ishte më i shpejtë se radha e tavolinës. Shumica e të ftuarve thjesht nuk e vunë re atë.',
        'Hipoteza ishte e thjeshtë: në një mjedis të ngarkuar vizualisht me përmbajtje lëvizëse, një QR statike bëhet e padukshme. Zgjidhja e nevojshme për ta bërë QR-në të dukshme pa kompromentuar besueshmërinë e kërkuar për një fluks check-in ku dështimi do të nënkuptonte udhëtarë të frustruar dhe radhë më të gjata në tavolinë.',
      ],
      images: [
        {
          ...
          caption:
            'Konfigurimi origjinal: një QR statike e humbur në një det me përmbajtje dinamike promovuese, duke arritur vetëm 15% miratim',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Konfigurimi i animacionit: parametrat e akorduar për ekranin e panelit LED duke ruajtur besueshmërinë e skanimit në çdo kornizë',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "QR-ja e animuar u pozicionua në një 'zonë të qëndrueshme' të dedikuar të paraqitjes së ekranit - një zonë që mbeti konstante ndërsa përmbajtja promovuese rrotullohej në zonën kryesore të ekranit. Kjo ndarje ishte thelbësore: QR kishte nevojë për stabilitet vizual për skanim edhe kur tërhiqte vëmendjen përmes animacionit të tij delikate.",
        'Një thirrje e qartë për veprim u shtua ngjitur me QR: "Kapërceni radhën - skanoni për t\'u regjistruar". Teksti mbeti statik ndërsa QR-ja pulsonte, duke krijuar një hierarki vizuale që tërhoqi vëmendjen te mundësia e skanimit pa e mbingarkuar përmbajtjen promovuese.',
      ],
      images: [
        {
          ...
          caption:
            'Shpërndarja e pasurive të paluajtshme në ekran: QR-ja e animuar zë një zonë të qëndrueshme të ndarë nga përmbajtja e rradhës promovuese',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR-ja e animuar u eksportua si një GIF me cilësime të optimizuara për CMS-në e sinjalistikës. Konsideratat e madhësisë së skedarit kishin rëndësi - sistemi i menaxhimit të përmbajtjes së sallës kishte kufizime të ngarkimit dhe skedarët tepër të mëdhenj shkaktuan belbëzimin e riprodhimit. Eksporti përfundimtar balancon cilësinë vizuale kundrejt madhësisë së skedarit duke kufizuar paletën e ngjyrave dhe duke optimizuar numrin e kornizave.',
        'Vendosja përfshinte një kthim prapa: nëse GIF nuk do të luhej për ndonjë arsye, sistemi i sinjalistikës do të shfaqte një kopje rezervë statike PNG. Kjo tepricë siguroi që aftësia e regjistrimit të mos humbiste kurrë për shkak të problemeve teknike me animacionin.',
      ],
      images: [
        {
          ...
          caption:
            'Konfigurimi i Signage CMS: primar i animuar me rikthim statik që siguron që aftësia e regjistrimit të mos ndërpritet kurrë',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Pas një muaji funksionimi, miratimi i regjistrimit në QR u rrit nga 15% në 24% - një përmirësim relativ 60%. Sondazhet e komenteve të të ftuarve treguan se QR-ja e animuar ishte 'më e lehtë për t'u vënë re' dhe 'ndihej më moderne'. Kohët e radhës së tavolinave u ulën në mënyrë të matshme gjatë periudhave të pikut pasi më shumë të ftuar shërbyen vetë nëpërmjet QR.",
        'E rëndësishmja, u raportuan zero dështime të skanimit pavarësisht mijëra skanimeve ditore. Qasja konservatore e animacionit kishte arritur qëllimin e vëmendjes pa sakrifikuar besueshmërinë që kërkonte një fluks kontrolli. Salla e pritjes më pas shpërndau QR të ngjashme të animuara në vendet e tyre të tjera.',
        'Shihni udhëzuesin Mësoni mbi kodet e animuara QR për sinjalistikën dixhitale për parimet teknike prapa dizajnit të sigurt të animacionit.',
      ],
      images: [
        {
          ...
          caption:
            'Një muaj të dhëna: 60% rritje miratimi, reduktimi i kohës së radhës dhe ruajtja e besueshmërisë së përsosur të skanimit',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Sfida: 12 tregje, 8 gjuhë dhe një histori e zbatimeve jokonsistente të QR nëpër rajone',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Konfigurimi kryesor: standardet globale të markave të koduara në një burim të vetëm, të përbashkët të së vërtetës',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Çdo ekip rajonal i marketingut mori lidhjen e konfigurimit me udhëzime të thjeshta: hapni lidhjen, verifikoni që pamja paraprake përputhet me udhëzimet e markës, eksportoni në formatin e kërkuar për aplikacionin tuaj. Ndërfaqja ANQR shfaqet në gjuhën e preferuar të secilit ekip, por cilësimet themelore të QR mbetën identike pavarësisht nga gjuha e ndërfaqes.',
        "Kur ekipi japonez kishte nevojë për SVG për ekranet e shitjes me pakicë të nivelit të lartë dhe ekipit brazilian kishte nevojë për PNG për mediat sociale, të dyja të eksportuara nga i njëjti konfigurim. Kur shitësi i printimeve të ekipit gjerman kërkonte vlera specifike ngjyrash, ata mund t'i referoheshin konfigurimit drejtpërdrejt në vend që të merrnin me mend nga një pamje ekrani.",
      ],
      images: [
        {
          ...
          caption:
            'I njëjti konfigurim, ndërfaqe të ndryshme: ekipet rajonale punojnë në gjuhën e tyre të preferuar duke ruajtur konsistencën globale',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "Disa tregje kërkonin përshtatje të vogla. Ekipi kinez kishte nevojë për një version me një kornizë të optimizuar nga WeChat për ndarjen sociale. Në vend që të modifikonin masterin, ata krijuan një variant të dokumentuar me lidhjen e vet të konfigurimit, të etiketuar qartë si 'Varianti CN-WeChat' në bibliotekën e aseteve të fushatës. Kjo ruajti gjurmueshmërinë duke lejuar lokalizimin e nevojshëm.",
        "Ekipi i markës vendosi një rregull të thjeshtë: çdo ndryshim nga masteri kërkonte një lidhje të re, të dokumentuar konfigurimi. Asnjë modifikim në skedarët e eksportuar, pa 'rregullime të shpejta' në softuerin e projektimit. Kjo parandaloi zhvendosjen e konfigurimit që kishte pllakosur lëshimet e mëparshme.",
      ],
      images: [
        {
          ...
          caption:
            'Qeverisja e aseteve të fushatës: konfigurimi kryesor plus variante të dokumentuara, të gjitha të gjurmueshme nëpërmjet lidhjeve të konfigurimit',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Konsistenca globale e arritur: prezantim identik QR në 12 tregje pavarësisht gjuhëve, shitësve dhe formateve të ndryshme',
        },
      ],
      links: [
        {
