...
export const learn: PageDefinition = {
  ...
  primaryLinks: [
    ...
    { href: '/examples?lang=${lang}', label: 'Shikoni shembuj QR', type: 'example' },
    {
      ...
      label: 'Hapni udhëzuesin e plotë të përdoruesit',
      type: 'guide',
    },
  ],
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Para dhe pas: E njëjta URL e destinacionit e transformuar nga një kod gjenerik i datës në një aktiv të markës profesionale',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Modeli sistematik i auditimit QR për dokumentimin dhe prioritizimin e kandidatëve tuaj për përmirësim',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Udhëzues për përzgjedhjen e ngjyrave të markës që tregon kombinime me kontrast të lartë që ruajnë besueshmërinë e skanimit',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Parandaloni zhvendosjen e konfigurimit duke krijuar një burim të vetëm autoritar për të gjitha riprodhimet QR',
        },
      ],
      links: [
        {
    ...
    // Guide 2: QR Codes for Retail Payments
    {
      ...
      paragraphs: [
        'Kodet QR të pagesës funksionojnë në mjedisin më kërkues të shitjes me pakicë: në momentin e transaksionit. Klientët janë gati të paguajnë, shpesh me një radhë që krijohet pas tyre dhe çdo sekondë vonese krijon fërkime. Megjithatë, ky moment i presionit të lartë është gjithashtu pasuria e paluajtshme kryesore për përforcimin e markës. Ky udhëzues shpjegon se si të krijoni kode QR të pagesave që skanohen në çast në aplikacionet bankare, ndërkohë që ende paraqesin një pamje profesionale dhe të markës që ndërton besimin e klientit.',
        "Parimi themelor për kodet QR të pagesës është besueshmëria mbi estetikën. Një kod i dizajnuar bukur që dështon të skanohet në aplikacionin bankar të një klienti do t'ju kushtojë shumë më tepër në transaksionet e braktisura dhe klientët e frustruar sesa një dizajn konservator ndonjëherë. Filloni me pajtueshmërinë, shtoni besueshmërinë, pastaj vendosni me kujdes markimin vetëm aty ku nuk cenon funksionin parësor.",
      ],
      images: [
        {
          ...
          caption:
            'Kodet QR të pagesave duhet të funksionojnë menjëherë me aplikacionet bankare dhe të portofolit në kushtet reale të banakut',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Udhëzues për vendosjen e sportelit: lartësitë, këndet dhe distancat optimale për skanim të besueshëm të pagesave',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Spektri i markës së pagesës QR: nga stilimi i sigurt konservator deri te qasjet e rrezikshme dekorative',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Matrica gjithëpërfshirëse e testimit të pagesës QR që mbulon aplikacionet, pajisjet dhe faktorët mjedisorë',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        "Dallimi midis një kodi QR që skanon në mënyrë të përsosur dhe atij që dështon shpesh varet nga mënyra se si u eksportua dhe trajtohej në rrjedhën e punës së printimit. Ky udhëzues shpjegon dallimet kritike midis formateve vektoriale (SVG) dhe raster (PNG), kur duhet përdorur secili dhe si t'ua dorëzoni veprat artistike QR projektuesve dhe shitësve të printimeve në mënyra që ruajnë besueshmërinë e skanimit nga kartat e biznesit deri te sinjalistika me madhësi të tabelës.",
        'Prodhimi i printimit prezanton variabla që nuk ekzistojnë në ekran: përhapja e bojës, tekstura e substratit, proceset e përfundimit dhe efekti kumulativ i konvertimeve të shumëfishta të skedarëve. Një kod QR që duket i përsosur në softuerin tuaj të dizajnit mund të dalë nga printeri me skaje të zbutura, kontrast të reduktuar ose module të shtrembëruara në mënyrë delikate. Kuptimi i praktikave më të mira të përzgjedhjes së formatit dhe rrjedhës së punës parandalon këto dështime të heshtura.',
      ],
      images: [
        {
          ...
          caption:
            'Vektori kundrejt rasterit në shkallë printimi: ndryshimi i saktësisë që përcakton besueshmërinë e skanimit',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Llogaritësi i rezolucionit të printimit: përcaktimi i përmasave minimale të pikselëve për madhësinë e daljes së synuar',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Paketa profesionale e dorëzimit të QR: gjithçka që i nevojitet një stilisti ose shitësi printimi për riprodhim të saktë',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Rrjedha e punës e verifikimit të provës së printimit: testim sistematik përpara se të angazhoheni për sasitë e prodhimit',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Kodet QR të animuara në sinjalistikën dixhitale: lëvizje që tërheq vëmendjen dhe inkurajon skanimin',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Skanerët QR funksionojnë duke kapur një kornizë të vetme dhe duke analizuar modelin e moduleve të lehta dhe të errëta. Që një kod i animuar të funksionojë, çdo kornizë duhet të përmbajë modelin e plotë dhe të vlefshëm QR. Kjo përjashton animacionet që modifikojnë strukturën e kodit, shpërndajnë modulet ose ndryshojnë ndjeshëm modelin e kontrastit. Modulet që mbartin të dhënat - modeli në dukje i rastësishëm në qendër - duhet të mbeten vizualisht të qëndrueshëm gjatë gjithë kohës.',
        'Qasjet e sigurta të animacionit modifikojnë elementët që nuk përmbajnë të dhëna: sfondet, ngjyrat, kornizat dekorative dhe elementët e mbivendosjes. Komponentët strukturorë - modelet e gjetësit (sheshet e mëdha të qosheve), modelet e kohës (vijat e alternuara) dhe modelet e shtrirjes (sheshet më të vogla në kode më të mëdha) - duhet të ruajnë pozicionet dhe përmasat e tyre. Puna brenda këtyre kufizimeve ende lejon për animacione çuditërisht dinamike dhe tërheqëse.',
      ],
    },
    {
      heading: 'Teknikat e animacionit që funksionojnë',
      paragraphs: [
        'Cikli i ngjyrave animon ngjyrat e planit dhe sfondit përmes një palete duke ruajtur kontrast të mjaftueshëm në çdo hap. Kjo krijon një efekt të gjallë dhe tërheqës me rrezik minimal të skanimit - për sa kohë që kontrasti nuk bie kurrë nën nivelet e lexueshme. Paracaktimet e ciklit të ngjyrave të ANQR janë krijuar për të ruajtur skanueshmërinë gjatë gjithë ciklit.',
        'Mbivendosjet e animuara vendosin imazhe lëvizëse pas një modeli QR gjysmë transparent. Kodi mbetet i qëndrueshëm ndërkohë që sfondi animohet - ndoshta një video në lidhje, elementë të animuar të markës ose grafika abstrakte të lëvizjes. Kjo teknikë kërkon menaxhim të kujdesshëm të intensitetit për të parandaluar që sfondi të mbingarkojë modelin QR, por krijon rezultatet më të mahnitshme vizualisht.',
      ],
      images: [
        {
          ...
          caption:
            'Parimi i shtresimit të animacionit: modeli QR mbetet konstant ndërsa elementët e sfondit animojnë poshtë',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Analiza e kornizës: verifikimi i skanueshmërisë së qëndrueshme gjatë gjithë ciklit të animacionit',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'GIF mbetet formati i animuar më i mbështetur gjerësisht, duke luajtur automatikisht në shumicën e konteksteve pa kërkuar mbështetje për luajtësin e videos. Megjithatë, paleta me 256 ngjyra të GIF kufizon besnikërinë e ngjyrave. Për animacionet kritike për ngjyrat, merrni parasysh WebP-në e animuar ku mbështetet, ose kthehuni te formatet e videos për cilësinë më të lartë. Eksportimi GIF i ANQR përfshin opsione të ndryshme për të maksimizuar cilësinë brenda kufizimeve të paletës.',
        'Madhësia e skedarit ka rëndësi për dorëzimin. Sistemet e sinjalistikës dixhitale, klientët e postës elektronike dhe platformat sociale shpesh vendosin kufij përmasash. Nëse animacioni juaj i kalon këto kufij, zvogëloni numrin e kuadrove, dimensionet ose thellësinë e ngjyrave. Ndonjëherë ndarja e një animacioni kompleks në një lak më të shkurtër arrin rezultate më të mira sesa kompresimi agresiv që degradon çdo kornizë.',
      ],
    },
    {
      heading: 'Testimi i kodeve të animuara QR',
      paragraphs: [
        'Testimi i kodeve të animuara kërkon skanim në pika të shumta në ciklin e animacionit. Mos skanoni vetëm një herë dhe supozoni sukses - skanoni në mënyrë të përsëritur, në momente të ndryshme, për të verifikuar që çdo kornizë është e lexueshme. Kushtojini vëmendje të veçantë kornizave në skajet e ciklit të ngjyrave ose majat e intensitetit të mbivendosjes ku kontrasti mund të jetë më i ulët.',
        'Testoni në harduerin aktual të ekranit kur është e mundur. Kalibrimi i ngjyrave të monitorit, këndi i shikimit dhe ndriçimi i ambientit ndikojnë të gjitha në mënyrën se si shfaqet dhe skanohet animacioni. Një animacion i ndritshëm që skanon në mënyrë të përsosur në monitorin tuaj mund të shpërndahet në një ekran të jashtëm ose të bëhet i palexueshëm në kënde të pjerrëta shikimi.',
      ],
      images: [
        {
          ...
          caption:
            'Protokolli i animuar i testimit QR: verifikim sistematik nëpër korniza, pajisje dhe kushte shikimi',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Spektri i skanimit: nga kodet antiplumb tek stilimi që shtyn kufijtë e besueshmërisë',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Skanerët QR zbulojnë modelin e moduleve të lehta dhe të errëta. Çdo stil që zvogëlon këtë kontrast - plane të përparme të lehta, sfonde të errëta, efekte gradient ose mbivendosje me tejdukshmëri të ulët - e bën kodin më të vështirë për t'u lexuar. ANQR llogarit raportet e kontrastit dhe paralajmëron kur zgjedhjet tuaja të ngjyrave i afrohen niveleve të rrezikshme, por arbitri përfundimtar është gjithmonë testimi i botës reale.",
        "Perceptimi i ngjyrave ndryshon me kushtet e ndriçimit. Një kombinim ngjyrash që shfaqet me kontrast të lartë në monitorin tuaj mund të bëhet i vështirë për t'u dalluar nën ndriçimin e ngrohtë inkandeshentë ose tubat fluoreshente të ftohtë. Nëse kodi juaj do të vendoset në kushte të ndryshme ndriçimi, provoni nën burime të shumta drite dhe merrni parasysh raportet më konservatore të kontrastit si një diferencë sigurie.",
      ],
    },
    {
      heading: 'Madhësia e modulit dhe distanca e shikimit',
      paragraphs: [
        'Madhësia fizike e moduleve individuale përcakton distancën maksimale nga e cila mund të skanohet një kod. Modulet më të vogla nënkuptojnë kode më të vogla, por kërkojnë distanca më të afërta skanimi. Rregulli i përgjithshëm është që çdo modul duhet të jetë së paku 0,5 mm në distancën e synuar të skanimit, duke u shkallëzuar proporcionalisht për distanca më të mëdha. Një kod në një billboard ka nevojë për module shumë më të mëdha se një kod në një kartëvizitë.',
        'Kur llogaritni madhësinë e modulit, merrni parasysh skenarin më të keq: klienti me një telefon të vjetër, me ndriçim të papërsosur, duke skanuar në distancën maksimale të mundshme. Dizajni për këtë përdorues dhe të gjithë të tjerët do të kenë një përvojë edhe më të mirë. Rekomandimet e madhësisë së ANQR-së ndikojnë në këto variabla të botës reale për të sugjeruar dimensione të përshtatshme për përdorimin tuaj të synuar.',
      ],
      images: [
        {
          ...
          caption:
            'Udhëzuesi i distancës së skanimit: përputhja e madhësisë së modulit me kërkesat tuaja të vendosjes',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Modaliteti i sigurisë i ANQR ofron reagime në kohë reale mbi besueshmërinë e skanimit. Ai monitoron raportet e kontrastit, pajtueshmërinë e zonës së qetë, intensitetin e mbivendosjes dhe faktorë të tjerë që ndikojnë në skanueshmërinë. Kur ndonjë parametër i afrohet niveleve të rrezikshme, do të shihni paralajmërime me udhëzime specifike se si të përmirësoni besueshmërinë. Për vendosjet profesionale ku dështimi është i kushtueshëm, mbajeni Safety Mode aktiv gjatë gjithë procesit të projektimit.',
        'Modaliteti i sigurisë përfshin gjithashtu një veçori verifikimi të skanimit që përpiqet të deshifrojë kodin tuaj të krijuar dhe raporton suksesin ose dështimin. Ndërsa ky verifikim përmes aplikacionit nuk mund të përsërisë çdo kusht të botës reale, ai kap shumë probleme të zakonshme përpara se të investoni në printim ose shpërndarje. Trajtojeni verifikimin e suksesshëm si një bar minimal, jo një garanci - testimi në botën reale mbetet thelbësor.',
      ],
    },
    {
      heading: 'Protokollet e testimit në botën reale',
      paragraphs: [
        'Asnjë sasi e verifikimit të softuerit nuk zëvendëson testimin fizik. Shtypni kodin tuaj në madhësinë e synuar në materialin përfaqësues. Provoni atë në mjedisin aktual të vendosjes me kushte ndriçimi që përputhen me përdorimin real. Skanoni me pajisje të shumta - jo vetëm telefonin tuaj kryesor, por pajisjet buxhetore Android, iPhone të vjetër dhe çdo pajisje specifike që përdor zakonisht audienca juaj.',
        'Dokumentoni testimin tuaj në mënyrë sistematike. Regjistroni cilat pajisje janë testuar, në çfarë kushtesh, me çfarë rezultate. Nëse po vendosni kode në shkallë, vendosni kriteret e pranimit: ndoshta 95% normë suksesi në grupin e testimit të pajisjes tuaj ose skanime të suksesshme brenda 2 sekondave në të gjitha pajisjet e testuara. Këto standarde ndihmojnë në bërjen objektive të vendimeve për të shkuar/mos shkuar, në vend që të shpresojmë për më të mirën.',
      ],
      images: [
        {
          ...
          caption:
            'Protokolli i testimit të vendosjes QR: verifikimi sistematik përpara angazhimit të prodhimit',
        },
      ],
      links: [
        {
