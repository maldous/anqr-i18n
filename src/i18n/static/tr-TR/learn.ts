...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        'Çoğu işletmenin menülerinde, tezgah standlarında, ambalajlarında ve promosyon malzemelerinde operasyonlarının her yerine dağılmış QR kodları vardır. Bu kodların çoğu yıllar önce temel oluşturucularla oluşturuldu ve sonuçta güven uyandırmayan veya marka kimliğinizle eşleşmeyen genel siyah beyaz kareler ortaya çıktı. Bu kapsamlı kılavuz, halihazırda oluşturduğunuz müşteri yolculuklarını aksatmadan mevcut QR altyapınızı denetlemek, yükseltmek ve optimize etmek için sistematik bir yaklaşımla size yol gösterir.',
        "QR kodlarınızı değiştirmek yerine yükseltmenin stratejik avantajı, sürekliliğin korunmasında yatmaktadır. Müşterileriniz kodlarınızı tararken belirli hedefleri beklemeyi zaten öğrenmişlerdir. Kodlanmış URL'leri aynı tutarken görsel sunumu, tarama güvenilirliğini ve marka uyumunu önemli ölçüde geliştirerek, dijital altyapınızda veya analitik takibinizde herhangi bir değişiklik gerektirmeden güveni artıran kusursuz bir geçiş yaratırsınız.",
      ],
      images: [
        {
          ...
          caption:
            'Öncesi ve sonrası: Aynı hedef URL, eski bir genel koddan profesyonel markalı bir varlığa dönüştürüldü',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Yükseltme adaylarınızı belgelemek ve önceliklendirmek için sistematik QR denetim şablonu',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Tarama güvenilirliğini koruyan yüksek kontrast kombinasyonlarını gösteren marka renk seçimi kılavuzu',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Tüm QR çoğaltmaları için tek bir yetkili kaynak oluşturarak konfigürasyon kaymasını önleyin',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Ödeme QR kodları, gerçek dünyadaki sayaç koşulları altında bankacılık ve cüzdan uygulamalarıyla anında çalışmalıdır',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Sayaç yerleştirme kılavuzu: güvenilir ödeme taraması için optimum yükseklikler, açılar ve mesafeler',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Ödeme QR markalama yelpazesi: güvenli muhafazakar stilden riskli dekoratif yaklaşımlara kadar',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Fiziksel ekran malzemesi tarama güvenilirliğini önemli ölçüde etkiler. Parlak laminasyon, tavan ışıklarını doğrudan müşterinin kamerasına yansıtır. Dokulu malzemeler modül kenarlarını bozabilir. Ucuz baskı ince ayrıntıları bulanıklaştırabilir. Ödeme QR kodları için kaliteye yatırım yapın: mat veya saten laminasyon kullanın, yüksek çözünürlüklü baskı sağlayın ve ekranları aşınma göstermeden değiştirin. Çizilmiş veya soluk bir ödeme kodu, işlemlerinize mal olur.',
        'Ekranın dayanıklılığını ve değiştirilebilirliğini göz önünde bulundurun. Tezgah ekranlarına dokunulur, hareket ettirilir, sıçrar ve ara sıra devrilir. Görüntüleme sisteminizi, standın tamamını değiştirmeden QR eklentisinin kolayca değiştirilebileceği şekilde tasarlayın. Kilitli yapılandırma bağlantınızdan oluşturulan yedek baskıları hazır tutun, böylece aşınmış kodlar hemen değiştirilebilir.',
      ],
    },
    {
      heading: 'Gerçek Ödeme Uygulamalarıyla Test Etme',
      paragraphs: [
        'Genel kamera tarayıcıları hemen hemen tüm makul biçimlendirilmiş QR kodlarını çözecektir. Ödeme uygulamaları daha seçicidir. Herhangi bir ödeme QR kodunu dağıtmadan önce, onu müşterilerinizin kullanabileceği her ödeme uygulamasında test edin. Çoklu ödeme ortamlarında bu, birden fazla bankacılık uygulaması, dijital cüzdan ve ödeme platformuyla test yapmak anlamına gelebilir. Hangi uygulamaları test ettiğinizi ve sürümlerini belgeleyin; ödeme uygulamaları sık sık güncellenir ve bir güncelleme, tarama davranışını değiştirebilir.',
        "Gerçekçi koşullar altında test edin: gerçek ekran, gerçek aydınlatma, gerçek tarama mesafesi. Masanızda anında taranan bir kod, öğleden sonra güneşinin parıldadığı saat 17.00'de tezgahta zorlanabilir. Bulabileceğiniz en eski, en ucuz akıllı telefonla test edin; eğer uygun fiyatlı bir cihazda güvenilir bir şekilde çalışıyorsa, her şey üzerinde çalışacaktır. Araştırma ve olası yeniden tasarım için 2 saniyenin üzerindeki tarama sürelerini işaretleyin.",
      ],
      images: [
        {
          ...
          caption:
            'Uygulamaları, cihazları ve çevresel faktörleri kapsayan kapsamlı ödeme QR test matrisi',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Baskı ölçeğinde vektör ve raster: tarama güvenilirliğini belirleyen hassasiyet farkı',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Baskı çözünürlüğü hesaplayıcısı: hedef çıktı boyutunuz için minimum piksel boyutlarını belirleme',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'ANQR, farklı iş akışlarına uyacak çeşitli SVG dışa aktarma modları sunar. True Vector modu, baskı ve profesyonel tasarım araçları için ideal, saf yol tabanlı çıktı üretir. Raster kaplamalar veya belirli efektler eklediğinizde ANQR, vektör modüllerini korurken bunları gömebilir veya tamamen rasterleştirilmiş bir sürümü belirttiğiniz çözünürlükte dışa aktarabilirsiniz. Bu seçenekleri anlamak, her kullanım durumu için doğru dışa aktarımı seçmenize yardımcı olur.',
        "PNG dışa aktarmaları için ANQR, tam boyutları belirtmenize olanak tanır ve şeffaf arka planlar için seçenekler içerir. DPI ayarı, baskı için uygun boyutları hesaplamanıza yardımcı olur, ancak DPI'nın meta veri olduğunu unutmayın; baskı için önemli olan, fiziksel boyutunuz için yeterli piksele sahip olmaktır. Şüpheye düştüğünüzde, ihtiyacınız olduğunu düşündüğünüzden daha fazlasını ihraç edin; ölçeği küçültmek kaliteyi korurken, büyütmek kaliteyi yok eder.",
      ],
    },
    {
      heading: 'Dosyaları Aktarma İçin Hazırlama',
      paragraphs: [
        'QR resmini tasarımcılara veya baskı satıcılarına verirken net spesifikasyonlara yer verin: amaçlanan fiziksel boyut, minimum sessiz bölge gereksinimleri ve renk alanıyla ilgili hususlar. Kritik uygulamalar için, kullanım amaçları açıkça etiketlenmiş, hem bir SVG ana kopyası hem de yüksek çözünürlüklü bir PNG yedeği sağlayın. Gerektiğinde kodun yeniden oluşturulabilmesi için ANQR yapılandırma bağlantınızı ekleyin.',
        "Devir işlemindeki yaygın hataları tahmin edin. QR'nin ölçeklenmemesi, döndürülmemesi, eğilmemesi veya efekt uygulanmaması gerektiğini açıkça belirtin. Sessiz bölgenin temiz kalması gerektiğini belirtin; kırpma işaretleri, kayıt işaretleri veya izinsiz giren tasarım öğeleri olmamalıdır. QR renkli veya fotografik bir arka plan üzerine yerleştirilecekse, yeterli kontrastı sağlamak için opak arka planlı bir versiyon sağlayın.",
      ],
      images: [
        {
          ...
          caption:
            'Profesyonel QR aktarma paketi: Bir tasarımcının veya baskı satıcısının doğru çoğaltım için ihtiyaç duyduğu her şey',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Baskı kanıtı doğrulama iş akışı: üretim miktarlarına karar vermeden önce sistematik testler',
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        'Animasyonlu QR kodları, standart QR kodlarının işlevselliğini, etkileşim oranlarını önemli ölçüde artıran göz alıcı hareketle birleştirir. Dijital tabelalarda, sosyal medyada ve etkileşimli ekranlarda animasyon, statik bir yardımcı programı, dikkat çeken ve etkileşime davet eden ilgi çekici bir görsel öğeye dönüştürür. Bu kılavuz, görsel etki sağlarken güvenilir bir şekilde tarayan animasyonlu QR kodları oluşturmanın ilkelerini, tekniklerini ve pratik kısıtlamalarını kapsar.',
        'Animasyonlu QR kodlarının temel zorluğu, görsel ilgi ile tarama güvenilirliğini dengelemektir. Her kare ayrı ayrı taranabilir olmalıdır; bir tarayıcı, animasyon döngüsünün herhangi bir noktasında kodu yakalayabilir. Bu kısıtlama her tasarım kararını şekillendirir: hangi öğeler hareket edebilir, ne kadar değişebilir ve animasyon boyunca nelerin sabit kalması gerekir.',
      ],
      images: [
        {
          ...
          caption:
            'Dijital tabelada animasyonlu QR kodları: dikkat çeken ve taramayı teşvik eden hareket',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR tarayıcılar, tek bir kareyi yakalayıp açık ve koyu modüllerin desenini analiz ederek çalışır. Animasyonlu bir kodun çalışması için her karenin eksiksiz, geçerli QR modelini içermesi gerekir. Bu, kod yapısını değiştiren, modülleri çözen veya kontrast modelini önemli ölçüde değiştiren animasyonları hariç tutar. Veri taşıyan modüller (merkezdeki görünüşte rastgele desen) baştan sona görsel olarak sabit kalmalıdır.',
        'Güvenli animasyon yaklaşımları, veri taşımayan öğeleri değiştirir: arka planlar, renkler, dekoratif çerçeveler ve kaplama öğeleri. Yapısal bileşenler (bulucu desenler (büyük köşe kareleri), zamanlama desenleri (alternatif çizgiler) ve hizalama desenleri (büyük kodlarda daha küçük kareler) konumlarını ve oranlarını korumalıdır. Bu kısıtlamalar dahilinde çalışmak hâlâ şaşırtıcı derecede dinamik ve ilgi çekici animasyonlara olanak tanıyor.',
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animasyon katmanlama ilkesi: Arka plan öğeleri altta hareket ederken QR deseni sabit kalır',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Kare hızı hem görsel düzgünlüğü hem de dosya boyutunu etkiler. Çoğu uygulama için saniyede 10-15 kare, aşırı dosya boyutları olmadan düzgün görünümlü hareket sağlar. Daha yüksek kare hızları, dosya boyutlarını önemli ölçüde artırırken görsel getirilerin azalmasını sağlar. Teslimat bağlamınızı göz önünde bulundurun; büyük bir dijital tabela, mobil reklam yerleşimine göre daha büyük dosyaları işleyebilir.',
        'Döngü davranışı, animasyonun nasıl döndüğünü belirler. Kesintisiz döngüler, tabelalar ve ortam gösterimleri için ideal olan sürekli hareket oluşturur. Ping-pong (ileri-sonra-geri) döngüleri basit animasyonlar için iyi çalışır. Dikkat çekici darbeler için, sürekli hareket yorgunluğu olmadan gözü çeken hareketlerle noktalanan hareketsizlik dönemleri olan tutmalı animasyonları düşünün.',
      ],
    },
    {
      heading: 'Animasyonlu Kaplamalar Oluşturma',
      paragraphs: [
        "Animasyonlu görüntüleri (GIF'ler, animasyonlu WebP'ler veya video) kaplama olarak kullanırken, ANQR çerçeveleri çıkarır ve bunları QR kodunuzla birleştirir. Kaplama yoğunluğu ayarı, animasyonun ne kadarının gösterileceğini kontrol eder; daha düşük değerler taranabilirliğe öncelik verirken, daha yüksek değerler görsel etkiyi destekler. Tutarlı taranabilirlik sağlamak için seçtiğiniz yoğunluğu birden fazla karede test edin.",
        'Kaynak malzeme kalitesi sonuçları önemli ölçüde etkiler. Net konulara ve iyi kontrasta sahip kaplamalar kullanın. Ara sıra düşük kontrastlı kareler oluşturabilecek hızlı yanıp sönen veya aşırı parlaklık değişiklikleri içeren kaynak animasyonlarından kaçının. Taranmaması muhtemel sorunlu kareleri yakalamak için dışa aktarmadan önce tam animasyon döngüsünü önizleyin.',
      ],
      images: [
        {
          ...
          caption:
            'Çerçeve analizi: tüm animasyon döngüsü boyunca tutarlı taranabilirliğin doğrulanması',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Animasyonlu QR test protokolü: çerçeveler, cihazlar ve görüntüleme koşulları arasında sistematik doğrulama',
        },
      ],
      links: [
        {
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: [
        "Güzel tasarlanmış ve taranamayan bir QR kodu işe yaramazdan da kötüdür; müşterileri hayal kırıklığına uğratır, marka algısına zarar verir ve oluşturulmasına ve dağıtımına yatırılan her kaynağı boşa harcar. Bu kılavuz, bir QR kodunun güvenilir bir şekilde taranıp taranmayacağını belirleyen teknik ve pratik faktörleri ve potansiyel sorunları üretime ulaşmadan önce yakalamak için ANQR'nin güvenlik özelliklerinin nasıl kullanılacağını kapsar.",
        'QR kod güvenilirliği ikili değildir. Bir kod, amiral gemisi telefonlarda mükemmel şekilde taranabilir ancak uygun fiyatlı cihazlarda başarısız olabilir. İdeal aydınlatmada çalışabilir ancak loş restoranlarda veya parlak güneş ışığında zorluk yaşayabilir. Taranabilirliği etkileyen faktörleri anlamak, görsel stil ile gerçek dünyadaki güvenilirlik arasında bilinçli seçimler yapmanıza yardımcı olur.',
      ],
      images: [
        {
          ...
          caption:
            'Taranabilirlik yelpazesi: kurşun geçirmez kodlardan güvenilirlik sınırlarını zorlayan stile kadar',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Sessiz bölge gereksinimleri: tarama başarısını belirleyen görünmez kenar boşluğu',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Tarama mesafesi kılavuzu: modül boyutunu dağıtım gereksinimlerinize göre eşleştirme',
        },
      ],
    },
    {
      ...
      paragraphs: [
        "ANQR'nin Güvenlik Modu, tarama güvenilirliği konusunda gerçek zamanlı geri bildirim sağlar. Kontrast oranlarını, sessiz bölge uyumluluğunu, kaplama yoğunluğunu ve taranabilirliği etkileyen diğer faktörleri izler. Herhangi bir parametre riskli seviyelere yaklaştığında, güvenilirliğin nasıl artırılacağına ilişkin özel rehberlik içeren uyarılar görürsünüz. Arızanın maliyetli olduğu profesyonel dağıtımlar için Güvenlik Modu'nu tasarım süreci boyunca etkin tutun.",
        'Güvenlik Modu ayrıca, oluşturulan kodunuzun kodunu çözmeye çalışan ve başarı veya başarısızlığı bildiren bir tarama doğrulama özelliği içerir. Bu uygulama içi doğrulama, gerçek dünyadaki her durumu kopyalayamasa da, baskı veya dağıtıma yatırım yapmadan önce birçok yaygın sorunu yakalar. Başarılı doğrulamayı bir garanti olarak değil, minimum bir ölçü olarak ele alın; gerçek dünyada yapılan testler hâlâ vazgeçilmezdir.',
      ],
    },
    {
      heading: 'Gerçek Dünya Test Protokolleri',
      paragraphs: [
        "Hiçbir yazılım doğrulaması fiziksel testin yerini alamaz. Kodunuzu temsili malzeme üzerine istenilen boyutta yazdırın. Gerçek kullanımla eşleşen aydınlatma koşullarıyla gerçek dağıtım ortamında test edin. Yalnızca amiral gemisi telefonunuzla değil, bütçenize uygun Android cihazları, eski iPhone'lar ve hedef kitlenizin yaygın olarak kullandığı tüm belirli cihazlarla birden fazla cihazla tarama yapın.",
        'Testinizi sistematik olarak belgeleyin. Hangi cihazların, hangi koşullar altında, hangi sonuçlarla test edildiğini kaydedin. Kodları geniş ölçekte dağıtıyorsanız kabul kriterleri belirleyin: cihaz test havuzunuzda %95 başarı oranı veya test edilen tüm cihazlarda 2 saniye içinde başarılı taramalar. Bu standartlar, en iyiyi ummak yerine, git/gitme kararlarını objektif hale getirmeye yardımcı olur.',
      ],
      images: [
        {
