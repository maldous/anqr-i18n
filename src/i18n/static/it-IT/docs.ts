...
export const docs: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Per creare il tuo primo codice QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Formato: scegli il formato di esportazione in base al caso d\'uso.”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Controlla il comportamento del codice QR animato:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Il livello avanzato sblocca formati di carico aggiuntivi:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Ulteriori capacità di sovrapposizione:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Ulteriori modalità di fusione nel livello avanzato:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Come viene elaborata l’immagine sovrapposta:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Come l\'immagine sovrapposta si adatta all\'area del codice QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Quando si utilizza la modalità di fusione Subpixel:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Quando si utilizza la modalità di fusione Mezzitoni:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Quando si utilizzano sovrapposizioni GIF animate:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Controlli di rendering aggiuntivi:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Regolazione precisa della codifica QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Impostazioni di esportazione aggiuntive:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Impostazioni di elaborazione dell\'input:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Filigrana”',
      paragraphs: [
        '"Aggiungi filigrane ai tuoi codici QR:”',
      ],
      bullets: [
    ...
    },
    {
      heading: '"Metadati”',
      paragraphs: [
        '"Incorpora metadati nei file esportati:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Condividi le configurazioni del tuo codice QR:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Assicurarsi che i codici QR rimangano scansionabili:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Il livello professionale aggiunge tipi di pagamento e contenuti aziendali:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Ulteriori modalità di fusione nel livello Professionale:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Controlli di rendering avanzati:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Impostazioni di esportazione aziendale:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Ulteriori funzionalità di animazione professionale:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Parametri obbligatori e comuni (i nomi dei parametri non vengono tradotti):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Stile del modulo e del pattern:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Pre-elaborazione dell\'immagine applicata alla sovrapposizione:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Aggiungi filigrane ai codici QR generati:”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Per l\'output GIF animato (richiede format=gif):”',
      ],
      bullets: [
    ...
    },
    {
      ...
      paragraphs: [
        '"Segui queste linee guida per codici QR affidabili:”',
      ],
      bullets: [
