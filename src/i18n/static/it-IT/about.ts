...
export const about: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'ANQR è gestito come uno strumento web indipendente. Per domande, supporto o richieste commerciali, utilizzare la pagina Contatti o inviare un\'e-mail' + CONTACT_EMAIL + '.',
      ],
    },
    {
