...
export const examples: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['Il QR animato è stato posizionato in una zona dedicata \'stabile\' del layout dello schermo - un\'area che rimase costante mentre il contenuto promozionale ruotava nell\'area di visualizzazione principale. Questa separazione era cruciale: il QR aveva bisogno di stabilità visiva per la scansione anche attirando l\'attenzione attraverso la sua animazione sottile.', 'Un chiaro call-to-action è stato aggiunto adiacente al QR: \'Skip the code - scansione per il check-in.\' Il testo rimase statico mentre il QR pulsava, creando una gerarchia visiva che attirava l\'occhio all\'opportunità di scansione senza schiacciare il contenuto promozionale.'],
      images: [
        {
