...
export const examples: PageDefinition = {
  ...
  sections: [
    // Example 1: Uplift an Existing QR Campaign (759-770)
    {
      ...
      images: [
        { src: '/images/examples/uplift-overview.png', alt: 'Uplift an Existing QR Campaign', caption: 'Transform a plain QR code into a branded, safety-optimised version.' },
      ],
    },
    {
      ...
      images: [
        { src: '/images/examples/uplift-before.png', alt: 'The challenge', caption: 'You have an existing QR code campaign — perhaps plain black-and-white codes printed on marketing materials. The codes work, but they\'re not on-brand and may have suboptimal settings. How do you upgrade without breaking existing scans?' },
      ],
    },
    {
      ...
      images: [
        { src: '/images/examples/uplift-after.png', alt: 'The solution', caption: 'Keep the same destination URL but recreate the QR code with ANQR. Add your logo as a center overlay, apply brand colours, and enable Safety Mode to ensure the upgraded code scans reliably. The encoded content remains identical.' },
      ],
    },
    {
    ...
    // Example 2: Branded Retail Payment QR (771-782)
    {
      ...
      images: [
        { src: '/images/examples/payment-overview.png', alt: 'Branded Retail Payment QR', caption: 'Design a payment QR that balances branding with scan reliability.' },
      ],
    },
    {
      heading: 'The challenge',
      ...
      images: [
        { src: '/images/examples/payment-before.png', alt: 'The challenge', caption: 'Your retail business needs payment QR codes that match your brand identity while meeting strict payment system requirements. Generic black-and-white payment codes work but miss branding opportunities.' },
      ],
    },
    {
      heading: 'The solution',
      ...
      images: [
        { src: '/images/examples/payment-after.png', alt: 'The solution', caption: 'Use ANQR\'s payment templates (UPI, PayNow, SEPA, etc.) with conservative branding. Add your logo small and centered, use brand colours for the foreground while keeping white background, and use the highest error correction level.' },
      ],
    },
    {
    ...
    // Example 3: Print Scaling: PNG vs SVG (783-794)
    {
      ...
      images: [
        { src: '/images/examples/print-overview.png', alt: 'Print Scaling: PNG vs SVG', caption: 'See the difference between raster and vector at large print sizes.' },
      ],
    },
    {
      heading: 'The challenge',
      ...
      images: [
        { src: '/images/examples/print-png-scaled.png', alt: 'The challenge', caption: 'You need QR codes for large format print — posters, banners, or signage. Exporting at small pixel sizes then scaling up produces blurry, potentially unscannable codes.' },
      ],
    },
    {
      ...
      images: [
        { src: '/images/examples/print-svg-scaled.png', alt: 'PNG at poster size', caption: 'A QR code exported as 200×200px PNG then scaled to 30cm (12in) becomes obviously pixelated. The module edges blur together, reducing contrast and scanner reliability. This is the most common print QR failure.' },
      ],
    },
    {
    ...
    // Example 4: Animated Signage QR (795-806)
    {
      ...
      images: [
        { src: '/images/examples/animation-overview.png', alt: 'Animated Signage QR', caption: 'Add attention-grabbing animation while maintaining scan reliability.' },
      ],
    },
    {
      heading: 'The challenge',
      ...
      images: [
        { src: '/images/examples/animation-static.png', alt: 'The challenge', caption: 'Your digital signage competes for attention. Static QR codes get ignored among animated content. But aggressive animation can break scanning.' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        { href: '/?lang=${lang}&tab=advanced&format=gif#animation', label: 'Recreate in Generator', type: 'generator' },
        { href: '/learn?lang=${lang}', label: 'Browse Learn articles', type: 'learn' },
      ],
    },
    ...
    // Example 5: Cross-Lingual QR Collaboration (807-817)
    {
      ...
      images: [
        { src: '/images/examples/collab-overview.png', alt: 'Cross-Lingual QR Collaboration', caption: 'Share QR configurations across teams in different languages.' },
      ],
    },
    {
      heading: 'The challenge',
      ...
      images: [
        { src: '/images/examples/collab-english.png', alt: 'The challenge', caption: 'Your international team needs to create consistent QR codes, but team members work in different languages. Manual configuration recreation is error-prone and time-consuming.' },
      ],
    },
    {
      heading: 'The solution',
      ...
      images: [
        { src: '/images/examples/collab-japanese.png', alt: 'The solution', caption: 'ANQR\'s share links encode all settings in the URL. Team members can open the same link in their preferred language — the QR configuration loads identically, but the interface displays in their locale.' },
      ],
    },
    {
