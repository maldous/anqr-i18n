...
export const examples: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['El QR animado fue colocado en una "zona estable" dedicada del diseño de la pantalla - un área que permaneció constante mientras el contenido promocional giraba en el área de visualización principal. Esta separación fue crucial: el QR necesitaba estabilidad visual para escanear incluso a la vez que atraer la atención a través de su sutil animación.', 'Se agregó una llamada a la acción clara junto al QR: "Salta la cola - escanea para registrarte". El texto permaneció estático mientras el QR pulsaba, creando una jerarquía visual que atraía la atención hacia la oportunidad de escaneo sin abrumar el contenido promocional.'],
      images: [
        {
