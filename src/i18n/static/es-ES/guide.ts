...
export const guide: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['Texto del mensaje: codifica cualquier texto hasta el límite de capacidad del código QR. Ideal para mensajes cortos, códigos o identificadores.', 'URL: codifica direcciones web. El código QR abrirá la URL cuando se escanee. Admite protocolos http:// y https://.'],
    },
    {
    ...
    },
    {
      ...
      bullets: ['Bitcoin/Litecoin (BIP-21): Pago estándar de criptomonedas URIs con dirección de cartera, cantidad opcional y etiqueta. Compatible con todas las principales carteras de Bitcoin y Litecoin.', 'Lightning Network (BOLT11): Relámpago Red facturas de pago. Pruebe una cadena de factura codificada BOLT11 para pagos instantáneos de Bitcoin con tarifas mínimas.', 'Ethereum (EIP-681): URI de solicitud de transacciones de Ethereum que admiten transferencias nativas de ETH y transferencias de tokens ERC-20. Incluye ID de cadena para soporte de múltiples redes (Mainnet, Polygon, BSC, Arbitrum, Optimism, Avalanche), parámetros de gas y llamadas a funciones de contrato.'],
      links: [{ href: '/?lang=${lang}&tab=professional#payload', label: 'Pruebe esta configuración directamente en el generador ANQR.', type: 'generator' }],
    },
    {
