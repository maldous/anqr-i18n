...
export const learn: PageDefinition = {
  ...
  sections: [
    // Guide 1: Improving Existing QR Campaigns
    {
      ...
      paragraphs: [
        'La mayoría de las empresas tienen códigos QR dispersos a través de sus operaciones - en menús, contra stands, embalaje y materiales promocionales. Muchos de estos códigos fueron creados hace años con generadores básicos, resultando en cuadrados genéricos en blanco y negro que no inspiran confianza ni coinciden con su identidad de marca. Esta guía integral le lleva a través de un enfoque sistemático para auditar, actualizar y optimizar su infraestructura QR existente sin interrumpir los viajes de clientes que ya ha establecido.',
        'La ventaja estratégica de actualizar en lugar de sustituir sus códigos QR reside en preservar la continuidad. Sus clientes ya han aprendido a esperar ciertos destinos cuando escanean sus códigos. Al mantener las URLs codificadas idénticas mientras mejora dramáticamente la presentación visual, la fiabilidad del escaneo y la alineación de la marca, usted crea una transición perfecta que mejora la confianza sin requerir cambios en su infraestructura digital o el seguimiento de analítica.',
      ],
      images: [
        {
          ...
          caption:
            'Antes y después: La misma URL de destino transformada de un código genérico de fecha a un activo de marca profesional',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Plantilla de auditoría de QR sistemática para documentar y priorizar a sus candidatos de actualización',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Prevenir la deriva de configuración estableciendo una única fuente autorizada para todas las reproducciones QR',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Pago Los códigos QR deben trabajar al instante con aplicaciones bancarias y billeteras bajo condiciones de contador del mundo real',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Guía de colocación: alturas óptimas, ángulos y distancias para el escaneo de pago fiable',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pago espectro de marca QR: desde el estilo conservador seguro hasta enfoques decorativos arriesgados',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Pago completo matriz de pruebas QR que cubre aplicaciones, dispositivos y factores ambientales',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Vector vs raster a escala de impresión: la diferencia de precisión que determina la fiabilidad del escaneo',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Calculadora de resolución de impresión: determinación de las dimensiones mínimas del píxel para el tamaño de la salida del objetivo',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'ANQR ofrece varios modos de exportación SVG para adaptarse a diferentes flujos de trabajo. El modo Vector Verdadero produce una salida pura vía ideal para herramientas de diseño profesional y de impresión. Cuando usted ha añadido superposiciones de raster o ciertos efectos, ANQR puede incrustar estos al tiempo que mantiene módulos vectoriales, o puede exportar una versión completamente rasterizada en su resolución especificada. Comprender estas opciones le ayuda a elegir la exportación adecuada para cada caso de uso.',
      ...
      images: [
        {
          ...
          caption:
            'Paquete profesional QR: todo lo que un diseñador o proveedor de impresión necesita para una reproducción precisa',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Corriente de trabajo de verificación de pruebas de impresión: pruebas sistemáticas antes de comprometerse a cantidades de producción',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Códigos QR animados en señalización digital: movimiento que atrae la atención y alienta el escaneo',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Principio de capa de animación: el patrón QR sigue siendo constante mientras los elementos de fondo animan bajo',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Al utilizar imágenes animadas (GIFs, WebPs animados o video) como overlays, ANQR extrae marcos y los compone con su código QR. El ajuste de intensidad de superposición controla cuánto de la animación muestra a través de - menor valor priorización de la digitalización mientras que valores superiores favorecen el impacto visual. Pruebe su intensidad escogida a través de múltiples marcos para asegurar una escaneabilidad consistente.',
        'La calidad del material fuente impacta significativamente los resultados. Use superposiciones con sujetos claros y buen contraste. Evite las animaciones de origen con rápidos cambios de parpadeo o brillo extremo que podrían crear marcos ocasionales de bajo contraste. Avance el ciclo de animación completo antes de exportar para capturar cualquier marco problemático que pueda dejar de escanear.',
      ],
      images: [
        {
          ...
          caption:
            'Análisis del marco: verificación de la escaneabilidad consistente en todo el ciclo de animación',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protocolo de prueba de QR animado: verificación sistemática a través de marcos, dispositivos y condiciones de visualización',
        },
      ],
      links: [
        {
      ...
      images: [
        {
          ...
          caption:
            'El espectro de escaneabilidad: desde códigos antibalas a estilo que empuja límites de fiabilidad',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Los códigos QR incluyen redundancia incorporada que les permite ser leídos incluso cuando se daña parcialmente o se obsesiona. El nivel de corrección de errores - L (7%), M (15%), Q (25%), o H (30%) - determina cuánto del código puede faltar mientras se decodifica correctamente. La corrección de error más alta crea códigos más grandes pero proporciona un margen de seguridad para sobreimpresiones, imperfecciones de impresión y daños ambientales.',
      ...
      images: [
        {
          ...
          caption:
            'Requisitos de zona tranquila: el margen invisible que determina el éxito de la exploración',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Los escáneres QR detectan el patrón de módulos ligeros y oscuros. Cualquier estilo que reduzca este contraste - primer plano ligero, fondo oscuro, efectos gradientes o superposiciones de baja opacidad - hace que el código sea más difícil de leer. ANQR calcula ratios de contraste y advierte cuando sus opciones de color se acercan a niveles peligrosos, pero el árbitro final es siempre pruebas reales.',
      ...
      images: [
        {
          ...
          caption:
            'Guía de distancia de escaneado: tamaño del módulo a los requisitos de implementación',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protocolo de prueba de despliegue de QR: verificación sistemática antes del compromiso de producción',
        },
      ],
      links: [
        {
