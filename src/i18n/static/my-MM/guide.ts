...
export const guide: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        '(လိုအပ်သည်): QR ကုဒ်တွင် encode လုပ်ရမည့် အကြောင်းအရာ။ URL-encode လုပ်ရန် အထူးစာလုံးများ။',
        'ပစ်ဇယ်ဖြင့် ရုပ်ပုံအရွယ်အစား (ပုံသေ- ၄၀၀၊ အများဆုံး- ၂၀၀၀)။ w/h ကို မသတ်မှတ်ပါက အသုံးပြုသည်။',
        'w, h: ပစ်ဇယ်ဖြင့် အထွက်အကျယ်နှင့် အမြင့်။ အရွယ်အစား ကန့်သတ်ချက်ကို အစားထိုးသည်။',
        'အထွက်ဖော်မတ် — png၊ webp၊ သို့မဟုတ် gif (ပုံသေ- png)။',
        'အမှားပြင်ဆင်ခြင်းအဆင့် — L၊ M၊ Q သို့မဟုတ် H (ပုံသေ- H)။',
        'fg: # မပါဘဲ hex ဖြင့် ရှေ့မျက်နှာပြင်အရောင် (ပုံသေ: 000000)။',
        '# မပါဘဲ hex အဖြစ် နောက်ခံအရောင် (ပုံသေ: ffffff)။',
        'ဖောက်ထွင်းမြင်ရခြင်း- နောက်ခံဖောက်ထွင်းမြင်ရခြင်းအတွက် ၁ သို့ သတ်မှတ်ပါ။',
        'မော်ဂျူးများတွင် တိတ်ဆိတ်သောဇုန် (ပုံသေ- 4)။',
      ],
    },
    {
      ...
      bullets: [
        ...
        'ရှာဖွေစက်ပုံစံ — စတုရန်း၊ လုံးဝန်း၊ စက်ဝိုင်း။',
        ...
        'Gap mode — none, inset, stroke, negative_space.',
        'eyeInner: မျက်လုံးပုံစံများ — စတုရန်း၊ လုံးဝန်း၊ စက်ဝိုင်း။',
        'မျက်လုံးစကေး ရာခိုင်နှုန်း (ပုံသေ: 100)။',
    ...
    },
    {
      ...
      bullets: [
        ...
        'ဒီဂရီဖြင့် အပေါ်ယံလွှာလှည့်ခြင်း။',
        'flipX၊ flipY: flip overlay အတွက် ၁ သို့ သတ်မှတ်ပါ။',
        'ရှာဖွေကိရိယာပုံစံများကို ထိန်းသိမ်းပါ (ပုံသေ: 1)။',
