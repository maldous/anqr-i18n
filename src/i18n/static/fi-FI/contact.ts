...
export const contact: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Liity Reddit-yhteisöömme osoitteessa r/ANQR jakaaksesi QR-luomuksesi, kysyäksesi kysymyksiä, saadaksesi apua ja ollaksesi yhteydessä muihin ANQR-käyttäjiin.',
      ],
    },
  ],
};
