...
export const about: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        '”ANQR toimii itsenäisenä verkkotyökaluna. Kysymyksiin, tukeen tai liiketoimintaan liittyvissä tiedusteluissa käytä yhteydenottosivua tai sähköpostia.”' + CONTACT_EMAIL + '.',
      ],
    },
    {
