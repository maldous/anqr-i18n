...
export const docs: PageDefinition = {
  ...
  description: 'ANQR பயன்படுத்தி QR குறியீடுகள் உருவாக்குவதற்கான முழுமையான வழிகாட்டி.',
  ...
  sections: [
    ...
    {
      heading: 'QR குறியாக்க அமைப்புகள்',
      paragraphs: [
    ...
    {
      heading: 'அமைதிப் பகுதி (விளிம்பு)',
      paragraphs: [
    ...
    {
      heading: 'சீரமைப்பு மற்றும் நேர முறை பேட்டர்ன்கள்',
      paragraphs: [
    ...
    {
      heading: 'அனிமேஷன் அமைப்புகள் (மேம்பட்ட)',
      paragraphs: [
    ...
    {
      heading: 'உள்ளடக்க வகைகள் (மேம்பட்ட)',
      paragraphs: [
    ...
    {
      heading: 'மேலடுக்கு கலவை முறைகள் (மேம்பட்ட)',
      paragraphs: [
    ...
    {
      heading: 'Dithering அல்காரிதம்கள்',
      paragraphs: [
