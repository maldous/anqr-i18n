...
export const learn: PageDefinition = {
  ...
  sections: [
      ...
      images: [
        {
          ...
          caption:
            'Prije i poslije: Isti odredišni URL transformiran iz zastarjelog generičkog koda u sredstvo profesionalne marke',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Predložak sustavne QR revizije za dokumentiranje i određivanje prioriteta vaših kandidata za nadogradnju',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Vodič za odabir boja marke koji prikazuje kombinacije visokog kontrasta koje održavaju pouzdanost skeniranja',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Spriječite pomicanje konfiguracije uspostavljanjem jednog mjerodavnog izvora za sve QR reprodukcije',
        },
      ],
      links: [
        {
    ...
    // Guide 2: QR Codes for Retail Payments
    {
      ...
      paragraphs: [
        'QR kodovi za plaćanje djeluju u najzahtjevnijem okruženju u maloprodaji: trenutku transakcije. Kupci su spremni platiti, često se iza njih formira red, a svaka sekunda kašnjenja stvara trvenje. Ipak, ovaj trenutak visokog pritiska također je glavna nekretnina za jačanje marke. Ovaj vodič objašnjava kako izraditi QR kodove za plaćanje koji se trenutačno skeniraju u bankarskim aplikacijama, a istovremeno predstavljaju profesionalan, brendirani izgled koji gradi povjerenje kupaca.',
        'Temeljno načelo QR kodova za plaćanje je pouzdanost ispred estetike. Prekrasno dizajniran kod koji ne uspije skenirati bankovnu aplikaciju jednog klijenta koštat će vas mnogo više u napuštenim transakcijama i frustriranim klijentima nego što bi ikada mogao konzervativan dizajn. Započnite s usklađenošću, dodajte pouzdanost, a zatim pažljivo slojite markiranje samo tamo gdje to ne ugrožava primarnu funkciju.',
      ],
      images: [
        {
          ...
          caption:
            'QR kodovi za plaćanje moraju odmah funkcionirati s aplikacijama za bankarstvo i novčanik pod uvjetima šaltera u stvarnom svijetu',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Vodič za postavljanje pulta: optimalne visine, kutovi i udaljenosti za pouzdano skeniranje plaćanja',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Spektar QR brendiranja plaćanja: od sigurnog konzervativnog stila do rizičnih dekorativnih pristupa',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Sveobuhvatna matrica QR testiranja plaćanja koja pokriva aplikacije, uređaje i čimbenike okoliša',
        },
      ],
      links: [
        {
    ...
    // Guide 3: Print-Ready QR Codes
    {
      ...
      paragraphs: [
        'Razlika između QR koda koji se savršeno skenira i onog koji ne uspijeva često se svodi na to kako je izvezen i kako se njime rukovalo u tijeku rada ispisa. Ovaj vodič objašnjava kritične razlike između vektorskih (SVG) i rasterskih (PNG) formata, kada koristiti svaki od njih i kako predati QR umjetnička djela dizajnerima i dobavljačima ispisa na načine koji čuvaju pouzdanost skeniranja od posjetnica do reklamnih natpisa veličine panoa.',
        'Proizvodnja ispisa uvodi varijable koje ne postoje na ekranu: nanošenje boje, teksturu supstrata, procese dorade i kumulativni učinak konverzije više datoteka. QR kod koji izgleda savršeno u vašem softveru za dizajn može izaći iz pisača s omekšanim rubovima, smanjenim kontrastom ili suptilno iskrivljenim modulima. Razumijevanje odabira formata i najbolje prakse tijeka rada sprječava ove tihe greške.',
      ],
      images: [
        {
          ...
          caption:
            'Vektor naspram rastera u mjerilu ispisa: razlika u preciznosti koja određuje pouzdanost skeniranja',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Kalkulator razlučivosti ispisa: određivanje minimalnih dimenzija u pikselima za vašu ciljanu veličinu ispisa',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Profesionalni QR handoff paket: sve što dizajneru ili prodavaču ispisa treba za točnu reprodukciju',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'Nikada nemojte odobriti nakladu bez skeniranja fizičkog otiska. Zatražite otisak otisnut na stvarnoj podlozi sa stvarnom završnom obradom koja će se koristiti u proizvodnji. Skenirajte otisak pod uvjetima osvjetljenja sličnim onima gdje će biti prikazan konačni komad. Testirajte s više uređaja, uključujući starije pametne telefone koji bi mogli imati problema s marginalnom kvalitetom.',
        'Ako se dokaz skenira sporo ili nedosljedno, istražite prije odobravanja. Uobičajeni problemi uključuju nedovoljan kontrast na podlogama u boji, kršenje tihe zone zbog podrezivanja, rubove modula za omekšavanje širenja tinte ili laminaciju koja stvara odsjaj. Bilo koji od njih može se riješiti prije nego što se posveti punoj nakladi - ali samo ako ih uhvatite u fazi probnog ispisa.',
      ],
      images: [
        {
          ...
          caption:
            'Radni tijek provjere probnog ispisa: sustavno testiranje prije nego što se posveti proizvodnim količinama',
        },
      ],
      links: [
        {
    ...
    // Guide 4: Animated QR Codes
    {
      ...
      paragraphs: [
        'Animirani QR kodovi kombiniraju funkcionalnost standardnih QR kodova s privlačnim pokretima koji dramatično povećavaju stope angažmana. U digitalnom natpisu, društvenim medijima i interaktivnim zaslonima, animacija pretvara statičnu uslužnost u uvjerljiv vizualni element koji privlači poglede i poziva na interakciju. Ovaj vodič pokriva načela, tehnike i praktična ograničenja stvaranja animiranih QR kodova koji se pouzdano skeniraju, a istovremeno stvaraju vizualni učinak.',
        'Temeljni izazov animiranih QR kodova je balansiranje između vizualnog interesa i pouzdanosti skeniranja. Svaki okvir mora se pojedinačno skenirati - skener može uhvatiti kod u bilo kojem trenutku u ciklusu animacije. Ovo ograničenje oblikuje svaku dizajnersku odluku: koji se elementi mogu kretati, koliko se mogu mijenjati i što mora ostati stabilno tijekom cijele animacije.',
      ],
      images: [
        {
          ...
          caption:
            'Animirani QR kodovi u digitalnom natpisu: pokret koji privlači pozornost i potiče na skeniranje',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Načelo slojevitosti animacije: QR uzorak ostaje konstantan dok se pozadinski elementi animiraju ispod',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Analiza okvira: provjera dosljedne mogućnosti skeniranja kroz cijeli ciklus animacije',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'GIF ostaje najšire podržani animirani format, koji se automatski reproducira u većini konteksta bez potrebe za podrškom za video player. Međutim, GIF-ova paleta od 256 boja ograničava vjernost boja. Za animacije koje su važne za boje, razmislite o animiranom WebP-u ako je podržan ili se vratite na video formate za najvišu kvalitetu. ANQR-ov izvoz GIF-ova uključuje opcije ditheringa za maksimiziranje kvalitete unutar ograničenja palete.',
        'Veličina datoteke bitna je za isporuku. Sustavi digitalnog označavanja, klijenti e-pošte i društvene platforme često nameću ograničenja veličine. Ako vaša animacija premašuje ta ograničenja, smanjite broj okvira, dimenzije ili dubinu boje. Ponekad se dijeljenjem složene animacije u kraću petlju postižu bolji rezultati od agresivne kompresije koja degradira svaki kadar.',
      ],
    },
    {
      heading: 'Testiranje animiranih QR kodova',
      paragraphs: [
        'Testiranje animiranih kodova zahtijeva skeniranje u više točaka u ciklusu animacije. Nemojte skenirati samo jednom i pretpostaviti uspjeh - skenirajte više puta, u različitim trenucima, kako biste provjerili je li svaki okvir čitljiv. Obratite posebnu pozornost na okvire na ekstremima ciklusa boja ili vrhove intenziteta preklapanja gdje bi kontrast mogao biti najniži.',
        'Testirajte na stvarnom hardveru zaslona gdje je to moguće. Kalibracija boje monitora, kut gledanja i ambijentalno osvjetljenje utječu na to kako se animacija pojavljuje i skenira. Svijetla animacija koja se savršeno skenira na vašem monitoru može izblijediti na vanjskom zaslonu ili postati nečitljiva pod kosim kutovima gledanja.',
      ],
      images: [
        {
          ...
          caption:
            'Protokol testiranja animiranog QR-a: sustavna provjera preko okvira, uređaja i uvjeta gledanja',
        },
      ],
      links: [
        {
    ...
    // Guide 5: QR Safety & Compliance
    {
      ...
      paragraphs: [
        'Lijepo dizajniran QR kod koji se ne uspije skenirati gori je od beskorisnog - frustrira kupce, šteti percepciji robne marke i uzalud troši svaki resurs uložen u njegovu izradu i distribuciju. Ovaj vodič pokriva tehničke i praktične čimbenike koji određuju hoće li se QR kod pouzdano skenirati i kako koristiti sigurnosne značajke ANQR-a za otkrivanje potencijalnih problema prije nego što dođu do proizvodnje.',
        'Pouzdanost QR koda nije binarna. Kod bi mogao savršeno skenirati na vodećim telefonima, ali ne bi uspio na jeftinim uređajima. Može raditi pri idealnom osvjetljenju, ali se muči u prigušenim restoranima ili jakom sunčevom svjetlu. Razumijevanje čimbenika koji utječu na mogućnost skeniranja pomaže vam da napravite informirane kompromise između vizualnog stila i pouzdanosti u stvarnom svijetu.',
      ],
      images: [
        {
          ...
          caption:
            'Spektar mogućnosti skeniranja: od neprobojnih kodova do stila koji pomiče granice pouzdanosti',
        },
      ],
    },
    {
      ...
      paragraphs: [
        'QR kodovi uključuju ugrađenu redundantnost koja im omogućuje čitanje čak i kad su djelomično oštećeni ili zaklonjeni. Razina ispravljanja pogreške - L (7%), M (15%), Q (25%) ili H (30%) - određuje koliko koda može nedostajati dok se i dalje ispravno dekodira. Veća korekcija pogrešaka stvara veće kodove, ali pruža sigurnosnu granicu za slojeve, nesavršenosti ispisa i štetu okolišu.',
        'Za kodove sa slikovnim preklapanjem, bitna je razina ispravljanja pogrešaka H - preklapanje fizički zaklanja dio koda, a potrebno vam je tih 30% redundantnosti za održavanje pouzdanosti. Za čiste kodove bez stila u kontroliranim okruženjima često je dovoljna razina M. Razina L trebala bi biti rezervirana za situacije u kojima je veličina koda kritično ograničena i možete jamčiti netaknute uvjete.',
      ],
    },
    {
      heading: 'Kritična tiha zona',
      paragraphs: [
        'Tiha zona je prazna margina koja okružuje svaki QR kod. Skeneri koriste ovu granicu kako bi identificirali gdje kod počinje i završava. ISO standard navodi minimalnu tihu zonu od četiri modula (četiri puta širine najmanjeg kvadrata u kodu). Narušavanje ovog prostora - elementima dizajna, skraćivanjem rubova ili susjednim sadržajem - jedan je od najčešćih uzroka neuspjeha skeniranja.',
        'Provedba tihe zone ANQR-a pomaže u održavanju ovog kritičnog razmaka, ali također morate osigurati da bude sačuvan u vašim konačnim dizajnima. Prilikom predaje QR umjetničkih djela, izričito navedite zahtjeve za tihu zonu. Prilikom postavljanja kodova u rasporede, provjerite da nijedan element ne ulazi u ovaj prostor. Nekoliko milimetara slobodnog prostora može značiti razliku između pouzdanog skeniranja i frustriranih kupaca.',
      ],
      images: [
        {
      ...
      images: [
        {
          ...
          caption:
            'Vodič za udaljenost skeniranja: usklađivanje veličine modula s vašim zahtjevima za postavljanje',
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          caption:
            'Protokol testiranja postavljanja QR-a: sustavna provjera prije predaje proizvodnje',
        },
      ],
      links: [
        {
