...
export const contact: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Pridružite se našoj Reddit zajednici na r/ANQR kako biste podijelili svoje QR kreacije, postavljali pitanja, dobili pomoć i povezali se s drugim korisnicima ANQR-a.',
      ],
    },
  ],
};
