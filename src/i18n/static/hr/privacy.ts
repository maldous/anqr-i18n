...
export const privacy: PageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['ANQR nije usmjeren na djecu mlađu od 13 (ili 16 u EEA). Ne prikupljamo svjesno podatke od djece. Kontaktirajte ${CONTACT_EMAIL} ako mislite da je dijete dalo informacije.'],
    },
    {
      heading: 'Sigurnost',
    ...
    },
    {
      ...
      paragraphs: ['Za pitanja o privatnosti ili ostvarivanje svojih prava: ${CONTACT_EMAIL} ili upotrijebite našu stranicu za kontakt. Na zahtjeve o privatnosti odgovaramo u roku od 30 dana.'],
    },
  ],
};
